...
canonical_url: "https://react.dev/learn/typescript"
docset: "react"
kind: "library"
adapter: "generic"
last_crawled_at: "2026-04-18T16:34:51.432Z"
...
All [production-grade React frameworks](../creating-a-react-app/index.md#full-stack-frameworks) offer support for using TypeScript. Follow the framework specific guide for installation:
...
Taking the [`MyButton` component](../index.md#components) from the [Quick Start](../index.md) guide, we can add a type describing the `title` for the button:
...
Or, as recommended in [Principles for structuring state](../choosing-the-state-structure/index.md#principles-for-structuring-state), you can group related state as an object and describe the different possibilities via object types:
...
[React Compiler](../react-compiler/index.md) automatically memoizes values and functions, reducing the need for manual `useMemo` calls. You can use the compiler to handle memoization automatically.
...
[React Compiler](../react-compiler/index.md) automatically memoizes values and functions, reducing the need for manual `useCallback` calls. You can use the compiler to handle memoization automatically.
