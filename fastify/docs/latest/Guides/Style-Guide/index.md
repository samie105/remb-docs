---
title: "Fastify Style Guide"
source: "https://fastify.dev/docs/latest/Guides/Style-Guide/"
canonical_url: "https://fastify.io/docs/latest/Guides/Style-Guide/"
docset: "fastify"
kind: "framework"
adapter: "generic"
last_crawled_at: "2026-04-18T16:39:17.886Z"
...
Welcome to _Fastify Style Guide_. This guide is here to provide you with a conventional writing style for users writing developer documentation on our Open Source framework. Each topic is precise and well explained to help you write documentation users can easily understand and implement.
...
Visit the [contribute](https://fastify.dev/contribute) page on our website or read the [CONTRIBUTING.md](https://github.com/fastify/fastify/blob/main/CONTRIBUTING.md) file on GitHub to join our Open Source folks.

## Before you write[​](#before-you-write "Direct link to Before you write")
...
### Consider your Audience[​](#consider-your-audience "Direct link to Consider your Audience")
...
### Get straight to the point[​](#get-straight-to-the-point "Direct link to Get straight to the point")
...
### Avoid adding video or image content[​](#avoid-adding-video-or-image-content "Direct link to Avoid adding video or image content")
...
## Word Choice[​](#word-choice "Direct link to Word Choice")
...
> According to [Wikipedia](#), _**You**_ is usually a second person pronoun. Also, used to refer to an indeterminate person, as a more common alternative to a very formal indefinite pronoun.

## When to avoid the second person "you" as the pronoun[​](#when-to-avoid-the-second-person-you-as-the-pronoun "Direct link to When to avoid the second person \"you\" as the pronoun")
...
### Avoid using condescending terms[​](#avoid-using-condescending-terms "Direct link to Avoid using condescending terms")
...
### Starting with a verb[​](#starting-with-a-verb "Direct link to Starting with a verb")
...
### Grammatical moods[​](#grammatical-moods "Direct link to Grammatical moods")
...
### Use **active** voice instead of **passive**[​](#use-active-voice-instead-of-passive "Direct link to use-active-voice-instead-of-passive")
...
## Writing Style[​](#writing-style "Direct link to Writing Style")

### Documentation titles[​](#documentation-titles "Direct link to Documentation titles")
...
### Hyperlinks[​](#hyperlinks "Direct link to Hyperlinks")
