...
*   The [reply serializer](../Server/index.md#setreplyserializer) if set
*   The [serializer compiler](../Server/index.md#setserializercompiler) if a JSON schema is set for the HTTP status code
*   The default `JSON.stringify` function

## Shutdown Lifecycle[​](#shutdown-lifecycle "Direct link to Shutdown Lifecycle")

When [`fastify.close()`](../Server/index.md#close) is called, the server goes through a graceful shutdown sequence involving [`preClose`](../Hooks/index.md#pre-close) hooks, connection draining, and [`onClose`](../Hooks/index.md#on-close) hooks. See the [`close`](../Server/index.md#close) method documentation for the full step-by-step lifecycle.
