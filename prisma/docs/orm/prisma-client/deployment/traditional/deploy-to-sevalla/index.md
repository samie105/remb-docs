...
kind: "library"
adapter: "generic"
last_crawled_at: "2026-04-27T19:44:24.202Z"
content_hash: "0f11efa8bf4cb9e9c13ac7ca0452402b87dec790162b58080b0da22384707c3e"
menu_path: ["Deploy to Sevalla"]
section_path: []
tab_variants: ["npm","pnpm","yarn","bun"]
content_language: "en"
nav_prev: {"path": "../deploy-to-render/index.md", "title": "Deploy to Render"}
nav_next: {"path": "../../../observability-and-logging/logging/index.md", "title": "Logging"}
---
...
![Sevalla app creation interface](/docs/img/orm/prisma-client/deployment/traditional/images/sevalla-app-creation.png)
...
![Choose repository interface in Sevalla](/docs/img/orm/prisma-client/deployment/traditional/images/sevalla-choose-repository.png)
...
![Name application interface in Sevalla](/docs/img/orm/prisma-client/deployment/traditional/images/sevalla-name-application.png)
...
![Create database interface in Sevalla](/docs/img/orm/prisma-client/deployment/traditional/images/sevalla-create-database.png)
...
![App internal connection interface in Sevalla](/docs/img/orm/prisma-client/deployment/traditional/images/sevalla-app-internal-connection.png)
...
![Sevalla web terminal interface](/docs/img/orm/prisma-client/deployment/traditional/images/sevalla-web-terminal.png)
...
![Sevalla database studio interface](/docs/img/orm/prisma-client/deployment/traditional/images/sevalla-database-studio.png)
