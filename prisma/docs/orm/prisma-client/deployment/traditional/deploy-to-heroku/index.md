...
canonical_url: "https://www.prisma.io/docs/orm/prisma-client/deployment/traditional/deploy-to-heroku"
docset: "prisma"
kind: "library"
adapter: "generic"
...
At the core of Prisma ORM is the [Prisma schema](../../../../prisma-schema/overview/index.md) – a declarative configuration where you define your data model and other Prisma ORM-related configuration. The Prisma schema is also a single source of truth for both Prisma Client and Prisma Migrate.

In this guide, you will use [Prisma Migrate](../../../../prisma-migrate/index.md) to create the database schema. Prisma Migrate is based on the Prisma schema and works by generating `.sql` migration files that are executed against the database.
...
To learn more about how migrations are created with Prisma Migrate, check out the [start from scratch guide](https://www.prisma.io/docs/prisma-orm/quickstart/postgresql)
...
## [5\. Add a PostgreSQL database to your application](#5-add-a-postgresql-database-to-your-application)
