...
canonical_url: "https://www.prisma.io/docs/orm/prisma-client/deployment/traditional/deploy-to-render"
docset: "prisma"
kind: "library"
adapter: "generic"
last_crawled_at: "2026-04-27T19:44:16.142Z"
content_hash: "d498522804e368b55d4198c5340ac64dd1dfb6b281cf3aa2d7ae060ead499e70"
...
-   Render lets you deploy long-running, "serverful" full-stack applications. You can configure Render services to [autoscale](https://docs.render.com/scaling) based on CPU and/or memory usage. This is one of several [deployment paradigms](../../deploy-prisma/index.md) you can choose from.
...
-   `prisma/schema.prisma`: The data model of this app. This example defines two models, `User` and `Post`. The format of this file follows the [Prisma schema](../../../../prisma-schema/overview/index.md).
-   `prisma/migrations/<migration name>/migration.sql`: The SQL commands that construct this schema in a PostgreSQL database. You can auto-generate migration files like this one by running [`prisma migrate dev`](../../../../prisma-migrate/understanding-prisma-migrate/mental-model/index.md#what-is-prisma-migrate).
...
### [How Render deploys work with Prisma Migrate](#how-render-deploys-work-with-prisma-migrate)
...
### [1\. Initialize your Git repository](#1-initialize-your-git-repository)
...
### [2\. Deploy manually](#2-deploy-manually)
...
### [3\. (optional) Deploy with Infrastructure as Code](#3-optional-deploy-with-infrastructure-as-code)
...
Prisma ORM includes a framework for [seeding the database](../../../../prisma-migrate/workflows/seeding/index.md) with starter data. In our example, `prisma/seed.js` defines some test users and posts.
...
### [Method 1: Pre-Deploy Command](#method-1-pre-deploy-command)
