...
canonical_url: "https://www.prisma.io/docs/orm/prisma-client/deployment/serverless/deploy-to-aws-lambda"
docset: "prisma"
kind: "library"
adapter: "generic"
...
You can use [Prisma Postgres](https://www.prisma.io/docs/postgres), which has built-in connection pooling, to solve this issue. For other solutions, see the [connection management guide for serverless environments](../../../setup-and-configuration/databases-connections/index.md#serverless-environments-faas).
