...
kind: "library"
adapter: "generic"
last_crawled_at: "2026-04-27T19:38:39.119Z"
content_hash: "dbf2d8f69a6827e7ef1bbf865a6c09a7569e5d01b41f284455f86184e8b58a32"
...
Your application is [traditionally deployed](../traditional/deploy-to-heroku/index.md) if a Node.js process is continuously running and handles multiple requests at the same time. Your application could be deployed to a Platform-as-a-Service (PaaS) like [Heroku](../traditional/deploy-to-heroku/index.md), [Koyeb](../traditional/deploy-to-koyeb/index.md), or [Render](../traditional/deploy-to-render/index.md); as a Docker container to Kubernetes; or as a Node.js process on a virtual machine or bare metal server.

See also: [Connection management in long-running processes](../../setup-and-configuration/databases-connections/index.md#long-running-processes)

### [Serverless Functions](#serverless-functions)

Your application is [serverless](../serverless/deploy-to-vercel/index.md) if the Node.js processes of your application (or subsets of it broken into functions) are started as requests come in, and each function only handles one request at a time. Your application would most likely be deployed to a Function-as-a-Service (FaaS) offering, such as [AWS Lambda](../serverless/deploy-to-aws-lambda/index.md) or [Azure Functions](../serverless/deploy-to-azure-functions/index.md)
...
See also: [Connection management in serverless environments](../../setup-and-configuration/databases-connections/index.md#serverless-environments-faas)

### [Edge Functions](#edge-functions)

Your application is [edge deployed](../edge/overview/index.md) if your application is [serverless](#serverless-functions) and the functions are distributed across one or more regions close to the user.
