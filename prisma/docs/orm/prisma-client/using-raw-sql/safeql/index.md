...
canonical_url: "https://www.prisma.io/docs/orm/prisma-client/using-raw-sql/safeql"
docset: "prisma"
kind: "library"
adapter: "generic"
last_crawled_at: "2026-04-18T16:49:51.576Z"
content_hash: "118b1d1428522256777ba14d8c1dc90c98c273137a83a8a5ac55755c36153602"
menu_path: ["SafeQL & Prisma Client"]
section_path: []
...
## [1\. Set up Prisma ORM for use with PostGIS](#1-set-up-prisma-orm-for-use-with-postgis)
...
### [3.1. Install the `@ts-safeql/eslint-plugin` npm package](#31-install-the-ts-safeqleslint-plugin-npm-package)

This ESLint plugin is what will allow for queries to be linted.

### [3.2. Add `@ts-safeql/eslint-plugin` to your ESLint plugins](#32-add-ts-safeqleslint-plugin-to-your-eslint-plugins)
...
### [3.3 Add `@ts-safeql/check-sql` rules](#33-add-ts-safeqlcheck-sql-rules)
...
### [3.4. Connect to your database](#34-connect-to-your-database)
...
### [4.1. Adding an extension to create `PointOfInterest` records](#41-adding-an-extension-to-create-pointofinterest-records)
...
### [4.2. Adding an extension to query for closest to `PointOfInterest` records](#42-adding-an-extension-to-query-for-closest-to-pointofinterest-records)
