...
[`migrate status`](https://www.prisma.io/docs/orm/reference/prisma-cli-reference#migrate-status)

1

Checks the status of migrations

[`migrate dev`](https://www.prisma.io/docs/orm/reference/prisma-cli-reference#migrate-dev)

1–4

Applies pending migrations in development

[`migrate diff`](https://www.prisma.io/docs/orm/reference/prisma-cli-reference#migrate-diff)

1–2

Compares database schema with migration history

[`migrate reset`](https://www.prisma.io/docs/orm/reference/prisma-cli-reference#migrate-reset)
...
[`db pull`](https://www.prisma.io/docs/orm/reference/prisma-cli-reference#db-pull)

1

Pulls the database schema into the Prisma schema

[`db push`](https://www.prisma.io/docs/orm/reference/prisma-cli-reference#db-push)

1–2

Pushes the Prisma schema to the database

[`db execute`](https://www.prisma.io/docs/orm/reference/prisma-cli-reference#db-execute)

1

Executes raw SQL commands

[`db seed`](https://www.prisma.io/docs/orm/reference/prisma-cli-reference#db-seed)
...
![An AWS Lambda function connecting to a database.](https://www.prisma.io/docs/img/orm/prisma-client/setup-and-configuration/databases-connections/serverless-connections.png?dpl=dpl_2TrAJrUt7dXR3AAWNDvwk5WL6VFX)
...
![Three AWS Lambda function connecting to a database.](https://www.prisma.io/docs/img/orm/prisma-client/setup-and-configuration/databases-connections/serverless-connections-2.png?dpl=dpl_2TrAJrUt7dXR3AAWNDvwk5WL6VFX)
