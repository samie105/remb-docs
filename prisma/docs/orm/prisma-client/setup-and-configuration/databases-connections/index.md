...
-   Configure [pool size and timeouts](https://www.prisma.io/docs/orm/prisma-client/setup-and-configuration/databases-connections/connection-pool) for your driver adapter (defaults and options are adapter-specific)
...
| --- | --- | --- |
| [`migrate status`](https://www.prisma.io/docs/orm/reference/prisma-cli-reference#migrate-status) | 1 | Checks the status of migrations |
| [`migrate dev`](https://www.prisma.io/docs/orm/reference/prisma-cli-reference#migrate-dev) | 1–4 | Applies pending migrations in development |
| [`migrate diff`](https://www.prisma.io/docs/orm/reference/prisma-cli-reference#migrate-diff) | 1–2 | Compares database schema with migration history |
| [`migrate reset`](https://www.prisma.io/docs/orm/reference/prisma-cli-reference#migrate-reset) | 1–2 | Resets the database and reapplies migrations |
| [`migrate deploy`](https://www.prisma.io/docs/orm/reference/prisma-cli-reference#migrate-deploy) | 1–2 | Applies pending migrations in production |
| [`db pull`](https://www.prisma.io/docs/orm/reference/prisma-cli-reference#db-pull) | 1 | Pulls the database schema into the Prisma schema |
| [`db push`](https://www.prisma.io/docs/orm/reference/prisma-cli-reference#db-push) | 1–2 | Pushes the Prisma schema to the database |
| [`db execute`](https://www.prisma.io/docs/orm/reference/prisma-cli-reference#db-execute) | 1 | Executes raw SQL commands |
| [`db seed`](https://www.prisma.io/docs/orm/reference/prisma-cli-reference#db-seed) | 1 | Seeds the database with initial data |
...
![An AWS Lambda function connecting to a database.](/docs/img/orm/prisma-client/setup-and-configuration/databases-connections/serverless-connections.png)
...
![Three AWS Lambda function connecting to a database.](/docs/img/orm/prisma-client/setup-and-configuration/databases-connections/serverless-connections-2.png)
...
1.  Configure a small pool size for your [driver adapter](https://www.prisma.io/docs/orm/prisma-client/setup-and-configuration/databases-connections/connection-pool) (adapter-specific; start small when not using a pooler)
...
You [do not need to explicitly `$disconnect()`](https://www.prisma.io/docs/orm/prisma-client/setup-and-configuration/databases-connections/connection-management#calling-disconnect-explicitly) at the end of a function, as there is a possibility that the container might be reused. Opening a new connection takes time and slows down your function's ability to process requests. In some cases (e.g. [Cloudflare Workers](https://www.prisma.io/docs/orm/prisma-client/deployment/edge/deploy-to-cloudflare)), calling `$disconnect()` when releasing a temporary client is recommended—see the [connection management caveat](https://www.prisma.io/docs/orm/prisma-client/setup-and-configuration/databases-connections/connection-management#calling-disconnect-explicitly).
...
Pool size, acquire timeout, and other pool behavior are **configured per driver adapter**—there are no connection URL parameters for these in Prisma ORM v7. See the [connection pool reference](https://www.prisma.io/docs/orm/prisma-client/setup-and-configuration/databases-connections/connection-pool) for each adapter's pool settings (e.g. `max`, `connectionTimeoutMillis` for `pg`) and the underlying driver documentation. Tune the pool so that:
