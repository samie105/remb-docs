...
In order to set up Prisma Client, you need a Prisma Config and a [Prisma schema file](../../../prisma-schema/overview/index.md):

[Install the Prisma CLI](../../../reference/prisma-cli-reference/index.md), the Prisma Client library, and the [driver adapter](../../../core-concepts/supported-databases/database-drivers/index.md) for your database:
...
With the client generated, import it along with your [driver adapter](../../../core-concepts/supported-databases/database-drivers/index.md) and create a new instance:

Find out what [driver adapter](../../../core-concepts/supported-databases/database-drivers/index.md) is needed for your database.

Your application should generally only create **one instance** of `PrismaClient`. How to achieve this depends on whether you are using Prisma ORM in a [long-running application](../databases-connections/index.md#prismaclient-in-long-running-applications) or in a [serverless environment](../databases-connections/index.md#prismaclient-in-serverless-environments).
