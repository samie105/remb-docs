...
kind: "library"
adapter: "generic"
last_crawled_at: "2026-04-27T19:39:09.886Z"
...
See [Nested writes](index.md#nested-writes) for creating records with relations.
...
See [Select fields](https://www.prisma.io/docs/v6/orm/prisma-client/queries/select-fields) and [Relation queries](index.md) for more.
...
See [Relation queries](index.md) for connecting and disconnecting related records.
