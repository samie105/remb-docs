...
See the [Prisma Client API reference](../../../reference/prisma-client-reference/index.md) for detailed method documentation.
...
See [Nested writes](../relation-queries/index.md#nested-writes) for creating records with relations.
...
See [Filtering and sorting](https://www.prisma.io/docs/v6/orm/prisma-client/queries/filtering-and-sorting) for more examples, or [Working with geometry fields](../../special-fields-and-types/working-with-geometry-fields/index.md) for spatial queries.
...
See [Select fields](https://www.prisma.io/docs/v6/orm/prisma-client/queries/select-fields) and [Relation queries](../relation-queries/index.md) for more.
...
See [Relation queries](../relation-queries/index.md) for connecting and disconnecting related records.

### [Delete a single record](#delete-a-single-record)

The following query uses [`delete()`](../../../reference/prisma-client-reference/index.md#delete) to delete a single `User` record:
...
The following query uses [`deleteMany()`](../../../reference/prisma-client-reference/index.md#deletemany) to delete all `User` records where `email` contains `prisma.io`:
...
The following query uses [`deleteMany()`](../../../reference/prisma-client-reference/index.md#deletemany) to delete all `User` records:
...
When you know the order in which your tables should be deleted, you can use the [`deleteMany`](../../../reference/prisma-client-reference/index.md#deletemany) function. This is executed synchronously in a [`$transaction`](../transactions/index.md) and can be used with all types of databases.
...
If you are comfortable working with raw SQL, you can perform a `TRUNCATE` query on a table using [`$executeRawUnsafe`](../../using-raw-sql/raw-queries/index.md#executerawunsafe).
