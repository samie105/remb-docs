...
When using Prisma Client, every model from your [Prisma schema](../../../prisma-schema/overview/index.md) is translated into a dedicated TypeScript type. For example, assume you have the following `User` and `Post` models:
...
When doing [`select`](../../../reference/prisma-client-reference/index.md#select) or [`include`](../../../reference/prisma-client-reference/index.md#include) operations on your models and returning these variants from a function, it can be difficult to gain access to the return type, e.g:
