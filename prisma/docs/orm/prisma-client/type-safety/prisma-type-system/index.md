...
See Prisma ORM's [database connector pages](https://www.prisma.io/docs/orm/core-concepts/supported-databases) for the default type mappings for a given database. For example, [this table](https://www.prisma.io/docs/orm/core-concepts/supported-databases/postgresql#prisma-to-postgresql) gives the default type mappings for PostgreSQL.  
