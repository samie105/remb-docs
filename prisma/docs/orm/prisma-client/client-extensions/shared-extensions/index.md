...
kind: "library"
adapter: "generic"
last_crawled_at: "2026-04-27T19:43:06.688Z"
content_hash: "1830d8e96d872e9438d78604ea7b793799f4f50efcedff13ce97ea9ad6f0a3b9"
...
To explore examples of Prisma's official Client extensions and those made by the community, visit [this](../extension-examples/index.md) page.
...
2.  Use one of the methods that begin with the `$all` prefix such as [`$allModels`](../model/index.md#add-a-custom-method-to-all-models-in-your-schema) or [`$allOperations`](../query/index.md#modify-all-prisma-client-operations)
...
You do not need to use the `$all` prefix with the [`client`](../client/index.md) component, because the `client` component always applies to the client instance.
...
-   [Modify all Prisma Client operations](../query/index.md#modify-all-prisma-client-operations)
-   [Modify a specific operation in all models of your schema](../query/index.md#modify-a-specific-operation-in-all-models-of-your-schema)
-   [Modify all operations in all models of your schema](../query/index.md#modify-all-operations-in-all-models-of-your-schema)
...
-   When you want to use a [client-level method](../../../reference/prisma-client-reference/index.md#client-methods), such as `$queryRaw`, in your packaged extension.
...
You can improve the type-safety of your shared extensions using [type utilities](../type-utilities/index.md).
