...
section_path: []
content_language: "en"
nav_prev: {"path": "../../more/troubleshooting/typescript-performance/index.md", "title": "TypeScript performance"}
nav_next: {"path": "client/index.md", "title": "Add methods to Prisma Client"}
---
...
-   `model`: [add custom methods or fields to your models](model/index.md)
-   `client`: [add client-level methods to Prisma Client](client/index.md)
-   `query`: [create custom Prisma Client queries](query/index.md)
-   `result`: [add custom fields to your query results](result/index.md)
...
You can [share your Prisma Client extensions](shared-extensions/index.md) with other Prisma ORM users, and [import Prisma Client extensions developed by other users](shared-extensions/index.md#install-a-shared-packaged-extension) into your Prisma ORM project.
...
-   Use the client-level [`$extends`](../../reference/prisma-client-reference/index.md#client-methods) method
...
The above examples use the [`model` extension component](model/index.md) to extend the `User` model.

In your `$extends` method, use the appropriate extension component or components ([`model`](model/index.md), [`client`](client/index.md), [`result`](result/index.md) or [`query`](query/index.md)).
...
Chain [`query`](query/index.md) extensions to compose middleware. Extensions execute in order—first in, first out:
...
[Client-level methods](../../reference/prisma-client-reference/index.md#client-methods) do not necessarily exist on extended clients. For these clients you will need to first check for existence before using.
