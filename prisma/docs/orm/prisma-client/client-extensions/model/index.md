...
You can use the `model` [Prisma Client extensions](../index.md) component type to add custom methods to your models.
...
You can improve the type-safety of `model` components in your shared extensions with [type utilities](../type-utilities/index.md).
