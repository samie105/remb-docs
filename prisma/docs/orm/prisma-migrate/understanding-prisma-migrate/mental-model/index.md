...
kind: "library"
adapter: "generic"
last_crawled_at: "2026-04-27T19:40:51.421Z"
content_hash: "6cf9eb3e2187af7d0d14cfc84d3f02748b3d5826206ef8ca9475f96fb65feea0"
...
![Model-first migration flow](/docs/img/orm/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/entity-first-migration-flow.png)
...
![Database-first migration flow](/docs/img/orm/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/database-first-migration-flow.png)
...
![Prisma Migrate workflow](/docs/img/orm/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/prisma-migrate-lifecycle.png)
...
![Prisma Migrate "state management"](/docs/img/orm/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/prisma-migrate-state-mgt.png)
...
Under the hood, Prisma Migrate uses a [shadow database](../shadow-database/index.md) to detect a [schema drift](../shadow-database/index.md#detecting-schema-drift) and generate new migrations.
...
![A cartoon that shows how the shadow database works.](/docs/img/orm/prisma-migrate/understanding-prisma-migrate/shadow-database.png)
...
For such instances, you can use the [`prisma migrate diff`](../../../reference/prisma-cli-reference/index.md#migrate-diff) command to compare your migration history and revert changes made to your database schema.

![Revert database schema with migrate diff](/docs/img/orm/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/prisma-migrate-diff-flow.png)
...
You can then apply the changes to your database using [`prisma db execute`](../../../reference/prisma-cli-reference/index.md#db-execute) command.

#### [Prototype your schema](#prototype-your-schema)

The [`prisma db push`](../../../reference/prisma-cli-reference/index.md#db-push) command allows you to sync your Prisma schema and database schema without persisting a migration (`/prisma/migrations`). The `prisma db push` command tracks the state of the database using the following pieces of state:

-   the Prisma schema
-   the database schema

![prisma db push development flow](/docs/img/orm/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/db-push-flow.png)
...
The [`prisma migrate deploy`](../../../reference/prisma-cli-reference/index.md#migrate-deploy) command allows you to sync your migration history from your development environment with your database in your **staging or production environment**.
...
![Workflow of Prisma Migrate](/docs/img/orm/prisma-migrate/workflows/deploy-db.png)
