...
kind: "library"
adapter: "generic"
last_crawled_at: "2026-04-27T19:41:01.678Z"
content_hash: "6aa888831daa8aaf89e64d17ef00af7a791d7121e13067d1a0f91fb91d567e97"
...
![A migration history represented by three migration files (file icon and name), surrounded by a a box labelled 'migration history'. The first migration is marked 'do not apply', and the second two migrations are marked 'apply'. An arrow labelled with the command 'prisma migrate deploy' points from the migration history to a database labelled 'production'.](/docs/img/orm/prisma-migrate/workflows/deploy-db.png)
