...
**Timeout configuration:** Configure connection and pool timeouts via your [driver adapter](../../../prisma-client/setup-and-configuration/databases-connections/connection-pool/index.md) (e.g. `connectionTimeoutMillis` for `pg`).
...
See [connection pool guide](../../../prisma-client/setup-and-configuration/databases-connections/connection-pool/index.md#postgresql-using-the-pg-driver-adapter) for configuration.
