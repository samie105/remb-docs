---
title: "MongoDB"
source: "https://www.prisma.io/docs/orm/core-concepts/supported-databases/mongodb"
canonical_url: "https://www.prisma.io/docs/orm/core-concepts/supported-databases/mongodb"
docset: "prisma"
kind: "library"
adapter: "generic"
last_crawled_at: "2026-04-27T19:36:42.157Z"
content_hash: "ab0b25eb686eca92607c721f1950f438d1658f93f1a9c4f098291fe830d81001"
menu_path: ["MongoDB"]
section_path: []
...
-   model your database with the [Prisma Schema Language](../../../prisma-schema/overview/index.md)
...
-   use [Introspection](../../../prisma-schema/introspection/index.md) for existing projects if you already have a MongoDB database
-   use [`db push`](../../../prisma-migrate/workflows/prototyping-your-schema/index.md) to push changes in your schema to the database
-   use [Prisma Client](../../../prisma-client/setup-and-configuration/introduction/index.md) in your application to query your database in a type safe way based on your Prisma Schema
...
### [Performance considerations for large collections](#performance-considerations-for-large-collections)
...
### [How to migrate existing data to match your Prisma schema](#how-to-migrate-existing-data-to-match-your-prisma-schema)
...
### [How to add in missing relations after Introspection](#how-to-add-in-missing-relations-after-introspection)
...
For more information on how to use relations in Prisma ORM, see [our documentation](../../../prisma-schema/data-model/relations/index.md).
...
To include missing fields as well, use the [`isSet` filter](../../../reference/prisma-client-reference/index.md#isset) to explicitly search for fields which are either `null` or not set. This will return both records:
...
-   [Start from scratch](https://www.prisma.io/docs/prisma-orm/quickstart/mongodb)
-   [Add to existing project](https://www.prisma.io/docs/prisma-orm/add-to-existing-project/mongodb)
...
Further reference information is available in the [MongoDB connector documentation](index.md).
...
To connect to a MongoDB server, configure the [`datasource`](../../../prisma-schema/overview/data-sources/index.md) block in your [Prisma Schema](../../../prisma-schema/overview/index.md):
...
-   `url`: Specifies the [connection URL](#connection-url) for the MongoDB server. In this case, an [environment variable is used](../../../more/dev-environment/environment-variables/index.md) to provide the connection URL.
...
![Structure of the MongoDB connection URL](/docs/img/orm/core-concepts/databases/mongodb.png)

#### [Base URL and path](#base-url-and-path)
...
See also: [Defining ID fields in MongoDB](../../../prisma-schema/data-model/models/index.md#defining-ids-in-mongodb)
...
Currently, there are no plans to add support for [Prisma Migrate](../../../prisma-migrate/index.md) as MongoDB projects do not rely on internal schemas where changes need to be managed with an extra tool. Management of `@unique` indexes is realized through `db push`.

### [No support for `@@id` and `autoincrement()`](#no-support-for-id-and-autoincrement)

The [`@@id`](../../../reference/prisma-schema-reference/index.md) attribute (an ID for multiple fields) is not supported because primary keys in MongoDB are always on the `_id` field of a model.

The [`autoincrement()`](../../../reference/prisma-schema-reference/index.md#generate-autoincrementing-integers-as-ids-relational-databases-only) function (which creates incrementing `@id` values) is not supported because `autoincrement()` does not work with the `ObjectID` type that the `_id` field has in MongoDB.

### [Cyclic references and referential actions](#cyclic-references-and-referential-actions)

If you have cyclic references in your models, either from self-relations or a cycle of relations between models, and you use [referential actions](../../../prisma-schema/data-model/relations/referential-actions/index.md), you must set a referential action of `NoAction` to prevent an infinite loop of actions.

See [Special rules for referential actions](../../../prisma-schema/data-model/relations/referential-actions/index.md#special-rules-for-sql-server-and-mongodb) for more details.
...
The MongoDB connector maps the [scalar types](../../../prisma-schema/data-model/models/index.md#scalar-fields) from the Prisma ORM [data model](../../../prisma-schema/data-model/models/index.md) to MongoDB's native column types as follows:

> Alternatively, see [Prisma schema reference](../../../reference/prisma-schema-reference/index.md#model-field-scalar-types) for type mappings organized by Prisma type.
...
When introspecting a MongoDB database, Prisma ORM uses the relevant [scalar types](../../../prisma-schema/data-model/models/index.md#scalar-fields). Some special types also get additional native type annotations:

| MongoDB (Type | Aliases) | Prisma ORM | Supported | Native database type attribute | Notes |
| --- | --- | --- | --- | --- |
| `objectId` | `String` | ✔️ | `@db.ObjectId` |  |

[Introspection](../../../prisma-schema/introspection/index.md) adds native database types that are **not yet supported** as [`Unsupported`](../../../reference/prisma-schema-reference/index.md#unsupported) fields:
