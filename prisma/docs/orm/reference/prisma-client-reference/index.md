...
Specifies a [driver adapter](../../core-concepts/supported-databases/database-drivers/index.md#driver-adapters) for database connections. Required unless using [`accelerateUrl`](#accelerateurl).
...
Determines the type and level of logging. See also: [Logging](../../prisma-client/observability-and-logging/logging/index.md)
...
Defines an array of [SQL commenter plugins](../../prisma-client/observability-and-logging/sql-comments/index.md) that add metadata to your SQL queries as comments. This is useful for observability, debugging, and correlating queries with application traces.
...
For more details, see [SQL comments](../../prisma-client/observability-and-logging/sql-comments/index.md).

### [`transactionOptions`](#transactionoptions)

Sets default [transaction options](../../prisma-client/queries/transactions/index.md#transaction-isolation-level) globally.
...
| `isolationLevel` | Sets the [transaction isolation level](../../prisma-client/queries/transactions/index.md#transaction-isolation-level). By default this is set to the value currently configured in your database. The available levels can vary depending on the database you use. |
...
Use model queries to perform CRUD operations on your models. See also: [CRUD](../../prisma-client/queries/crud/index.md)
...
-   Prisma Client's dataloader [automatically batches `findUnique()` queries](../../prisma-client/queries/advanced/query-optimization-performance/index.md#using-findunique-with-the-fluent-api) with the same `select` and `where` parameters.
...
-   You cannot use [filter conditions](#filter-conditions-and-operators) (e.g. `equals`, `contains`, `not`) to filter fields of the [JSON](../prisma-schema-reference/index.md#json) data type. Using filter conditions will likely result in a `null` response for that field.
...
| `include` | `XOR<UserInclude, null>` | No | [Specifies which relations should be eagerly loaded](../../prisma-client/queries/relation-queries/index.md) on the returned object. |
...
| `relationLoadStrategy` | `'join'` or `'query'` | No | **Default: `join`**. [Load strategy](../../prisma-client/queries/relation-queries/index.md#relation-load-strategies-preview) for relations. Requires `relationJoins` preview feature. |
...
| `include` | `XOR<PostInclude, null>` | No | [Specifies which relations should be eagerly loaded](../../prisma-client/queries/relation-queries/index.md) on the returned object. |
...
| [`include`](#include) | `XOR<UserInclude, null>` | No | [Specifies which relations should be eagerly loaded](../../prisma-client/queries/relation-queries/index.md) on the returned object. |
...
| JavaScript object (typed) | `User` |  |
| JavaScript object (plain) | `{ name: "Alice Wonderland" }` | Use `select` and `include` to determine which fields to return. |
| `PrismaClientKnownRequestError` (code `P2025`) |  | Thrown if the record to update does not exist. See [Error reference](../error-reference/index.md#p2025) |
...
If multiple upsert operations happen at the same time and the record doesn't already exist, then one or more of the operations might return a [unique key constraint error](../error-reference/index.md#p2002).
...
-   The query does _not_ include a selection that uses a [nested read](../../prisma-client/queries/relation-queries/index.md#nested-reads)
...
| `PrismaClientKnownRequestError` (code `P2025`) |  | Thrown if the record to delete does not exist. See [Error reference](../error-reference/index.md#p2025) |
...
-   You **cannot** create or connect relations by using nested `create`, `createMany`, `connect`, `connectOrCreate` queries inside a top-level `createMany()` query. See here for a [workaround](../../prisma-client/queries/relation-queries/index.md#using-nested-createmany).
...
| [`include`](#include) | `XOR<UserInclude, null>` | No | [Specifies which relations should be eagerly loaded](../../prisma-client/queries/relation-queries/index.md) on the returned objects. |
| `skipDuplicates?` | `boolean` | No | Do not insert records with unique fields or ID fields that already exist. Only supported by databases that support [`ON CONFLICT DO NOTHING`](https://www.postgresql.org/docs/9.5/sql-insert.html#SQL-ON-CONFLICT). This excludes MongoDB and SQLServer |
...
-   You **cannot** create or connect relations by using nested `create`, `createMany`, `connect`, `connectOrCreate` queries inside a top-level `createManyAndReturn()` query. See here for a [workaround](../../prisma-client/queries/relation-queries/index.md#using-nested-createmany).
...
See also: [Aggregation, grouping, and summarizing](../../prisma-client/queries/aggregation-grouping-summarizing/index.md#aggregate)
...
See also: [Aggregation, grouping, and summarizing](../../prisma-client/queries/aggregation-grouping-summarizing/index.md#group-by)
...
See: [Using Raw SQL (`findRaw()`)](../../prisma-client/using-raw-sql/raw-queries/index.md#findraw).

### [`aggregateRaw()`](#aggregateraw)

See: [Using Raw SQL (`aggregateRaw()`)](../../prisma-client/using-raw-sql/raw-queries/index.md#aggregateraw).
...
> **Note**: Once `relationLoadStrategy` moves from [Preview](../../more/releases/index.md#preview) into [General Availability](../../more/releases/index.md#generally-available-ga), `join` will universally become the default for all relation queries.

You can learn more about join strategies [here](../../prisma-client/queries/relation-queries/index.md#relation-load-strategies-preview).
...
-   For use on optional [scalar](../../prisma-schema/data-model/models/index.md#scalar-fields) fields only. If you try to sort by nulls on a required or [relation](../../prisma-schema/data-model/models/index.md#relation-fields) field, Prisma Client throws a [P2009 error](../error-reference/index.md#p2009).
...
Deduplicate a list of records from [`findMany`](#findmany) or [`findFirst`](#findfirst). See also: [Aggregation, grouping, and summarizing](../../prisma-client/queries/aggregation-grouping-summarizing/index.md#select-distinct)
...
See [Preview Features](../preview-features/client-preview-features/index.md#preview-features-promoted-to-general-availability) for more details.

### [`create`](#create-1)

A nested `create` query adds a new related record or set of records to a parent record. See: [Working with relations](../../prisma-client/queries/relation-queries/index.md)
...
A nested `createMany` query adds a new set of records to a parent record. See: [Working with relations](../../prisma-client/queries/relation-queries/index.md)
...
-   You can use a nested `create` _or_ a nested `createMany` to create multiple related records - [if you do not need the `skipDuplicates` query option, you should probably use `create`](../../prisma-client/queries/relation-queries/index.md#create-a-single-record-and-multiple-related-records).
...
`set` overwrites the value of a relation - for example, replacing a list of `Post` records with a different list. See: [Working with relations](../../prisma-client/queries/relation-queries/index.md)
...
A nested `connect` query connects a record to an existing related record by specifying an ID or unique identifier. See: [Working with relations](../../prisma-client/queries/relation-queries/index.md)
...
`connectOrCreate` _either_ connects a record to an existing related record by ID or unique identifier _or_ creates a new related record if the record does not exist. See: [Working with relations](../../prisma-client/queries/relation-queries/index.md)
...
A nested `disconnect` query breaks the connection between a parent record and a related record, but does not delete either record. See: [Working with relations](../../prisma-client/queries/relation-queries/index.md)
...
A nested `update` query updates one or more related records where the parent record's ID is `n`. See: [Working with relations](../../prisma-client/queries/relation-queries/index.md#update-a-specific-related-record)
...
-   Scalar list / array filters [ignore `NULL` values](../../prisma-client/special-fields-and-types/working-with-scalar-lists-arrays/index.md#null-values-in-arrays) . Using `isEmpty` or `NOT` does not return records with `NULL` value lists / arrays, and `{ equals: null }` results in an error.
...
Composite type methods allow you to create, update and delete [composite types](../../prisma-client/special-fields-and-types/composite-types/index.md) (MongoDB only).
...
Composite type filters allow you to filter the contents of [composite types](../../prisma-client/special-fields-and-types/composite-types/index.md) (MongoDB only).
...
For use cases and advanced examples, see: [Working with `Json` fields](../../prisma-client/special-fields-and-types/working-with-json-fields/index.md).
...
-   The implementation of `Json` filtering [differs between database connectors](../../prisma-client/special-fields-and-types/working-with-json-fields/index.md)
...
The `$disconnect()` method closes the database connections that were established when `$connect` was called and stops the process that was running Prisma ORM's query engine. See [Connection management](../../prisma-client/setup-and-configuration/databases-connections/connection-management/index.md) for an overview of `$connect()` and `$disconnect()`.

-   `$disconnect()` returns a `Promise`, so you should call it inside an `async` function with the `await` keyword.

### [`$connect()`](#connect-1)

The `$connect()` method establishes a physical connection to the database via Prisma ORM's query engine. See [Connection management](../../prisma-client/setup-and-configuration/databases-connections/connection-management/index.md) for an overview of `$connect()` and `$disconnect()`.

-   `$connect()` returns a `Promise`, so you should call it inside an `async` function with the `await` keyword.

### [`$on()`](#on)

The `$on()` method allows you to subscribe to [logging events](#log) or the [exit hook](../../prisma-client/setup-and-configuration/databases-connections/connection-management/index.md#exit-hooks).

### [`$queryRawTyped`](#queryrawtyped)

See: [Using Raw SQL (`$queryRawTyped`)](../../prisma-client/using-raw-sql/typedsql/index.md).

### [`$queryRaw`](#queryraw)

See: [Using Raw SQL (`$queryRaw`)](../../prisma-client/using-raw-sql/raw-queries/index.md#queryraw).

### [`$queryRawUnsafe()`](#queryrawunsafe)

See: [Using Raw SQL (`$queryRawUnsafe()`)](../../prisma-client/using-raw-sql/raw-queries/index.md#queryrawunsafe).

### [`$executeRaw`](#executeraw)

See: [Using Raw SQL (`$executeRaw`)](../../prisma-client/using-raw-sql/raw-queries/index.md#executeraw).

### [`$executeRawUnsafe()`](#executerawunsafe)

See: [Using Raw SQL (`$executeRawUnsafe()`)](../../prisma-client/using-raw-sql/raw-queries/index.md#executerawunsafe).

### [`$runCommandRaw()`](#runcommandraw)

See: [Using Raw SQL (`$runCommandRaw()`)](../../prisma-client/using-raw-sql/raw-queries/index.md#runcommandraw).

### [`$transaction()`](#transaction)

See: [Transactions](../../prisma-client/queries/transactions/index.md).
...
Learn more: [Prisma Client extensions](../../prisma-client/client-extensions/index.md).
...
You can use TypeScript's `satisfies` operator to create re-usable query parameters based on your schema models while ensuring that the objects you create are type-compatible with the generated Prisma Client types. See also: [Type safety with Prisma Client](../../prisma-client/type-safety/index.md).
...
-   Filter on optional [one-to-one nested reads](../../prisma-client/queries/relation-queries/index.md#nested-reads)

### [Optimistic concurrency control on updates](#optimistic-concurrency-control-on-updates)

You can filter on non-unique fields to perform [optimistic concurrency control](../../prisma-client/queries/transactions/index.md#optimistic-concurrency-control) on `update` operations.
...
You can filter on non-unique fields in the following operations on [one-to-one relations](../../prisma-schema/data-model/relations/one-to-one-relations/index.md):
...
When using the [`$transaction` API](../../prisma-client/queries/transactions/index.md#the-transaction-api), this behavior makes it possible for Prisma Client to pass all the queries on to the query engine as a single transaction.
