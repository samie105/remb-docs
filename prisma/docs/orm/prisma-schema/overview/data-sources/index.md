...
A data source determines how Prisma ORM connects to your database, and is represented by the [`datasource`](../../../reference/prisma-schema-reference/index.md#datasource) block in the Prisma schema. Connection details (such as the database URL) are configured in [Prisma Config](../../../reference/prisma-config-reference/index.md). The following data source uses the `postgresql` provider:
...
-   [Override the database connection when creating your `PrismaClient`](../../../reference/prisma-client-reference/index.md)
-   [Specify a different **database** for Prisma Migrate's shadow database if you are working with cloud-hosted development databases](../../../prisma-migrate/understanding-prisma-migrate/shadow-database/index.md#cloud-hosted-shadow-databases-must-be-created-manually)
...
-   [Configuring an SSL connection with PostgreSQL](../../../core-concepts/supported-databases/postgresql/index.md#common-patterns)
-   [Configuring an SSL connection with MySQL](../../../core-concepts/supported-databases/mysql/index.md#common-patterns)
-   [Configure a TLS connection with Microsoft SQL Server](../../../core-concepts/supported-databases/sql-server/index.md#connection-details)
