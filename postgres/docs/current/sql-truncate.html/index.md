---
title: "PostgreSQL: Documentation: 18: TRUNCATE"
source: "https://www.postgresql.org/docs/current/sql-truncate.html"
canonical_url: "https://www.postgresql.org/docs/current/sql-truncate.html"
docset: "postgres"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:47:23.125Z"
...
section_path: []
nav_prev: {"path": "../sql-syntax-lexical.html/index.md", "title": "PostgreSQL: Documentation: 18: 4.1.\u00a0Lexical Structure"}
nav_next: {"path": "../sql-unlisten.html/index.md", "title": "PostgreSQL: Documentation: 18: UNLISTEN"}
---
...
`TRUNCATE` is not MVCC-safe. After truncation, the table will appear empty to concurrent transactions, if they are using a snapshot taken before the truncation occurred. See [Section 13.6](https://www.postgresql.org/docs/current/mvcc-caveats.html "13.6. Caveats") for more details.
...
`TRUNCATE` can be used for foreign tables if supported by the foreign data wrapper, for instance, see [postgres\_fdw](https://www.postgresql.org/docs/current/postgres-fdw.html "F.38. postgres_fdw — access data stored in external PostgreSQL servers").
