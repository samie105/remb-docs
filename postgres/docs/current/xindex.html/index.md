---
title: "PostgreSQL: Documentation: 18: 36.16. Interfacing Extensions to Indexes"
source: "https://www.postgresql.org/docs/current/xindex.html"
canonical_url: "https://www.postgresql.org/docs/current/xindex.html"
docset: "postgres"
kind: "database"
adapter: "generic"
...
section_path: []
content_language: "en"
nav_prev: {"path": "../xfunc.html/index.md", "title": "PostgreSQL: Documentation: 18: 36.3.\u00a0User-Defined Functions"}
nav_next: {"path": "../xoper-optimization.html/index.md", "title": "PostgreSQL: Documentation: 18: 36.15.\u00a0Operator Optimization Information"}
---
...
### 36.16.1. Index Methods and Operator Classes [#](#XINDEX-OPCLASS)

Operator classes are associated with an index access method, such as [B-Tree](https://www.postgresql.org/docs/current/btree.html "65.1. B-Tree Indexes") or [GIN](https://www.postgresql.org/docs/current/gin.html "65.4. GIN Indexes"). Custom index access method may be defined with [CREATE ACCESS METHOD](https://www.postgresql.org/docs/current/sql-create-access-method.html "CREATE ACCESS METHOD"). See [Chapter 63](https://www.postgresql.org/docs/current/indexam.html "Chapter 63. Index Access Method Interface Definition") for details.
...
### 36.16.2. Index Method Strategies [#](#XINDEX-STRATEGIES)
...
The B-tree index method defines five strategies, shown in [Table 36.3](https://www.postgresql.org/docs/current/xindex.html#XINDEX-BTREE-STRAT-TABLE "Table 36.3. B-Tree Strategies").
...
### 36.16.3. Index Method Support Routines [#](#XINDEX-SUPPORT)
...
### 36.16.4. An Example [#](#XINDEX-EXAMPLE)
...
static int
complex\_abs\_cmp\_internal(Complex \*a, Complex \*b)
{
    double      amag = Mag(a),
                bmag = Mag(b);
...
PG\_FUNCTION\_INFO\_V1(complex\_abs\_lt);

Datum
complex\_abs\_lt(PG\_FUNCTION\_ARGS)
{
    Complex    \*a = (Complex \*) PG\_GETARG\_POINTER(0);
    Complex    \*b = (Complex \*) PG\_GETARG\_POINTER(1);

    PG\_RETURN\_BOOL(complex\_abs\_cmp\_internal(a, b) < 0);
}
...
CREATE FUNCTION complex\_abs\_lt(complex, complex) RETURNS bool
    AS '_`filename`_', 'complex\_abs\_lt'
    LANGUAGE C IMMUTABLE STRICT;

CREATE OPERATOR < (
   leftarg = complex, rightarg = complex, procedure = complex\_abs\_lt,
   commutator = > , negator = >= ,
...
CREATE FUNCTION complex\_abs\_cmp(complex, complex)
    RETURNS integer
    AS '_`filename`_'
    LANGUAGE C IMMUTABLE STRICT;
...
CREATE OPERATOR CLASS complex\_abs\_ops
    DEFAULT FOR TYPE complex USING btree AS
        ...
        OPERATOR        4       >= ,
        OPERATOR        5       > ,
        FUNCTION        1       complex\_abs\_cmp(complex, complex);
...
### 36.16.5. Operator Classes and Operator Families [#](#XINDEX-OPFAMILY)
...
CREATE OPERATOR FAMILY integer\_ops USING btree;

CREATE OPERATOR CLASS int8\_ops
DEFAULT FOR TYPE int8 USING btree FAMILY integer\_ops AS
  ...
  FUNCTION 3 in\_range(int8, int8, int8, boolean, boolean) ,
  FUNCTION 4 btequalimage(oid) ,
  FUNCTION 6 btint8skipsupport(internal) ;

CREATE OPERATOR CLASS int4\_ops
DEFAULT FOR TYPE int4 USING btree FAMILY integer\_ops AS
  ...
  FUNCTION 3 in\_range(int4, int4, int4, boolean, boolean) ,
  FUNCTION 4 btequalimage(oid) ,
  FUNCTION 6 btint4skipsupport(internal) ;

CREATE OPERATOR CLASS int2\_ops
DEFAULT FOR TYPE int2 USING btree FAMILY integer\_ops AS
  ...
  FUNCTION 3 in\_range(int2, int2, int2, boolean, boolean) ,
  FUNCTION 4 btequalimage(oid) ,
...
ALTER OPERATOR FAMILY integer\_ops USING btree ADD
  ...
  -- cross-type in\_range functions
  FUNCTION 3 in\_range(int4, int4, int8, boolean, boolean) ,
  FUNCTION 3 in\_range(int4, int4, int2, boolean, boolean) ,
  FUNCTION 3 in\_range(int2, int2, int8, boolean, boolean) ,
  FUNCTION 3 in\_range(int2, int2, int4, boolean, boolean) ;
...
### 36.16.6. System Dependencies on Operator Classes [#](#XINDEX-OPCLASS-DEPENDENCIES)
...
### 36.16.7. Ordering Operators [#](#XINDEX-ORDERING-OPS)
...
OPERATOR 15    <-> (point, point) FOR ORDER BY float\_ops
...
### 36.16.8. Special Features of Operator Classes [#](#XINDEX-OPCLASS-FEATURES)
...
SELECT \* FROM table WHERE integer\_column < 4;
...
CREATE OPERATOR CLASS polygon\_ops
