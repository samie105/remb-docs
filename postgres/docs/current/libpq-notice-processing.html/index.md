---
title: "PostgreSQL: Documentation: 18: 32.13. Notice Processing"
source: "https://www.postgresql.org/docs/current/libpq-notice-processing.html"
canonical_url: "https://www.postgresql.org/docs/current/libpq-notice-processing.html"
docset: "postgres"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:32:20.426Z"
content_hash: "70fcecf57d1f76844d04a8534f43cb10833326e58456c24582848ac1de60b80b"
menu_path: ["PostgreSQL: Documentation: 18: 32.13. Notice Processing"]
section_path: []
nav_prev: {"path": "../libpq-envars.html/index.md", "title": "PostgreSQL: Documentation: 18: 32.15.\u00a0Environment Variables"}
nav_next: {"path": "../lo-examplesect.html/index.md", "title": "PostgreSQL: Documentation: 18: 33.5.\u00a0Example Program"}
---
...
When a notice or warning message is received from the server, or generated internally by libpq, the notice receiver function is called. It is passed the message in the form of a `PGRES_NONFATAL_ERROR` `PGresult`. (This allows the receiver to extract individual fields using [`PQresultErrorField`](https://www.postgresql.org/docs/current/libpq-exec.html#LIBPQ-PQRESULTERRORFIELD), or obtain a complete preformatted message using [`PQresultErrorMessage`](https://www.postgresql.org/docs/current/libpq-exec.html#LIBPQ-PQRESULTERRORMESSAGE) or [`PQresultVerboseErrorMessage`](https://www.postgresql.org/docs/current/libpq-exec.html#LIBPQ-PQRESULTVERBOSEERRORMESSAGE).) The same void pointer passed to `PQsetNoticeReceiver` is also passed. (This pointer can be used to access application-specific state if needed.)

The default notice receiver simply extracts the message (using [`PQresultErrorMessage`](https://www.postgresql.org/docs/current/libpq-exec.html#LIBPQ-PQRESULTERRORMESSAGE)) and passes it to the notice processor.
