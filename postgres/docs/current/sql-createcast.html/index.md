---
title: "PostgreSQL: Documentation: 18: CREATE CAST"
source: "https://www.postgresql.org/docs/current/sql-createcast.html"
canonical_url: "https://www.postgresql.org/docs/current/sql-createcast.html"
docset: "postgres"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:40:11.052Z"
...
CREATE CAST (_`source_type`_ AS _`target_type`_)
    WITH FUNCTION _`function_name`_ \[ (_`argument_type`_ \[, ...\]) \]
...
Use [`DROP CAST`](https://www.postgresql.org/docs/current/sql-dropcast.html "DROP CAST") to remove user-defined casts.
