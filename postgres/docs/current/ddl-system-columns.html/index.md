---
title: "PostgreSQL: Documentation: 18: 5.6. System Columns"
source: "https://www.postgresql.org/docs/current/ddl-system-columns.html"
canonical_url: "https://www.postgresql.org/docs/current/ddl-system-columns.html"
docset: "postgres"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:34:05.720Z"
...
The OID of the table containing this row. This column is particularly handy for queries that select from partitioned tables (see [Section 5.12](https://www.postgresql.org/docs/current/ddl-partitioning.html "5.12. Table Partitioning")) or inheritance hierarchies (see [Section 5.11](https://www.postgresql.org/docs/current/ddl-inherit.html "5.11. Inheritance")), since without it, it's difficult to tell which individual table a row came from. The `tableoid` can be joined against the `oid` column of `pg_class` to obtain the table name.
