---
title: "PostgreSQL: Documentation: 18: 44.6. Database Access"
source: "https://www.postgresql.org/docs/current/plpython-database.html"
canonical_url: "https://www.postgresql.org/docs/current/plpython-database.html"
docset: "postgres"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:50:22.347Z"
...
section_path: []
nav_prev: {"path": "../plpython-data.html/index.md", "title": "PostgreSQL: Documentation: 18: 44.2.\u00a0Data Values"}
nav_next: {"path": "../plpython-envar.html/index.md", "title": "PostgreSQL: Documentation: 18: 44.11.\u00a0Environment Variables"}
---
...
Query parameters and result row fields are converted between PostgreSQL and Python data types as described in [Section 44.2](https://www.postgresql.org/docs/current/plpython-data.html "44.2. Data Values").

When you prepare a plan using the PL/Python module it is automatically saved. Read the SPI documentation ([Chapter 45](https://www.postgresql.org/docs/current/spi.html "Chapter 45. Server Programming Interface")) for a description of what this means. In order to make effective use of this across function calls one needs to use one of the persistent storage dictionaries `SD` or `GD` (see [Section 44.3](https://www.postgresql.org/docs/current/plpython-sharing.html "44.3. Sharing Data")). For example:
