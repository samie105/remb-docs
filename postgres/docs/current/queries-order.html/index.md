---
title: "PostgreSQL: Documentation: 18: 7.5. Sorting Rows (ORDER BY)"
source: "https://www.postgresql.org/docs/current/queries-order.html"
canonical_url: "https://www.postgresql.org/docs/current/queries-order.html"
docset: "postgres"
kind: "database"
adapter: "generic"
...
section_path: []
content_language: "en"
nav_prev: {"path": "../protocol-replication.html/index.md", "title": "PostgreSQL: Documentation: 18: 54.4.\u00a0Streaming Replication Protocol"}
nav_next: {"path": "../queries-overview.html/index.md", "title": "PostgreSQL: Documentation: 18: 7.1.\u00a0Overview"}
---
...
SELECT _`select_list`_
    ...
    ORDER BY _`sort_expression1`_ \[ASC | DESC\] \[NULLS { FIRST | LAST }\]
             \[, _`sort_expression2`_ \[ASC | DESC\] \[NULLS { FIRST | LAST }\] ...\]
