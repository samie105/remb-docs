...
section_path: []
nav_prev: {"path": "../sql-reassign-owned.html/index.md", "title": "PostgreSQL: Documentation: 18: REASSIGN OWNED"}
nav_next: {"path": "../sql-reindex.html/index.md", "title": "PostgreSQL: Documentation: 18: REINDEX"}
---
...
While `REFRESH MATERIALIZED VIEW` is running, the [search\_path](../runtime-config-client.html/index.md#GUC-SEARCH-PATH) is temporarily changed to `pg_catalog, pg_temp`.
