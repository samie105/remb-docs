---
title: "PostgreSQL: Documentation: 18: 19.1. Setting Parameters"
source: "https://www.postgresql.org/docs/current/config-setting.html"
canonical_url: "https://www.postgresql.org/docs/current/config-setting.html"
docset: "postgres"
kind: "database"
adapter: "generic"
...
### 19.1.3. Parameter Interaction via SQL [#](#CONFIG-SETTING-SQL)
...
### 19.1.4. Parameter Interaction via the Shell [#](#CONFIG-SETTING-SHELL)
...
### 19.1.5. Managing Configuration File Contents [#](#CONFIG-INCLUDES)
