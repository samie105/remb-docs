---
title: "Index"
source: "https://www.postgresql.org/docs/current/bookindex.html"
canonical_url: "https://www.postgresql.org/docs/current/bookindex.html"
docset: "postgres"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:44:35.270Z"
...
Supported Versions: [Current](/docs/current/bookindex.html "PostgreSQL 18 - Index") ([18](/docs/18/bookindex.html "PostgreSQL 18 - Index")) / [17](/docs/17/bookindex.html "PostgreSQL 17 - Index") / [16](/docs/16/bookindex.html "PostgreSQL 16 - Index") / [15](/docs/15/bookindex.html "PostgreSQL 15 - Index") / [14](/docs/14/bookindex.html "PostgreSQL 14 - Index")

Development Versions: [devel](/docs/devel/bookindex.html "PostgreSQL devel - Index")

Unsupported versions: [13](/docs/13/bookindex.html "PostgreSQL 13 - Index") / [12](/docs/12/bookindex.html "PostgreSQL 12 - Index") / [11](/docs/11/bookindex.html "PostgreSQL 11 - Index") / [10](/docs/10/bookindex.html "PostgreSQL 10 - Index") / [9.6](/docs/9.6/bookindex.html "PostgreSQL 9.6 - Index") / [9.5](/docs/9.5/bookindex.html "PostgreSQL 9.5 - Index") / [9.4](/docs/9.4/bookindex.html "PostgreSQL 9.4 - Index") / [9.3](/docs/9.3/bookindex.html "PostgreSQL 9.3 - Index") / [9.2](/docs/9.2/bookindex.html "PostgreSQL 9.2 - Index") / [9.1](/docs/9.1/bookindex.html "PostgreSQL 9.1 - Index") / [9.0](/docs/9.0/bookindex.html "PostgreSQL 9.0 - Index") / [8.4](/docs/8.4/bookindex.html "PostgreSQL 8.4 - Index") / [8.3](/docs/8.3/bookindex.html "PostgreSQL 8.3 - Index") / [8.2](/docs/8.2/bookindex.html "PostgreSQL 8.2 - Index") / [8.1](/docs/8.1/bookindex.html "PostgreSQL 8.1 - Index") / [8.0](/docs/8.0/bookindex.html "PostgreSQL 8.0 - Index") / [7.4](/docs/7.4/bookindex.html "PostgreSQL 7.4 - Index")
...
\_PG\_oauth\_validator\_module\_init, [Initialization Functions](oauth-validator-init.html)
...
age, [Date/Time Functions and Operators](functions-datetime.html), [Transaction ID and Snapshot Information Functions](functions-info.html#FUNCTIONS-INFO-SNAPSHOT)
...
allow\_alter\_system configuration parameter, [Platform and Client Compatibility](runtime-config-compatible.html#RUNTIME-CONFIG-COMPATIBLE-CLIENTS)
...
ALTER\_REPLICATION\_SLOT, [Streaming Replication Protocol](protocol-replication.html)
...
array\_reverse, [Array Functions and Operators](functions-array.html)
...
array\_sort, [Array Functions and Operators](functions-array.html)
...
Asynchronous I/O, [Glossary](glossary.html)
...
auto-increment (see [serial](#ientry-id-1.5.7.9.9.3))
...
autovacuum configuration parameter, [Automatic Vacuuming](runtime-config-vacuum.html#RUNTIME-CONFIG-AUTOVACUUM)

autovacuum\_analyze\_scale\_factor

configuration parameter, [Automatic Vacuuming](runtime-config-vacuum.html#RUNTIME-CONFIG-AUTOVACUUM)
...
autovacuum\_max\_workers configuration parameter, [Automatic Vacuuming](runtime-config-vacuum.html#RUNTIME-CONFIG-AUTOVACUUM)
...
autovacuum\_naptime configuration parameter, [Automatic Vacuuming](runtime-config-vacuum.html#RUNTIME-CONFIG-AUTOVACUUM)
...
autovacuum\_vacuum\_max\_threshold
...
autovacuum\_worker\_slots configuration parameter, [Automatic Vacuuming](runtime-config-vacuum.html#RUNTIME-CONFIG-AUTOVACUUM)
...
B-Tree (see [index](#ientry-id-1.5.10.2))

backend\_flush\_after configuration parameter, [I/O](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-IO)
...
BLOB (see [large object](#ientry-id-1.7.4.2))
...
BRIN (see [index](#ientry-id-1.5.10.2))
...
canceling SQL queries, [Canceling Queries in Progress](libpq-cancel.html)
...
casefold, [String Functions and Operators](functions-string.html)
...
of databases (see [database cluster](#ientry-id-1.4.4.3.4.1))
...
commit\_timestamp\_buffers configuration parameter, [Memory](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-MEMORY)

common table expression (see [WITH](#ientry-id-1.5.6.12.2))
...
crc32, [Binary String Functions and Operators](functions-binarystring.html)

crc32c, [Binary String Functions and Operators](functions-binarystring.html)
...
data area (see [database cluster](#ientry-id-1.4.4.3.4.1))
...
(see also [formatting](#ientry-id-1.5.8.14.2))
...
debug\_copy\_parse\_plan\_trees configuration parameter, [Developer Options](runtime-config-developer.html)
...
debug\_raw\_expression\_coverage\_test configuration parameter, [Developer Options](runtime-config-developer.html)

debug\_write\_read\_parse\_plan\_trees configuration parameter, [Developer Options](runtime-config-developer.html)

decimal (see [numeric](#ientry-id-1.5.3.5.9.9.8.3))
...
disk usage, [Determining Disk Usage](diskusage.html#DISK-USAGE)
...
effective\_io\_concurrency configuration parameter, [I/O](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-IO)
...
enable\_distinct\_reordering configuration parameter, [Planner Method Configuration](runtime-config-query.html#RUNTIME-CONFIG-QUERY-ENABLE)
...
enable\_group\_by\_reordering configuration parameter, [Planner Method Configuration](runtime-config-query.html#RUNTIME-CONFIG-QUERY-ENABLE)
...
enable\_self\_join\_elimination configuration parameter, [Planner Method Configuration](runtime-config-query.html#RUNTIME-CONFIG-QUERY-ENABLE)
...
in PGcancelConn, [Functions for Sending Cancel Requests](libpq-cancel.html#LIBPQ-CANCEL-FUNCTIONS)

in PGconn, [Connection Status Functions](libpq-status.html)
...
extension\_control\_path configuration parameter, [Other Defaults](runtime-config-client.html#RUNTIME-CONFIG-CLIENT-OTHER)
...
file\_copy\_method configuration parameter, [Disk](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-DISK)

file\_extend\_method configuration parameter, [Disk](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-DISK)
...
fips\_mode, [OpenSSL Support Functions](pgcrypto.html#PGCRYPTO-OPENSSL-SUPPORT-FUNCS)

first\_value, [Window Functions](functions-window.html)

flex, [Requirements](install-requirements.html)

float4 (see [real](#ientry-id-1.5.7.9.8.2))

float8 (see [double precision](#ientry-id-1.5.7.9.8.3))
...
FSM (see [Free Space Map](#ientry-id-1.10.18.5.2))
...
gamma, [Mathematical Functions and Operators](functions-math.html)
...
GEQO (see [genetic query optimization](#ientry-id-1.6.6.10.4.3.1.1.3))
...
GIN (see [index](#ientry-id-1.5.10.2))
...
gin\_index\_check, [Functions](amcheck.html#AMCHECK-FUNCTIONS)
...
GiST (see [index](#ientry-id-1.5.10.2))
...
hash (see [index](#ientry-id-1.5.10.2))
...
has\_largeobject\_privilege, [Access Privilege Inquiry Functions](functions-info.html#FUNCTIONS-INFO-ACCESS)
...
icu\_unicode\_version, [Version Information Functions](functions-info.html#FUNCTIONS-INFO-VERSION)
...
identity column, [Identity Columns](ddl-identity-columns.html)
...
idle\_replication\_slot\_timeout configuration parameter, [Sending Servers](runtime-config-replication.html#RUNTIME-CONFIG-REPLICATION-SENDER)
...
initplan, [EXPLAIN Basics](using-explain.html#USING-EXPLAIN-BASICS)
...
int2 (see [smallint](#ientry-id-1.5.7.9.6.3))

int4 (see [integer](#ientry-id-1.5.3.5.9.9.8.1))

int8 (see [bigint](#ientry-id-1.5.3.5.9.9.8.2))
...
in\_range support functions, [B-Tree Support Functions](btree.html#BTREE-SUPPORT-FUNCS)

io\_combine\_limit configuration parameter, [I/O](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-IO)

io\_max\_combine\_limit configuration parameter, [I/O](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-IO)

io\_max\_concurrency configuration parameter, [I/O](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-IO)

io\_method configuration parameter, [I/O](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-IO)

io\_workers configuration parameter, [I/O](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-IO)
...
isn.weak configuration parameter, [Configuration Parameters](isn.html#ISN-CONFIGURATION-PARAMETERS)
...
jsonb\_populate\_record\_valid, [Processing and Creating JSON Data](functions-json.html#FUNCTIONS-JSON-PROCESSING)
...
json\_exists, [SQL/JSON Query Functions](functions-json.html#SQLJSON-QUERY-FUNCTIONS)
...
json\_query, [SQL/JSON Query Functions](functions-json.html#SQLJSON-QUERY-FUNCTIONS)
...
json\_table, [JSON\_TABLE](functions-json.html#FUNCTIONS-SQLJSON-TABLE)
...
json\_value, [SQL/JSON Query Functions](functions-json.html#SQLJSON-QUERY-FUNCTIONS)

Julian date, [Julian Dates](datetime-julian-dates.html)

Just-In-Time compilation (see [JIT](#ientry-id-1.6.17.2))
...
label (see [alias](#ientry-id-1.4.4.7.11))
...
of a character string (see [character string, length](#ientry-id-1.5.3.5.9.4.2))
...
lgamma, [Mathematical Functions and Operators](functions-math.html)
...
libpq, [libpq — C Library](libpq.html), [Pipeline Mode](libpq-pipeline-mode.html), [Retrieving Query Results in Chunks](libpq-single-row-mode.html), [Retrieving Query Results in Chunks](libpq-single-row-mode.html)

chunked mode, [Retrieving Query Results in Chunks](libpq-single-row-mode.html)

pipeline mode, [Pipeline Mode](libpq-pipeline-mode.html)

single-row mode, [Retrieving Query Results in Chunks](libpq-single-row-mode.html)
...
log\_lock\_failures configuration parameter, [What to Log](runtime-config-logging.html#RUNTIME-CONFIG-LOGGING-WHAT)
...
maintenance\_io\_concurrency configuration parameter, [I/O](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-IO)
...
max\_active\_replication\_origins configuration parameter, [Subscribers](runtime-config-replication.html#RUNTIME-CONFIG-REPLICATION-SUBSCRIBER)
...
max\_notify\_queue\_pages configuration parameter, [Disk](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-DISK)
...
max\_parallel\_maintenance\_workers configuration parameter, [Worker Processes](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-WORKER-PROCESSES)

max\_parallel\_workers configuration parameter, [Worker Processes](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-WORKER-PROCESSES)

max\_parallel\_workers\_per\_gather configuration parameter, [Worker Processes](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-WORKER-PROCESSES)
...
max\_replication\_slots configuration parameter, [Sending Servers](runtime-config-replication.html#RUNTIME-CONFIG-REPLICATION-SENDER)
...
max\_worker\_processes configuration parameter, [Worker Processes](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-WORKER-PROCESSES)
...
md5\_password\_warnings configuration parameter, [Authentication](runtime-config-connection.html#RUNTIME-CONFIG-CONNECTION-AUTHENTICATION)

median, [Aggregate Expressions](sql-expressions.html#SYNTAX-AGGREGATES)

(see also [percentile](#ientry-id-1.5.8.27.18.2.4.2.1.1.1))
...
MERGE, [Returning Data from Modified Rows](dml-returning.html), [MERGE](sql-merge.html)

RETURNING, [Returning Data from Modified Rows](dml-returning.html), [Merge Support Functions](functions-merge-support.html)

merge\_action, [Merge Support Functions](functions-merge-support.html)
...
MinGW, [MinGW](installation-platform-notes.html#INSTALLATION-NOTES-MINGW)

installation on, [MinGW](installation-platform-notes.html#INSTALLATION-NOTES-MINGW)
...
multixact\_member\_buffers configuration parameter, [Memory](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-MEMORY)

multixact\_offset\_buffers configuration parameter, [Memory](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-MEMORY)

MVCC, [Introduction](mvcc-intro.html)

mxid\_age, [Transaction ID and Snapshot Information Functions](functions-info.html#FUNCTIONS-INFO-SNAPSHOT)
...
NaN (see [not a number](#ientry-id-1.5.7.9.7.15))
...
notify\_buffers configuration parameter, [Memory](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-MEMORY)
...
num\_os\_semaphores configuration parameter, [Preset Options](runtime-config-preset.html)

NVL, [COALESCE](functions-conditional.html#FUNCTIONS-COALESCE-NVL-IFNULL)

### O

OAuth Authorization/Authentication, [OAuth Authorization/Authentication](auth-oauth.html)

OAuth Validators, [OAuth Validator Modules](oauth-validators.html)

oauth\_validator\_libraries configuration parameter, [Authentication](runtime-config-connection.html#RUNTIME-CONFIG-CONNECTION-AUTHENTICATION)
...
(see also [SSL](#ientry-id-1.6.5.12.2))
...
parallel\_leader\_participation configuration parameter, [Worker Processes](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-WORKER-PROCESSES)
...
passwordcheck.min\_password\_length configuration parameter, [Configuration Parameters](passwordcheck.html#PASSWORDCHECK-CONFIGURATION-PARAMETERS)
...
permission (see [privilege](#ientry-id-1.5.4.10.2))
...
PGcancel, [Obsolete Functions for Sending Cancel Requests](libpq-cancel.html#LIBPQ-CANCEL-DEPRECATED)

PGcancelConn, [Functions for Sending Cancel Requests](libpq-cancel.html#LIBPQ-CANCEL-FUNCTIONS)
...
pgcrypto.builtin\_crypto\_enabled configuration parameter, [Configuration Parameters](pgcrypto.html#PGCRYPTO-CONFIGURATION-PARAMETERS)
...
PGMAXPROTOCOLVERSION, [Environment Variables](libpq-envars.html)

PGMINPROTOCOLVERSION, [Environment Variables](libpq-envars.html)
...
PGSSLNEGOTIATION, [Environment Variables](libpq-envars.html)
...
pg\_aios, [pg\_aios](view-pg-aios.html)
...
pg\_available\_wal\_summaries, [WAL Summarization Information Functions](functions-info.html#FUNCTIONS-INFO-WAL-SUMMARY)
...
pg\_basetype, [System Catalog Information Functions](functions-info.html#FUNCTIONS-INFO-CATALOG)
...
pg\_buffercache\_evict, [pg\_buffercache — inspect PostgreSQL buffer cache state](pgbuffercache.html)

pg\_buffercache\_evict\_all, [pg\_buffercache — inspect PostgreSQL buffer cache state](pgbuffercache.html)

pg\_buffercache\_evict\_relation, [pg\_buffercache — inspect PostgreSQL buffer cache state](pgbuffercache.html)

pg\_buffercache\_numa, [pg\_buffercache — inspect PostgreSQL buffer cache state](pgbuffercache.html)
...
pg\_buffercache\_usage\_counts, [pg\_buffercache — inspect PostgreSQL buffer cache state](pgbuffercache.html)
...
pg\_clear\_attribute\_stats, [Database Object Management Functions](functions-admin.html#FUNCTIONS-ADMIN-DBOBJECT)

pg\_clear\_relation\_stats, [Database Object Management Functions](functions-admin.html#FUNCTIONS-ADMIN-DBOBJECT)
...
pg\_column\_toast\_chunk\_id, [Database Object Management Functions](functions-admin.html#FUNCTIONS-ADMIN-DBOBJECT)

pg\_combinebackup, [pg\_combinebackup](app-pgcombinebackup.html)
...
pg\_createsubscriber, [pg\_createsubscriber](app-pgcreatesubscriber.html)
...
pg\_get\_acl, [Object Information and Addressing Functions](functions-info.html#FUNCTIONS-INFO-OBJECT)
...
pg\_get\_loaded\_modules, [Session Information Functions](functions-info.html#FUNCTIONS-INFO-SESSION)

pg\_get\_multixact\_members, [Transaction ID and Snapshot Information Functions](functions-info.html#FUNCTIONS-INFO-SNAPSHOT)

pg\_get\_object\_address, [Object Information and Addressing Functions](functions-info.html#FUNCTIONS-INFO-OBJECT)

pg\_get\_partition\_constraintdef, [System Catalog Information Functions](functions-info.html#FUNCTIONS-INFO-CATALOG)
...
pg\_get\_wal\_summarizer\_state, [WAL Summarization Information Functions](functions-info.html#FUNCTIONS-INFO-WAL-SUMMARY)
...
pg\_logicalinspect, [pg\_logicalinspect — logical decoding components inspection](pglogicalinspect.html)
...
pg\_ls\_summariesdir, [Generic File Access Functions](functions-admin.html#FUNCTIONS-ADMIN-GENFILE)
...
PG\_MODULE\_MAGIC, [Dynamic Loading](xfunc-c.html#XFUNC-C-DYNLOAD)
...
pg\_numa\_available, [Session Information Functions](functions-info.html#FUNCTIONS-INFO-SESSION)
...
pg\_overexplain, [pg\_overexplain — allow EXPLAIN to dump even more details](pgoverexplain.html)
...
pg\_receivexlog, [pg\_receivexlog renamed to pg\_receivewal](app-pgreceivexlog.html) (see [pg\_receivewal](#ientry-id-1.9.4.17.1))
...
pg\_resetxlog, [pg\_resetxlog renamed to pg\_resetwal](app-pgresetxlog.html) (see [pg\_resetwal](#ientry-id-1.9.5.9.1))

pg\_restore, [pg\_restore](app-pgrestore.html)

pg\_restore\_attribute\_stats, [Database Object Management Functions](functions-admin.html#FUNCTIONS-ADMIN-DBOBJECT)

pg\_restore\_relation\_stats, [Database Object Management Functions](functions-admin.html#FUNCTIONS-ADMIN-DBOBJECT)
...
pg\_shmem\_allocations\_numa, [pg\_shmem\_allocations\_numa](view-pg-shmem-allocations-numa.html)
...
pg\_stat\_checkpointer, [Viewing Statistics](monitoring-stats.html#MONITORING-STATS-VIEWS), [pg\_stat\_checkpointer](monitoring-stats.html#MONITORING-PG-STAT-CHECKPOINTER-VIEW)
...
pg\_stat\_get\_backend\_io, [Statistics Functions](monitoring-stats.html#MONITORING-STATS-FUNCTIONS)
...
pg\_stat\_get\_backend\_wal, [Statistics Functions](monitoring-stats.html#MONITORING-STATS-FUNCTIONS)
...
pg\_stat\_reset\_backend\_stats, [Statistics Functions](monitoring-stats.html#MONITORING-STATS-FUNCTIONS)
...
pg\_sync\_replication\_slots, [Replication Management Functions](functions-admin.html#FUNCTIONS-REPLICATION)
...
pg\_walsummary, [pg\_walsummary](app-pgwalsummary.html)
...
pg\_wal\_summary\_contents, [WAL Summarization Information Functions](functions-info.html#FUNCTIONS-INFO-WAL-SUMMARY)
...
pg\_xlogdump, [pg\_xlogdump renamed to pg\_waldump](pgxlogdump.html) (see [pg\_waldump](#ientry-id-1.9.5.14.1))
...
popcount (see [bit\_count](#ientry-id-1.5.8.11.7.2.2.1.1.1.1))
...
PQAUTHDATA\_OAUTH\_BEARER\_TOKEN, [Hook Types](libpq-oauth.html#LIBPQ-OAUTH-AUTHDATA-HOOKS-TYPES)

PQAUTHDATA\_PROMPT\_OAUTH\_DEVICE, [Hook Types](libpq-oauth.html#LIBPQ-OAUTH-AUTHDATA-HOOKS-TYPES)
...
PQcancel, [Obsolete Functions for Sending Cancel Requests](libpq-cancel.html#LIBPQ-CANCEL-DEPRECATED)

PQcancelBlocking, [Functions for Sending Cancel Requests](libpq-cancel.html#LIBPQ-CANCEL-FUNCTIONS)

PQcancelCreate, [Functions for Sending Cancel Requests](libpq-cancel.html#LIBPQ-CANCEL-FUNCTIONS)

PQcancelErrorMessage, [Functions for Sending Cancel Requests](libpq-cancel.html#LIBPQ-CANCEL-FUNCTIONS)

PQcancelFinish, [Functions for Sending Cancel Requests](libpq-cancel.html#LIBPQ-CANCEL-FUNCTIONS)

PQcancelPoll, [Functions for Sending Cancel Requests](libpq-cancel.html#LIBPQ-CANCEL-FUNCTIONS)

PQcancelReset, [Functions for Sending Cancel Requests](libpq-cancel.html#LIBPQ-CANCEL-FUNCTIONS)

PQcancelSocket, [Functions for Sending Cancel Requests](libpq-cancel.html#LIBPQ-CANCEL-FUNCTIONS)

PQcancelStart, [Functions for Sending Cancel Requests](libpq-cancel.html#LIBPQ-CANCEL-FUNCTIONS)

PQcancelStatus, [Functions for Sending Cancel Requests](libpq-cancel.html#LIBPQ-CANCEL-FUNCTIONS)

PQchangePassword, [Miscellaneous Functions](libpq-misc.html)
...
PQfreeCancel, [Obsolete Functions for Sending Cancel Requests](libpq-cancel.html#LIBPQ-CANCEL-DEPRECATED)
...
PQfullProtocolVersion, [Connection Status Functions](libpq-status.html)

PQgetAuthDataHook, [Authdata Hooks](libpq-oauth.html#LIBPQ-OAUTH-AUTHDATA-HOOKS)

PQgetCancel, [Obsolete Functions for Sending Cancel Requests](libpq-cancel.html#LIBPQ-CANCEL-DEPRECATED)

PQgetCopyData, [Functions for Receiving COPY Data](libpq-copy.html#LIBPQ-COPY-RECEIVE)

PQgetCurrentTimeUSec, [Miscellaneous Functions](libpq-misc.html)
...
(see also [PQserverVersion](#ientry-id-1.7.3.9.5.2.6.1.2))
...
PQrequestCancel, [Obsolete Functions for Sending Cancel Requests](libpq-cancel.html#LIBPQ-CANCEL-DEPRECATED)
...
PQsendPipelineSync, [Functions Associated with Pipeline Mode](libpq-pipeline-mode.html#LIBPQ-PIPELINE-FUNCTIONS)
...
PQsetAuthDataHook, [Authdata Hooks](libpq-oauth.html#LIBPQ-OAUTH-AUTHDATA-HOOKS)

PQsetChunkedRowsMode, [Retrieving Query Results in Chunks](libpq-single-row-mode.html)
...
PQsetSingleRowMode, [Retrieving Query Results in Chunks](libpq-single-row-mode.html)
...
PQsocketPoll, [Database Connection Control Functions](libpq-connect.html)
...
privilege, [Privileges](ddl-priv.html), [Privileges](ddl-priv.html#DDL-PRIV-DEFAULT), [Schemas and Privileges](ddl-schemas.html#DDL-SCHEMAS-PRIV), [Rules and Privileges](rules-privileges.html), [Rules and Privileges](rules-privileges.html)

default, [Privileges](ddl-priv.html#DDL-PRIV-DEFAULT)
...
query cancellation, [Canceling Queries in Progress](libpq-cancel.html)
...
(see also [pattern matching](#ientry-id-1.5.8.13.2))
...
restrict\_nonsystem\_relation\_kind
...
reverse, [String Functions and Operators](functions-string.html), [Binary String Functions and Operators](functions-binarystring.html)
...
scalar (see [expression](#ientry-id-1.5.3.6.2))
...
serializable\_buffers configuration parameter, [Memory](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-MEMORY)
...
shared\_preload\_libraries, [Requesting Shared Memory at Startup](xfunc-c.html#XFUNC-SHARED-ADDIN-AT-STARTUP), [Requesting LWLocks at Startup](xfunc-c.html#XFUNC-ADDIN-LWLOCKS-AT-STARTUP)
...
single-user mode, [Options for Single-User Mode](app-postgres.html#id-1.9.5.16.6.5)
...
sliced bread (see [TOAST](#ientry-id-1.7.4.6.2))
...
SP-GiST (see [index](#ientry-id-1.5.10.2))
...
ssl\_groups configuration parameter, [SSL](runtime-config-connection.html#RUNTIME-CONFIG-CONNECTION-SSL)
...
ssl\_tls13\_ciphers configuration parameter, [SSL](runtime-config-connection.html#RUNTIME-CONFIG-CONNECTION-SSL)
...
standby\_mode (see [standby.signal](#ientry-id-1.6.6.8.7.5.2))
...
string (see [character string](#ientry-id-1.5.3.5.9.4.2))
...
subplan, [EXPLAIN Basics](using-explain.html#USING-EXPLAIN-BASICS)

hashed, [EXPLAIN Basics](using-explain.html#USING-EXPLAIN-BASICS)
...
subtransaction\_buffers configuration parameter, [Memory](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-MEMORY)

sum, [Aggregate Functions](functions-aggregate.html)

summarize\_wal configuration parameter, [WAL Summarization](runtime-config-wal.html#RUNTIME-CONFIG-WAL-SUMMARIZATION)
...
in\_range, [B-Tree Support Functions](btree.html#BTREE-SUPPORT-FUNCS)
...
synchronized\_standby\_slots configuration parameter, [Primary Server](runtime-config-replication.html#RUNTIME-CONFIG-REPLICATION-PRIMARY)
...
sync\_replication\_slots configuration parameter, [Standby Servers](runtime-config-replication.html#RUNTIME-CONFIG-REPLICATION-STANDBY)
...
to\_regtypemod, [System Catalog Information Functions](functions-info.html#FUNCTIONS-INFO-CATALOG)
...
track\_cost\_delay\_timing configuration parameter, [Cumulative Query and Index Statistics](runtime-config-statistics.html#RUNTIME-CONFIG-CUMULATIVE-STATISTICS)
...
transaction log (see [WAL](#ientry-id-1.6.15.5.2))

transaction\_buffers configuration parameter, [Memory](runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-MEMORY)
...
transaction\_timeout configuration parameter, [Statement Behavior](runtime-config-client.html#RUNTIME-CONFIG-CLIENT-STATEMENT)
...
(see also [ephemeral named relation](#ientry-id-1.8.12.8.31.2))
...
type (see [data type](#ientry-id-1.5.3.5.9.10.2))
...
unicode\_assigned, [String Functions and Operators](functions-string.html)

unicode\_version, [Version Information Functions](functions-info.html#FUNCTIONS-INFO-VERSION)
...
UPLOAD\_MANIFEST, [Streaming Replication Protocol](protocol-replication.html)
...
UUID, [UUID Type](datatype-uuid.html), [UUID Functions](functions-uuid.html), [PostgreSQL Features](install-make.html#CONFIGURE-OPTIONS-FEATURES), [PostgreSQL Features](install-meson.html#MESON-OPTIONS-FEATURES)

generating, [UUID Functions](functions-uuid.html)

uuid-ossp, [uuid-ossp — a UUID generator](uuid-ossp.html)

uuidv4, [UUID Functions](functions-uuid.html)

uuidv7, [UUID Functions](functions-uuid.html)

uuid\_extract\_timestamp, [UUID Functions](functions-uuid.html)

uuid\_extract\_version, [UUID Functions](functions-uuid.html)
...
configuration parameters, [Vacuuming](runtime-config-vacuum.html)
...
vacuum\_cost\_delay configuration parameter, [Cost-based Vacuum Delay](runtime-config-vacuum.html#RUNTIME-CONFIG-RESOURCE-VACUUM-COST)

vacuum\_cost\_limit configuration parameter, [Cost-based Vacuum Delay](runtime-config-vacuum.html#RUNTIME-CONFIG-RESOURCE-VACUUM-COST)

vacuum\_cost\_page\_dirty configuration parameter, [Cost-based Vacuum Delay](runtime-config-vacuum.html#RUNTIME-CONFIG-RESOURCE-VACUUM-COST)

vacuum\_cost\_page\_hit configuration parameter, [Cost-based Vacuum Delay](runtime-config-vacuum.html#RUNTIME-CONFIG-RESOURCE-VACUUM-COST)

vacuum\_cost\_page\_miss configuration parameter, [Cost-based Vacuum Delay](runtime-config-vacuum.html#RUNTIME-CONFIG-RESOURCE-VACUUM-COST)

vacuum\_failsafe\_age configuration parameter, [Freezing](runtime-config-vacuum.html#RUNTIME-CONFIG-VACUUM-FREEZING)

vacuum\_freeze\_min\_age configuration parameter, [Freezing](runtime-config-vacuum.html#RUNTIME-CONFIG-VACUUM-FREEZING)

vacuum\_freeze\_table\_age configuration parameter, [Freezing](runtime-config-vacuum.html#RUNTIME-CONFIG-VACUUM-FREEZING)

vacuum\_index\_cleanup storage parameter, [Storage Parameters](sql-createtable.html#SQL-CREATETABLE-STORAGE-PARAMETERS)

vacuum\_max\_eager\_freeze\_failure\_rate

configuration parameter, [Freezing](runtime-config-vacuum.html#RUNTIME-CONFIG-VACUUM-FREEZING)

storage parameter, [Storage Parameters](sql-createtable.html#SQL-CREATETABLE-STORAGE-PARAMETERS)

vacuum\_multixact\_failsafe\_age configuration parameter, [Freezing](runtime-config-vacuum.html#RUNTIME-CONFIG-VACUUM-FREEZING)

vacuum\_multixact\_freeze\_min\_age configuration parameter, [Freezing](runtime-config-vacuum.html#RUNTIME-CONFIG-VACUUM-FREEZING)

vacuum\_multixact\_freeze\_table\_age configuration parameter, [Freezing](runtime-config-vacuum.html#RUNTIME-CONFIG-VACUUM-FREEZING)

vacuum\_truncate

configuration parameter, [Default Behavior](runtime-config-vacuum.html#RUNTIME-CONFIG-VACUUM-DEFAULT)
...
version, [Accessing a Database](tutorial-accessdb.html), [Version Information Functions](functions-info.html#FUNCTIONS-INFO-VERSION), [Upgrading a PostgreSQL Cluster](upgrading.html)
...
Visual Studio, [Visual Studio](installation-platform-notes.html#INSTALLATION-NOTES-VISUAL-STUDIO)

installation on, [Visual Studio](installation-platform-notes.html#INSTALLATION-NOTES-VISUAL-STUDIO)

VM (see [Visibility Map](#ientry-id-1.10.18.6.2))
...
wal\_summary\_keep\_time configuration parameter, [WAL Summarization](runtime-config-wal.html#RUNTIME-CONFIG-WAL-SUMMARIZATION)
...
xmltext, [xmltext](functions-xml.html#FUNCTIONS-PRODUCING-XML-XMLTEXT)
...
If you see anything in the documentation that is not correct, does not match your experience with the particular feature or requires further clarification, please use [this form](/account/comments/new/18/bookindex.html/) to report a documentation issue.
