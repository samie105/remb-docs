---
title: "PostgreSQL: Documentation: 18: NOTIFY"
source: "https://www.postgresql.org/docs/current/sql-notify.html"
canonical_url: "https://www.postgresql.org/docs/current/sql-notify.html"
docset: "postgres"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:43:38.223Z"
...
NOTIFY _`channel`_ \[ , _`payload`_ \]
...
The function `pg_notification_queue_usage` returns the fraction of the queue that is currently occupied by pending notifications. See [Section 9.27](https://www.postgresql.org/docs/current/functions-info.html "9.27. System Information Functions and Operators") for more information.
...
LISTEN foo;
SELECT pg\_notify('fo' || 'o', 'pay' || 'load');
