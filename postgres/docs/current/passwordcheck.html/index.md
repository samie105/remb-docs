...
section_path: []
nav_prev: {"path": "../parser-stage.html/index.md", "title": "PostgreSQL: Documentation: 18: 51.3.\u00a0The Parser Stage"}
nav_next: {"path": "../perm-functions.html/index.md", "title": "PostgreSQL: Documentation: 18: 21.6.\u00a0Function Security"}
---
...
To enable this module, add `'$libdir/passwordcheck'` to [shared\_preload\_libraries](../runtime-config-client.html/index.md#GUC-SHARED-PRELOAD-LIBRARIES) in `postgresql.conf`, then restart the server.
