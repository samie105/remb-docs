...
`to_regtypemod` can be combined with [to\_regtype](index.md#TO-REGTYPE) to produce appropriate inputs for [format\_type](index.md#FORMAT-TYPE), allowing a string representing a type name to be canonicalized.
