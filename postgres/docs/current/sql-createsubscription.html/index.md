...
The value of this parameter overrides the [synchronous\_commit](postgres/docs/current/runtime-config-wal.html/index.md#GUC-SYNCHRONOUS-COMMIT) setting within this subscription's apply worker processes. The default value is `off`.
