---
title: "PostgreSQL: Documentation: 18: 65.1. B-Tree Indexes"
source: "https://www.postgresql.org/docs/current/btree.html"
canonical_url: "https://www.postgresql.org/docs/current/btree.html"
docset: "postgres"
kind: "database"
adapter: "generic"
...
in\_range(_`val`_ type1, _`base`_ type1, _`offset`_ type2, _`sub`_ bool, _`less`_ bool)
returns bool
...
equalimage(_`opcintype`_ `oid`) returns bool
...
options(_`relopts`_ `local_relopts *`) returns void
