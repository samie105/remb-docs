---
title: "PostgreSQL: Documentation: 18: B.5. POSIX Time Zone Specifications"
source: "https://www.postgresql.org/docs/current/datetime-posix-timezone-specs.html"
canonical_url: "https://www.postgresql.org/docs/current/datetime-posix-timezone-specs.html"
docset: "postgres"
kind: "database"
adapter: "generic"
...
section_path: []
content_language: "en"
nav_prev: {"path": "../datetime-keywords.html/index.md", "title": "PostgreSQL: Documentation: 18: B.3.\u00a0Date/Time Key Words"}
nav_next: {"path": "../datetime-units-history.html/index.md", "title": "PostgreSQL: Documentation: 18: B.6.\u00a0History of Units"}
---
...
_`STD`_ _`offset`_ \[ _`DST`_ \[ _`dstoffset`_ \] \[ , _`rule`_ \] \]
...
_`dstdate`_ \[ `/` _`dsttime`_ \] `,` _`stddate`_ \[ `/` _`stdtime`_ \]
