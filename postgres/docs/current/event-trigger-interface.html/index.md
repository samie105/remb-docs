---
title: "PostgreSQL: Documentation: 18: 38.2. Writing Event Trigger Functions in C"
source: "https://www.postgresql.org/docs/current/event-trigger-interface.html"
canonical_url: "https://www.postgresql.org/docs/current/event-trigger-interface.html"
docset: "postgres"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:45:28.269Z"
...
Describes the event for which the function is called, one of `"login"`, `"ddl_command_start"`, `"ddl_command_end"`, `"sql_drop"`, `"table_rewrite"`. See [Section 38.1](https://www.postgresql.org/docs/current/event-trigger-definition.html "38.1. Overview of Event Trigger Behavior") for the meaning of these events.
