...
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-27T20:48:39.881Z"
content_hash: "0fb107630e278b5e102a46b9e97f4765cd7ce48e292d03ac656b3b3b72d93655"
...
-   Add [`pg_stat_io`](https://www.postgresql.org/docs/current/monitoring-stats.html#MONITORING-PG-STAT-IO-VIEW "27.2.13. pg_stat_io") columns to report I/O activity in bytes (Nazir Bilal Yavuz) [§](https://postgr.es/c/f92c854cf)
    ...
    The new columns are `read_bytes`, `write_bytes`, and `extend_bytes`. The `op_bytes` column, which always equaled [`BLCKSZ`](../runtime-config-preset.html/index.md#GUC-BLOCK-SIZE), has been removed.
...
-   Have [query id](../runtime-config-statistics.html/index.md#GUC-COMPUTE-QUERY-ID) computation of constant lists consider only the first and last constants (Dmitry Dolgov, Sami Imseih) [§](https://postgr.es/c/62d712ecf) [§](https://postgr.es/c/9fbd53dea) [§](https://postgr.es/c/c2da1a5d6)
