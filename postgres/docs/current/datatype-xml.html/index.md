---
title: "PostgreSQL: Documentation: 18: 8.13. XML Type"
source: "https://www.postgresql.org/docs/current/datatype-xml.html"
canonical_url: "https://www.postgresql.org/docs/current/datatype-xml.html"
docset: "postgres"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:54:26.247Z"
...
Limits and compatibility notes for the `xml` data type can be found in [Section D.3](https://www.postgresql.org/docs/current/xml-limits-conformance.html "D.3. XML Limits and Conformance to SQL/XML").
...
XMLPARSE ( { DOCUMENT | CONTENT } _`value`_)
...
XMLSERIALIZE ( { DOCUMENT | CONTENT } _`value`_ AS _`type`_ \[ \[ NO \] INDENT \] )
