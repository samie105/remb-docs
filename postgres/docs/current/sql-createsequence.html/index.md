---
title: "PostgreSQL: Documentation: 18: CREATE SEQUENCE"
source: "https://www.postgresql.org/docs/current/sql-createsequence.html"
canonical_url: "https://www.postgresql.org/docs/current/sql-createsequence.html"
docset: "postgres"
kind: "database"
adapter: "generic"
...
After a sequence is created, you use the functions `nextval`, `currval`, and `setval` to operate on the sequence. These functions are documented in [Section 9.17](https://www.postgresql.org/docs/current/functions-sequence.html "9.17. Sequence Manipulation Functions").

Although you cannot update a sequence directly, you can use a query like:

SELECT \* FROM _`name`_;
...
BEGIN;
COPY distributors FROM 'input\_file';
