---
title: "PostgreSQL: Documentation: 18: pg_ctl"
source: "https://www.postgresql.org/docs/current/app-pg-ctl.html"
canonical_url: "https://www.postgresql.org/docs/current/app-pg-ctl.html"
docset: "postgres"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:52:30.555Z"
...
pg\_ctl is a utility for initializing a PostgreSQL database cluster, starting, stopping, or restarting the PostgreSQL database server ([postgres](https://www.postgresql.org/docs/current/app-postgres.html "postgres")), or displaying the status of a running server. Although the server can be started manually, pg\_ctl encapsulates tasks such as redirecting log output and properly detaching from the terminal and process group. It also provides convenient options for controlled shutdown.

The `init` or `initdb` mode creates a new PostgreSQL database cluster, that is, a collection of databases that will be managed by a single server instance. This mode invokes the `initdb` command. See [initdb](https://www.postgresql.org/docs/current/app-initdb.html "initdb") for details.
...
`logrotate` mode rotates the server log file. For details on how to use this mode with external log rotation tools, see [Section 24.3](https://www.postgresql.org/docs/current/logfile-maintenance.html "24.3. Log File Maintenance").
...
For additional variables that affect the server, see [postgres](https://www.postgresql.org/docs/current/app-postgres.html "postgres").
