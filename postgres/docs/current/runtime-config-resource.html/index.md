...
Controls the size of huge pages, when they are enabled with [huge\_pages](index.md#GUC-HUGE-PAGES). The default is zero (`0`). When set to `0`, the default huge page size on the system will be used. This parameter can only be set at server start.
