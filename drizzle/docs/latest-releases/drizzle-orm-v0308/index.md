...
section_path: []
content_language: "en"
nav_prev: {"path": "../drizzle-orm-v0307/index.md", "title": "Drizzle ORM - DrizzleORM v0.30.7 release"}
nav_next: {"path": "../drizzle-orm-v0309/index.md", "title": "Drizzle ORM - DrizzleORM v0.30.9 release"}
---
...
Learn more about Postgres [schemas](../../schemas/index.md) and [enums](../../column-types/pg/index.md#enum).

## Fixes

-   Changed D1 `migrate()` function to use batch API ([#2137](https://github.com/drizzle-team/drizzle-orm/pull/2137))

To get started with Drizzle and D1 follow the [documentation](../../get-started-sqlite/index.md#cloudflare-d1).
...
Learn more about `.onConflictDoUpdate` method [here](../../insert/index.md#on-conflict-do-update).
...
Learn more about `.onConflictDoNothing` method [here](../../insert/index.md#on-conflict-do-nothing).
...
To get started with Drizzle and AWS Data API follow the [documentation](../../get-started-postgresql/index.md#aws-data-api).
