---
title: "New Features"
source: "https://orm.drizzle.team/docs/latest-releases/drizzle-orm-v1beta2"
canonical_url: "https://orm.drizzle.team/docs/latest-releases/drizzle-orm-v1beta2"
docset: "drizzle"
kind: "library"
adapter: "generic"
last_crawled_at: "2026-04-27T19:07:40.105Z"
content_hash: "c465a089d72fc4755e4af3ae7e52662a9e08aa1c323a99f012f79f1e5c819c7e"
menu_path: ["New Features"]
section_path: []
content_language: "en"
nav_prev: {"path": "../drizzle-orm-v0322/index.md", "title": "Drizzle ORM - DrizzleORM v0.32.2 release"}
nav_next: {"path": "../../migrate/components/index.md", "title": "Drizzle ORM - undefined"}
---
...
> Check the migration guide for RQBv1 to RQBv2 migration steps: [https://orm.drizzle.team/docs/relations-v1-v2](../../relations-v1-v2/index.md)

> Check new RQBv2 schema docs: [https://orm.drizzle.team/docs/relations-v2](../../relations-v2/index.md)

> Check new RQBv2 query docs: [https://orm.drizzle.team/docs/rqb-v2](../../rqb-v2/index.md)
...
-   blob: [https://orm.drizzle.team/docs/column-types/mysql#blob](../../column-types/mysql/index.md#blob)
-   tinyblob: [https://orm.drizzle.team/docs/column-types/mysql#tinyblob](../../column-types/mysql/index.md#tinyblob)
-   mediumblob: [https://orm.drizzle.team/docs/column-types/mysql#mediumblob](../../column-types/mysql/index.md#mediumblob)
-   longblob: [https://orm.drizzle.team/docs/column-types/mysql#longblob](../../column-types/mysql/index.md#longblob)
...
-   [\[BUG\]: When setting the casing to snake\_case, the constraint name for unique fields isn’t converted](https://github.com/drizzle-team/drizzle-orm/issues/4800)
...
-   [\[BUG\]: drizzle-kit pull fails to wrap gen\_random\_uuid() with sql function call resulting in syntax errors](https://github.com/drizzle-team/drizzle-orm/issues/4730)
...
-   [\[BUG\]: Big int precision loss when data fetched with json\_agg](https://github.com/drizzle-team/drizzle-orm/issues/4380)
...
-   [\[BUG\]: “unix\_timestamp is not defined”](https://github.com/drizzle-team/drizzle-orm/issues/3237)
...
-   [\[BUG\]: migrations do not work - table already exists - ER\_TABLE\_EXISTS\_ERROR - mysql](https://github.com/drizzle-team/drizzle-orm/issues/2815)
...
-   [\[BUG\]: ER\_WRONG\_AUTO\_KEY - Drizzle Kit not detecting primary keys](https://github.com/drizzle-team/drizzle-orm/issues/1428)
...
-   [\[BUG\]: error: column “role” cannot be cast automatically to type user\_role](https://github.com/drizzle-team/drizzle-orm/issues/930)
