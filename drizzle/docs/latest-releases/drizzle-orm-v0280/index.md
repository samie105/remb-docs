---
title: "Drizzle ORM - DrizzleORM v0.28.0 release"
source: "https://orm.drizzle.team/docs/latest-releases/drizzle-orm-v0280"
canonical_url: "https://orm.drizzle.team/docs/latest-releases/drizzle-orm-v0280"
docset: "drizzle"
kind: "library"
adapter: "generic"
...
3.  Reduced Aggregations: In the new version we’ve reduced the number of aggregation functions (e.g., COUNT, json\_agg). By using json\_build\_array directly within the lateral joins, drizzle is aggregating the data in a more streamlined manner, leading to improved query performance.
