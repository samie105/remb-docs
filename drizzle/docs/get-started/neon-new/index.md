---
title: "Get Started with Drizzle and Neon"
source: "https://orm.drizzle.team/docs/get-started/neon-new"
canonical_url: "https://orm.drizzle.team/docs/get-started/neon-new"
docset: "drizzle"
kind: "library"
adapter: "generic"
last_crawled_at: "2026-04-27T18:47:45.431Z"
content_hash: "fbe55b7c3a791712b3527d69288f47a14f0e5a210b9e7d94e8a5b91e35da7333"
...
If you need session or interactive transaction support, or a fully compatible drop-in replacement for the `pg` driver, you can use the WebSocket-based `neon-serverless` driver. You can connect to a Neon database directly using [Postgres](../postgresql-new/index.md)
