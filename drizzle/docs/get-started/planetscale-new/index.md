...
section_path: []
content_language: "en"
nav_prev: {"path": "../planetscale-existing/index.md", "title": "Get Started with Drizzle and PlanetScale in existing project"}
nav_next: {"path": "../planetscale-postgres-existing/index.md", "title": "Get Started with Drizzle and PlanetScale Postgres in existing project"}
---
...
For this tutorial, we will use the `database-js` driver to make **HTTP** calls to the PlanetScale database. If you need to connect to PlanetScale through TCP, you can refer to our [MySQL Get Started](../mysql-new/index.md) page
