...
canonical_url: "https://orm.drizzle.team/docs/guides/upsert"
docset: "drizzle"
kind: "library"
adapter: "generic"
...
To implement an upsert query in PostgreSQL and SQLite (skip to [MySQL](index.md#mysql)) with Drizzle you can use `.onConflictDoUpdate()` method:
