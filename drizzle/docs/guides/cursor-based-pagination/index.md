---
title: "Drizzle ORM - SQL Cursor-based pagination"
source: "https://orm.drizzle.team/docs/guides/cursor-based-pagination"
canonical_url: "https://orm.drizzle.team/docs/guides/cursor-based-pagination"
docset: "drizzle"
kind: "library"
adapter: "generic"
...
So, if you need to directly navigate to a specific page or you need simpler implementation of pagination, you should consider using [offset/limit](../limit-offset-pagination/index.md) pagination instead.
