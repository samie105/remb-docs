...
lets you generate SQL migration files based on your Drizzle schema either upon declaration or on subsequent changes, [see here](https://orm.drizzle.team/docs/drizzle-kit-generate).

[`drizzle-kit migrate`](https://orm.drizzle.team/docs/drizzle-kit-migrate)

lets you apply generated SQL migration files to your database, [see here](https://orm.drizzle.team/docs/drizzle-kit-migrate).

[`drizzle-kit pull`](https://orm.drizzle.team/docs/drizzle-kit-pull)

lets you pull(introspect) database schema, convert it to Drizzle schema and save it to your codebase, [see here](https://orm.drizzle.team/docs/drizzle-kit-pull)

[`drizzle-kit push`](https://orm.drizzle.team/docs/drizzle-kit-push)

lets you push your Drizzle schema to database either upon declaration or on subsequent schema changes, [see here](https://orm.drizzle.team/docs/drizzle-kit-push)

[`drizzle-kit studio`](https://orm.drizzle.team/docs/drizzle-kit-studio)

will connect to your database and spin up proxy server for Drizzle Studio which you can use for convenient database browsing, [see here](https://orm.drizzle.team/docs/drizzle-kit-studio)

[`drizzle-kit check`](https://orm.drizzle.team/docs/drizzle-kit-check)

will walk through all generate migrations and check for any race conditions(collisions) of generated migrations, [see here](https://orm.drizzle.team/docs/drizzle-kit-check)

[`drizzle-kit up`](https://orm.drizzle.team/docs/drizzle-kit-up)

used to upgrade snapshots of previously generated migrations, [see here](https://orm.drizzle.team/docs/drizzle-kit-up)
