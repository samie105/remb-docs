...
-   [Drizzle Kit](../kit-overview/index.md) support for migration generation and bundling in application ✅
...
Please make sure to check how [Drizzle migrations](../kit-overview/index.md) work before proceeding.  
