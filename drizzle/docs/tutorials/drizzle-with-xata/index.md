...
canonical_url: "https://orm.drizzle.team/docs/tutorials/drizzle-with-xata"
docset: "drizzle"
kind: "library"
adapter: "generic"
...
## Setup Xata and Drizzle ORM[](#setup-xata-and-drizzle-orm)

#### Create a new Xata database[](#create-a-new-xata-database)
...
Learn more about [migration process](../../migrations/index.md).
...
Read more about insert query in the [documentation](../../insert/index.md).
...
Read more about select query in the [documentation](../../select/index.md).
...
Alternatively, you can use [relational query syntax](../../rqb/index.md).

#### Update data[](#update-data)

Read more about update query in the [documentation](../../update/index.md).
...
Read more about delete query in the [documentation](../../delete/index.md).
...
-   Learn about [Drizzle relations](../../rqb/index.md) for complex queries
-   Explore [Xata’s documentation](https://xata.io/documentation/)
-   Implement [database migrations](../../migrations/index.md) for production deployments
