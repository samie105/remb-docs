...
Learn more about [migration process](../../migrations/index.md). You can also apply migrations using [Supabase CLI](https://supabase.com/docs/guides/cli/getting-started):
