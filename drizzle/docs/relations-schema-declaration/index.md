---
title: "Drizzle Relations Fundamentals"
source: "https://orm.drizzle.team/docs/relations-schema-declaration"
canonical_url: "https://orm.drizzle.team/docs/relations-schema-declaration"
docset: "drizzle"
kind: "library"
adapter: "generic"
...
section_path: []
content_language: "en"
nav_prev: {"path": "../sql-schema-declaration/index.md", "title": "Drizzle schema"}
nav_next: {"path": "../connect-overview/index.md", "title": "Database connection with Drizzle"}
---
...
#### 1NF (First Normal Form): `Atomic Values`[](#1nf-first-normal-form-atomic-values)
...
#### 2NF (Second Normal Form): `Eliminate Redundant Data Dependent on Part of the Key`[](#2nf-second-normal-form-eliminate-redundant-data-dependent-on-part-of-the-key)
...
#### 3NF (Third Normal Form): `Eliminate Redundant Data Dependent on Non-Key Attributes`[](#3nf-third-normal-form-eliminate-redundant-data-dependent-on-non-key-attributes)
...
### Why Foreign Keys?[](#why-foreign-keys)
...
> Hey database, I want to enforce a 1-M relationship here. Every value in the customer\_id column of the Orders table must correspond to a valid customer\_id in the Customers table.
...
### Why NOT Foreign Keys?[](#why-not-foreign-keys)
