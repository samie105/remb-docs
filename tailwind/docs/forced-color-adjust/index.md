...
You can also use the [forced colors variant](../hover-focus-and-other-states/index.md#forced-colors) to conditionally add styles when the user has enabled a forced color mode.
