...
canonical_url: "https://tailwindcss.com/docs/display"
docset: "tailwind"
kind: "framework"
adapter: "generic"
...
To visually hide an element but keep it in the document, use the [visibility](../visibility/index.md#making-elements-invisible) property instead.
