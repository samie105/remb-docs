...
canonical_url: "https://docs.deno.com/runtime/fundamentals/typescript/"
docset: "deno"
kind: "language"
adapter: "generic"
...
This will enable type checking for a browser environment, providing type information for global objects like `document`. This will however disable type information for Deno-specific APIs like [`Deno.readFile`](/api/deno/~/Deno.readFile).
...
This will enable type checking for both browser and Deno environments, providing type information for global objects like `document` and Deno-specific APIs like [`Deno.readFile`](/api/deno/~/Deno.readFile).
