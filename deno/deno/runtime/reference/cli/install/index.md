...
Use this command to install all dependencies defined in [`deno.json`](/runtime/fundamentals/configuration/) and/or `package.json`.
...
### deno install --global \[PACKAGE\_OR\_URL\]
...
For good practice, use the [`import.meta.main`](/runtime/tutorials/module_metadata/) idiom to specify the entry point in an executable script.
