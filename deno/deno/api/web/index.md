...
source: "https://docs.deno.com/api/web"
canonical_url: "https://docs.deno.com/api/web"
docset: "deno"
kind: "language"
adapter: "generic"
...
To check if a Web Platform API is available in Deno, refer to the interface documentation on [MDN](https://developer.mozilla.org/en-US/docs/Web/API#interfaces) and its Browser Compatibility table.
