...
source: "https://docs.deno.com/api/node"
canonical_url: "https://docs.deno.com/api/node"
docset: "deno"
kind: "language"
adapter: "generic"
last_crawled_at: "2026-04-27T18:02:26.588Z"
content_hash: "6d085ca5860397bae647f06aaeea70b1c78e549f8f7ab122ab68c8009880670c"
...
-   [Core Modules](#core-modules)
    ...
    -   [Network & HTTP](#network-%26-http)
    -   [Process & System](#process-%26-system)
    -   [Crypto & Security](#crypto-%26-security)
    -   [Data & Streams](#data-%26-streams)
    -   [Utilities](#utilities)
    -   [Development & Testing](#development-%26-testing)
-   [Global Objects](#global-objects)
-   [Usage Examples](#usage-examples)
    -   [Basic Module Import](#basic-module-import)
    -   [HTTP Server](#http-server)
    -   [Crypto Operations](#crypto-operations)
-   [Compatibility](#compatibility)
-   [Migration from Node.js](#migration-from-node.js)
...
-   **Built-in Module Support**: Access Node.js modules using `node:` prefix (e.g., `import fs from "node:fs"`)
...
-   **`node:crypto`** - Cryptographic functionality (hashing, encryption, certificates)
