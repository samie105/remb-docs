...
canonical_url: "https://docs.deno.com/runtime/reference/migration_guide/"
docset: "deno"
kind: "language"
adapter: "generic"
...
Deno 2 was built with development teams working on mission-critical projects in mind. These teams work on complex codebases, sharing internal code, often using private registries.

With Deno 2 your team can leverage private npm registries the same way you'd do with Node.js and npm, using an `.npmrc` file:
...
See [Node modules directory](deno/runtime/fundamentals/configuration/index.md#node-modules-directory) for reference.
...
Use granular unstable flags (`--unstable-*`) or configuration options instead. See [Unstable Feature Flags](deno/runtime/reference/cli/unstable_flags/index.md) for reference.
...
See the [Deno 1.40 Blog Post](https://deno.com/blog/v1.40#changes-to-how-we-handle-unstable-features) for details.

## Import assertions removal

Import assertions were removed from JavaScript and are now deprecated in Deno 2.0. Use import attributes instead:
...
This was one of the rare cases when a proposal was [downgraded after hitting Stage 3](https://github.com/tc39/proposal-import-attributes?tab=readme-ov-file#history).
...
Note: This symbol is soft-removed as of Deno 2. Its types have been removed, but its implementation remains to reduce breaking changes. You can ignore "property does not exist" TypeScript errors by using the [`@ts-ignore`](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-2-6.html#suppress-errors-in-ts-files-using--ts-ignore-comments) directive.
