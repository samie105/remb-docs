...
canonical_url: "https://docs.deno.com/runtime/reference/cli/coverage/"
docset: "deno"
kind: "language"
adapter: "generic"
...
`deno coverage` generates coverage reports from data collected by [`deno test --coverage`](../test/index.md#code-coverage).

## Inclusions and Exclusions

By default coverage includes any of your code that exists on the local file system, and its imports.
...
By default we support Deno's own coverage format - but you can also output coverage reports in the [lcov format](https://github.com/linux-test-project/lcov?tab=readme-ov-file) (a standard file format used to describe code coverage data), or in html.
