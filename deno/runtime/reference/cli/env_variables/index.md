...
source: "https://docs.deno.com/runtime/reference/cli/env_variables/"
canonical_url: "https://docs.deno.com/runtime/reference/cli/env_variables/"
docset: "deno"
kind: "language"
adapter: "generic"
...
This can be useful when you want to vary a task based on an environment variable, and can be helpfully combined with [`deno task`](../task/index.md) commands like so:
...
| DENO\_COVERAGE\_DIR | Set the directory for collecting coverage profile data. This option only works for [`deno test` subcommand](../test/index.md). |
