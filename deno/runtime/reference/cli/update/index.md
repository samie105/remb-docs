...
`deno update` updates dependencies in your [`deno.json`](../../../fundamentals/configuration/index.md) or `package.json`. See [Modules](../../../fundamentals/modules/index.md) for more about managing dependencies.
