...
section_path: []
nav_prev: {"path": "../TRPCRequestOptions/index.md", "title": "Interface: TRPCRequestOptions"}
nav_next: {"path": "../../type-aliases/CreateTRPCClient/index.md", "title": "Type Alias: CreateTRPCClient<TRouter>"}
---
...
> `optional` **experimental\_encoder**: [`Encoder`](../Encoder/index.md)
