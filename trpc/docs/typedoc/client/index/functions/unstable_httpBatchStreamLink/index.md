...
[`HTTPBatchStreamLinkOptions`](trpc/docs/typedoc/client/index/type-aliases/HTTPBatchStreamLinkOptions/index.md)<`TRouter`\[`"_def"`\]\[`"_config"`\]\[`"$types"`\]>
...
use [httpBatchStreamLink](trpc/docs/typedoc/client/index/functions/httpBatchStreamLink/index.md) instead
