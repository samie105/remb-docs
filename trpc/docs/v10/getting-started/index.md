...
If you prefer to get started in your local environment, you can use one of our [example apps](https://trpc.io/docs/v10/example-apps) as a starter project that you can experiment with locally.
...
*   Read the [concepts](https://trpc.io/docs/v10/concepts) page.
*   Become familiar with [routers](https://trpc.io/docs/v10/server/routers), [procedures](https://trpc.io/docs/v10/server/procedures), [context](https://trpc.io/docs/v10/server/context), and [middleware](https://trpc.io/docs/v10/server/middlewares).
*   If you are using React, read about [useQuery](https://trpc.io/docs/v10/client/react/useQuery), [useMutation](https://trpc.io/docs/v10/client/react/useMutation) and [useUtils](https://trpc.io/docs/v10/client/react/useUtils).
...
On the backend, there are [adapters](https://trpc.io/docs/v10/server/adapters) for a range of frameworks as well as vanilla Node.js. On the frontend, you can use our [React](https://trpc.io/docs/v10/client/react) or [Next.js](https://trpc.io/docs/v10/client/nextjs) integrations, a [third-party integration](https://trpc.io/docs/v10/community/awesome-trpc#frontend-frameworks) for a variety of other frameworks, or the [Vanilla Client](https://trpc.io/docs/v10/client/vanilla/setup), which works anywhere JavaScript runs.

After choosing your stack, you can either scaffold your app using a [template](https://trpc.io/docs/v10/example-apps), or start from scratch using the documentation for your chosen backend and frontend integration.
...
*   If you're not sure where to start, check the documentation for your backend [adapter](https://trpc.io/docs/v10/server/adapters) and frontend implementation, as well as the [example apps](https://trpc.io/docs/v10/example-apps).
*   If you are looking for some inspiration of how tRPC might look as part of a larger codebase, there are some examples in [Open-source projects using tRPC](https://trpc.io/docs/v10/community/awesome-trpc#-open-source-projects-using-trpc).
