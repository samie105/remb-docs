...
If you prefer to get started in your local environment, you can use one of our [example apps](trpc/docs/v10/example-apps/index.md) as a starter project that you can experiment with locally.
...
*   Read the [concepts](trpc/docs/v10/concepts/index.md) page.
*   Become familiar with [routers](trpc/docs/v10/server/routers/index.md), [procedures](trpc/docs/v10/server/procedures/index.md), [context](trpc/docs/v10/server/context/index.md), and [middleware](trpc/docs/v10/server/middlewares/index.md).
*   If you are using React, read about [useQuery](trpc/docs/v10/client/react/useQuery/index.md), [useMutation](trpc/docs/v10/client/react/useMutation/index.md) and [useUtils](trpc/docs/v10/client/react/useUtils/index.md).
...
On the backend, there are [adapters](trpc/docs/v10/server/adapters/index.md) for a range of frameworks as well as vanilla Node.js. On the frontend, you can use our [React](trpc/docs/v10/client/react/index.md) or [Next.js](trpc/docs/v10/client/nextjs/index.md) integrations, a [third-party integration](trpc/docs/v10/community/awesome-trpc/index.md#frontend-frameworks) for a variety of other frameworks, or the [Vanilla Client](trpc/docs/v10/client/vanilla/setup/index.md), which works anywhere JavaScript runs.

After choosing your stack, you can either scaffold your app using a [template](trpc/docs/v10/example-apps/index.md), or start from scratch using the documentation for your chosen backend and frontend integration.
...
*   If you're not sure where to start, check the documentation for your backend [adapter](trpc/docs/v10/server/adapters/index.md) and frontend implementation, as well as the [example apps](trpc/docs/v10/example-apps/index.md).
*   If you are looking for some inspiration of how tRPC might look as part of a larger codebase, there are some examples in [Open-source projects using tRPC](trpc/docs/v10/community/awesome-trpc/index.md#-open-source-projects-using-trpc).
