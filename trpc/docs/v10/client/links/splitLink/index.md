---
title: "Split Link"
source: "https://trpc.io/docs/v10/client/links/splitLink"
canonical_url: "https://trpc.io/docs/v10/client/links/splitLink"
docset: "trpc"
kind: "library"
adapter: "generic"
last_crawled_at: "2026-04-18T16:32:42.623Z"
content_hash: "b4367b4fec51a44d938c00da77dbb5045ef7c68047d2bab58bfd3284812900d4"
...
It's important to note that when you provide links for `splitLink` to execute, `splitLink` will create an entirely new link chain based on the links you passed. Therefore, you need to use a [**terminating link**](trpc/docs/v10/client/links/index.md#the-terminating-link) if you only provide one link or add the terminating link at the end of the array if you provide multiple links to be executed on a branch. Here's a visual representation of how `splitLink` works:
