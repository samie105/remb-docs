...
You can now use the React hooks you have just created to invoke your API. For more detail see the [React Query Integration](../../react/index.md)
...
*   **Required**:
*   `links` to customize the flow of data between tRPC Client and the tRPC Server. [Read more](../../../../client/links/index.md).
*   Optional:
...
Configure [overrides for React Query's hooks](../../../../client/react/useUtils/index.md#invalidate-full-cache-on-every-mutation).
...
You can also find information about [queries](../../../../client/react/useQuery/index.md) and [mutations](../../../../client/react/useMutation/index.md) now that you're using `@trpc/react-query`.
