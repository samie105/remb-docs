...
If you are using React, the best way to call a tRPC API is by using our [React Query Integration](trpc/docs/v10/client/react/index.md), which in addition to typesafe API calls also offers caching, invalidation, and management of loading and error state. If you are using Next.js with the `/pages` directory, you can use our [Next.js integration](trpc/docs/v10/client/nextjs/index.md), which adds helpers for Serverside Rendering and Static Generation in addition to the React Query Integration.
