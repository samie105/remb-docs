...
If you have an existing API deployment like [Express](https://trpc.io/docs/v10/server/adapters/express), [Fastify](https://trpc.io/docs/v10/server/adapters/fastify), or [Next.js](https://trpc.io/docs/v10/server/adapters/nextjs), which you want to integrate tRPC into, you should have a look at their respective adapters. Likewise if you have a preference to host on serverless or edge compute, we have adapters like [AWS Lambda](https://trpc.io/docs/v10/server/adapters/aws-lambda) and [Fetch](https://trpc.io/docs/v10/server/adapters/fetch) which may fit your needs.
