...
source: "https://trpc.io/docs/v10/server/validators"
canonical_url: "https://trpc.io/docs/v10/server/validators"
docset: "trpc"
kind: "library"
adapter: "generic"
last_crawled_at: "2026-04-18T16:40:47.598Z"
...
`.input()` can be stacked to build more complex types, which is particularly useful when you want to utilise some common input to a collection of procedures in a [middleware](../middlewares/index.md).
...
### With [@effect/schema](https://github.com/Effect-TS/effect/tree/main/packages/schema)[​](#with-effectschema "Direct link to with-effectschema")
...
### With [runtypes](https://github.com/pelotom/runtypes)[​](#with-runtypes "Direct link to with-runtypes")
