...
*   a `Subscription` - you might not need this, and we have [dedicated documentation](https://trpc.io/docs/v10/subscriptions)
...
The below example takes a user input and [authorizes](https://en.wikipedia.org/wiki/Authorization) them like protective towns-people. This is obviously a contrived example for simplicity, and not an appropriate way to securely authorize an application user, so in practice you may want to use some combination of [Headers](https://trpc.io/docs/client/headers), [Context](https://trpc.io/docs/v10/server/context), [Middleware](https://trpc.io/docs/v10/server/middlewares), and [Metadata](https://trpc.io/docs/v10/server/metadata), to [authenticate](https://en.wikipedia.org/wiki/Authentication) and authorize your users.
