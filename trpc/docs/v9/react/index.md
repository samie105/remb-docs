...
nav_next: {"path": "../react-mutations/index.md", "title": "useMutation()"}
---

info

*   If you're using Next.js, read the [Usage with Next.js](../nextjs/index.md) guide instead.
...
Follow the [Quickstart](../quickstart/index.md) and read the [`@trpc/server` docs](../router/index.md) for guidance on this. Once you have your API implemented and listening via HTTP, continue to the next step.
