...
This middleware can be re-used for multiple sub-routers by creating a [protected router](https://trpc.io/docs/v9/middlewares#createprotectedrouter-helper) helper.
