---
title: "Quickstart"
source: "https://trpc.io/docs/v9/quickstart"
canonical_url: "https://trpc.io/docs/v9/quickstart"
docset: "trpc"
kind: "library"
adapter: "generic"
last_crawled_at: "2026-04-18T16:43:10.279Z"
...
We highly encourage you to check out [the Example Apps](../example-apps/index.md) to get a feel of tRPC and getting up & running as seamless as possible.
...
### Installation Snippets[​](#installation-snippets "Direct link to Installation Snippets")
...
### Create a router instance[​](#create-a-router-instance "Direct link to Create a router instance")
...
### Add a query endpoint[​](#add-a-query-endpoint "Direct link to Add a query endpoint")
...
### Add a mutation endpoint[​](#add-a-mutation-endpoint "Direct link to Add a mutation endpoint")
...
*   [Usage with Next.js](../nextjs/index.md)
*   [Usage with Express.js (server-side)](../express/index.md)
*   [Usage with React (client-side)](../react/index.md)
