...
*   If you use suspense with [tRPC's _automatic_ SSR in Next.js](https://trpc.io/docs/client/nextjs/pages-router/ssr), the full page will crash on the server if a query fails, even if you have an `<ErrorBoundary />`
...
Suspense equivalent of [`useQueries()`](https://trpc.io/docs/client/react/useQueries).
...
*   If you are using Next.js please look at the docs on [Server-Side Helpers](https://trpc.io/docs/client/nextjs/pages-router/server-side-helpers) to implement server-side prefetching.
