...
section_path: []
nav_prev: {"path": "trpc/docs/client/index.md", "title": "tRPC Client"}
nav_next: {"path": "trpc/docs/client/headers/index.md", "title": "Headers"}
---
...
You also need to enable CORS on your server by modifying your [adapter](../../server/adapters/index.md), or the HTTP server which fronts your API. The best way to do this varies adapter-by-adapter and based on your hosting infrastructure, and individual adapters generally document this process where applicable.
