...
The headers option may be used with any of our HTTP links: [`httpBatchLink`](../links/httpBatchLink/index.md), [`httpBatchStreamLink`](../links/httpBatchStreamLink/index.md), [`httpLink`](../links/httpLink/index.md), or [`httpSubscriptionLink`](../links/httpSubscriptionLink/index.md).
