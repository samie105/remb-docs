...
If you're starting a new project, we recommend using this integration over the [classic React Query integration](../react/index.md). Read the [announcement post](https://trpc.io/blog/introducing-tanstack-react-query-client) for more information about this change.

Head to the [Setup](setup/index.md) guide to get started.
