...
section_path: []
---
`httpBatchLink` is a [**terminating link**](https://trpc.io/docs/client/links#the-terminating-link) that batches an array of individual tRPC operations into a single HTTP request that's sent to a single tRPC procedure.
...
### 2\. Replace `httpBatchLink` with [`httpLink`](https://trpc.io/docs/client/links/httpLink) in your tRPC Client[​](#2-replace-httpbatchlink-with-httplink-in-your-trpc-client "Direct link to 2-replace-httpbatchlink-with-httplink-in-your-trpc-client")
