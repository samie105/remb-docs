...
section_path: []
---
`localLink` is a [**terminating link**](https://trpc.io/docs/client/links#the-terminating-link) that allows you to make tRPC procedure calls directly in your application without going through HTTP.
