...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Getting Started: Upgrading","description":"Learn how to upgrade your Next.js application to the latest version or canary.","url":"https://nextjs.org/docs/app/getting-started/upgrading","image":"https://nextjs.org/api/docs-og?title=Getting Started: Upgrading&amp;sig=c0103ed3dcfe1fa0","dateModified":"2026-04-15","@type":"TechArticle"}
...
*   [Version guides](#version-guides)

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/01-getting-started/18-upgrading.mdx) Scroll to top
