...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"App Router: Getting Started","description":"Learn how to create full-stack web applications with the Next.js App Router.","url":"https://nextjs.org/docs/app/getting-started","image":"https://nextjs.org/api/docs-og?title=App Router: Getting Started&amp;sig=cc1deac3265484cf","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/01-getting-started/index.mdx) Scroll to top
