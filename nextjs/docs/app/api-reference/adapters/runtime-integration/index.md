...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Adapters: Runtime Integration","description":"Understand how build-time adapters and runtime cache interfaces work together.","url":"https://nextjs.org/docs/app/api-reference/adapters/runtime-integration","image":"https://nextjs.org/api/docs-og?title=Adapters: Runtime Integration&amp;sig=e52d5a3fe6288c9a","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/07-adapters/07-runtime-integration.mdx) Scroll to top

[API Reference](/docs/app/api-reference)[Adapters](/docs/app/api-reference/adapters)Runtime Integration
