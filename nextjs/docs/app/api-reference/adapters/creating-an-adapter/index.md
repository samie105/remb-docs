...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Adapters: Creating an Adapter","description":"Create an adapter module that implements the \`NextAdapter\` interface.","url":"https://nextjs.org/docs/app/api-reference/adapters/creating-an-adapter","image":"https://nextjs.org/api/docs-og?title=Adapters: Creating an Adapter&amp;sig=e6d6bcf4e114485d","dateModified":"2026-04-15","@type":"TechArticle"}

On this page

*   [Basic Adapter Structure](#basic-adapter-structure)

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/07-adapters/02-creating-an-adapter.mdx) Scroll to top

[API Reference](/docs/app/api-reference)[Adapters](/docs/app/api-reference/adapters)Creating an Adapter
