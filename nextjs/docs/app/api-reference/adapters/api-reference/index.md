...
canonical_url: "https://nextjs.org/docs/app/api-reference/adapters/api-reference"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Adapters: API Reference","description":"Reference for \`modifyConfig\` and \`onBuildComplete\` in the \`NextAdapter\` interface.","url":"https://nextjs.org/docs/app/api-reference/adapters/api-reference","image":"https://nextjs.org/api/docs-og?title=Adapters: API Reference&amp;sig=56f8e651696710d9","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/07-adapters/03-api-reference.mdx) Scroll to top
