...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"CLI: create-next-app","description":"Create Next.js apps using one command with the create-next-app CLI.","url":"https://nextjs.org/docs/app/api-reference/cli/create-next-app","image":"https://nextjs.org/api/docs-og?title=CLI: create-next-app&amp;sig=aa934b92118a92bd","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/06-cli/create-next-app.mdx) Scroll to top
