...
canonical_url: "https://nextjs.org/docs/app/api-reference/cli/next"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
| `--turbopack` | Force enable [Turbopack](../../turbopack/index.md) (enabled by default). Also available as `--turbo`. |
| `--webpack` | Use Webpack instead of the default [Turbopack](../../turbopack/index.md) bundler for development. |
...
`next experimental-analyze` analyzes your application's bundle output using [Turbopack](../../turbopack/index.md). This command helps you understand the size and composition of your bundles, including JavaScript, CSS, and other assets. This command doesn't produce an application build.
...
See [Package Bundling](../../../guides/package-bundling/index.md#optimizing-large-bundles) for optimization strategies.
