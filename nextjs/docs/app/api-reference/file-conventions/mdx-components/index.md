...
*   [Learn more about MDX Components](#learn-more-about-mdx-components)

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/03-file-conventions/mdx-components.mdx) Scroll to top
