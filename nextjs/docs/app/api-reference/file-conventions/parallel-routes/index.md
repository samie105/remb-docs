...
canonical_url: "https://nextjs.org/docs/app/api-reference/file-conventions/parallel-routes"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"File-system conventions: Parallel Routes","description":"Simultaneously render one or more pages in the same view that can be navigated independently. A pattern for highly dynamic applications.","url":"https://nextjs.org/docs/app/api-reference/file-conventions/parallel-routes","image":"https://nextjs.org/api/docs-og?title=File-system conventions: Parallel Routes&amp;sig=4e1bf43c2429ebfc","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/03-file-conventions/parallel-routes.mdx) Scroll to top
