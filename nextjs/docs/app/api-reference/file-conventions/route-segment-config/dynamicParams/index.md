...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Route Segment Config: dynamicParams","description":"API reference for the dynamicParams route segment config option.","url":"https://nextjs.org/docs/app/api-reference/file-conventions/route-segment-config/dynamicParams","image":"https://nextjs.org/api/docs-og?title=Route Segment Config: dynamicParams&amp;sig=7796051197c9ef08","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/03-file-conventions/02-route-segment-config/dynamicParams.mdx) Scroll to top
