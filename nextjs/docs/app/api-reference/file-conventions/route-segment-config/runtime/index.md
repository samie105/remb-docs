...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Route Segment Config: runtime","description":"API reference for the runtime route segment config option.","url":"https://nextjs.org/docs/app/api-reference/file-conventions/route-segment-config/runtime","image":"https://nextjs.org/api/docs-og?title=Route Segment Config: runtime&amp;sig=bfdb9d96333a5f84","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/03-file-conventions/02-route-segment-config/runtime.mdx) Scroll to top
