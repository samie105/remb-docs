...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"File-system conventions: src","description":"Save pages under the \`src\` folder as an alternative to the root \`pages\` directory.","url":"https://nextjs.org/docs/app/api-reference/file-conventions/src-folder","image":"https://nextjs.org/api/docs-og?title=File-system conventions: src&amp;sig=6160224172248ee1","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/03-file-conventions/src-folder.mdx) Scroll to top
