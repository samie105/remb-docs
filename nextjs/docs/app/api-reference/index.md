...
canonical_url: "https://nextjs.org/docs/app/api-reference"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"App Router: API Reference","description":"Next.js API Reference for the App Router.","url":"https://nextjs.org/docs/app/api-reference","image":"https://nextjs.org/api/docs-og?title=App Router: API Reference&amp;sig=23a6d63bdf3c3fd1","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/index.mdx) Scroll to top
