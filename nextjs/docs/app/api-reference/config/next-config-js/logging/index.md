...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: logging","description":"Configure logging behavior in the terminal when running Next.js in development mode, including fetch logging, incoming requests, and forwarding browser console logs to the terminal.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/logging","image":"https://nextjs.org/api/docs-og?title=next.config.js: logging&amp;sig=7efba73f5f2f65ec","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/logging.mdx) Scroll to top
