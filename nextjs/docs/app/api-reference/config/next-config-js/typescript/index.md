...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: typescript","description":"Configure how Next.js handles TypeScript errors during production builds and specify a custom tsconfig file.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/typescript","image":"https://nextjs.org/api/docs-og?title=next.config.js: typescript&amp;sig=fe7a19817f3920a8","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/typescript.mdx) Scroll to top
