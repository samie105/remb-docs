...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: allowedDevOrigins","description":"Use \`allowedDevOrigins\` to configure additional origins that can request the dev server.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/allowedDevOrigins","image":"https://nextjs.org/api/docs-og?title=next.config.js: allowedDevOrigins&amp;sig=200a3830eedd1600","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/allowedDevOrigins.mdx) Scroll to top
