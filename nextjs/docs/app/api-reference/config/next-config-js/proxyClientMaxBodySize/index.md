...
canonical_url: "https://nextjs.org/docs/app/api-reference/config/next-config-js/proxyClientMaxBodySize"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
last_crawled_at: "2026-04-18T13:08:14.575Z"
content_hash: "c6c531fad9e652469c89388f8913cce730a5b1e0a44a54aa24baeb591bd33eed"
menu_path: ["proxyClientMaxBodySize"]
section_path: []
---
Menu
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: proxyClientMaxBodySize","description":"Configure the maximum request body size when using proxy.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/proxyClientMaxBodySize","image":"https://nextjs.org/api/docs-og?title=next.config.js: proxyClientMaxBodySize&amp;sig=7e71a596e71d8fb2","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/proxyClientMaxBodySize.mdx) Scroll to top

[Configuration](/docs/app/api-reference/config)[next.config.js](/docs/app/api-reference/config/next-config-js)proxyClientMaxBodySize
