...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: typedRoutes","description":"Enable support for statically typed links.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/typedRoutes","image":"https://nextjs.org/api/docs-og?title=next.config.js: typedRoutes&amp;sig=0e2cbdce861cdf83","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/typedRoutes.mdx) Scroll to top
