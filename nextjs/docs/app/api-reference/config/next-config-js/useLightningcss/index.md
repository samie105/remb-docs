...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: useLightningcss","description":"Enable experimental support for Lightning CSS.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/useLightningcss","image":"https://nextjs.org/api/docs-og?title=next.config.js: useLightningcss&amp;sig=f86fd345d5e717b5","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/useLightningcss.mdx) Scroll to top
