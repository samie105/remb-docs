...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: staleTimes","description":"Learn how to override the invalidation time of the client cache.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/staleTimes","image":"https://nextjs.org/api/docs-og?title=next.config.js: staleTimes&amp;sig=15d03873a8e4d328","dateModified":"2026-04-15","@type":"TechArticle"}

On this page

*   [Version History](#version-history)

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/staleTimes.mdx) Scroll to top
