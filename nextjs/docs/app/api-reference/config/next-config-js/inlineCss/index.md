...
canonical_url: "https://nextjs.org/docs/app/api-reference/config/next-config-js/inlineCss"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: inlineCss","description":"Enable inline CSS support.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/inlineCss","image":"https://nextjs.org/api/docs-og?title=next.config.js: inlineCss&amp;sig=07d2c51f764aa7e9","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/inlineCss.mdx) Scroll to top
