...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: crossOrigin","description":"Use the \`crossOrigin\` option to add a crossOrigin tag on the \`script\` tags generated by \`next/script\`.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/crossOrigin","image":"https://nextjs.org/api/docs-og?title=next.config.js: crossOrigin&amp;sig=071f5911b4e6d231","dateModified":"2026-04-15","@type":"TechArticle"}

On this page

*   [Options](#options)

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/crossOrigin.mdx) Scroll to top
