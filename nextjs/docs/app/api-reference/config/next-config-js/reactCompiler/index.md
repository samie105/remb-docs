...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: reactCompiler","description":"Enable the React Compiler to automatically optimize component rendering.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/reactCompiler","image":"https://nextjs.org/api/docs-og?title=next.config.js: reactCompiler&amp;sig=e22cbb77347cf73d","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/reactCompiler.mdx) Scroll to top
