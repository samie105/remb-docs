...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: onDemandEntries","description":"Configure how Next.js will dispose and keep in memory pages created in development.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/onDemandEntries","image":"https://nextjs.org/api/docs-og?title=next.config.js: onDemandEntries&amp;sig=cb737fabafb4acad","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/onDemandEntries.mdx) Scroll to top
