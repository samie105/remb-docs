...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: viewTransition","description":"Enable ViewTransition API from React in App Router","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/viewTransition","image":"https://nextjs.org/api/docs-og?title=next.config.js: viewTransition&amp;sig=96495df086d06555","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/viewTransition.mdx) Scroll to top
