...
The `deploymentId` option allows you to set an identifier for your deployment. This identifier is used for [version skew](../../../../guides/self-hosting/index.md#version-skew) protection and cache busting during rolling deployments.
...
-   [Self-Hosting - Version Skew](../../../../guides/self-hosting/index.md#version-skew)
-   [generateBuildId](../generateBuildId/index.md)
