...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: turbopackFileSystemCache","description":"Learn how to enable FileSystem Caching for Turbopack builds","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/turbopackFileSystemCache","image":"https://nextjs.org/api/docs-og?title=next.config.js: turbopackFileSystemCache&amp;sig=956703e4874bf45c","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/turbopackFileSystemCache.mdx) Scroll to top
