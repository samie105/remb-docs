...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: staticGeneration\*","description":"Learn how to configure static generation in your Next.js application.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/staticGeneration","image":"https://nextjs.org/api/docs-og?title=next.config.js: staticGeneration\*&amp;sig=4fb35c7b473f00e8","dateModified":"2026-04-15","@type":"TechArticle"}

On this page

*   [Config Options](#config-options)

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/staticGeneration.mdx) Scroll to top
