...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: basePath","description":"Use \`basePath\` to deploy a Next.js application under a sub-path of a domain.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/basePath","image":"https://nextjs.org/api/docs-og?title=next.config.js: basePath&amp;sig=6089e9efd2096ee7","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/basePath.mdx) Scroll to top
