...
canonical_url: "https://nextjs.org/docs/app/api-reference/config/next-config-js/redirects"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
last_crawled_at: "2026-04-27T18:07:11.449Z"
content_hash: "615cd55d4a926c8e8c8dc188eeba8370eb45d9c62a73e958dad7b9c7374df75d"
menu_path: ["redirects"]
section_path: []
version: "latest"
content_language: "en"
...
When using the Pages Router, redirects are not applied to client-side routing (`Link`, `router.push`) unless [Proxy](../../../file-conventions/proxy/index.md) is present and matches the path.
...
When leveraging [`basePath` support](../basePath/index.md) with redirects each `source` and `destination` is automatically prefixed with the `basePath` unless you add `basePath: false` to the redirect:
...
For dynamic or per-request locale handling, use [dynamic route segments and proxy](../../../../guides/internationalization/index.md), which can redirect based on the user's preferred language.
...
-   Inside [API Routes](../../../../../pages/building-your-application/routing/api-routes/index.md) and [Route Handlers](../../../file-conventions/route/index.md), you can redirect based on the incoming request.
-   Inside [`getStaticProps`](../../../../../pages/building-your-application/data-fetching/get-static-props/index.md) and [`getServerSideProps`](../../../../../pages/building-your-application/data-fetching/get-server-side-props/index.md), you can redirect specific pages at request-time.
