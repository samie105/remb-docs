...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: sassOptions","description":"Configure Sass options.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/sassOptions","image":"https://nextjs.org/api/docs-og?title=next.config.js: sassOptions&amp;sig=4c591729437d53b6","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/sassOptions.mdx) Scroll to top
