...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: cacheLife","description":"Learn how to set up cacheLife configurations in Next.js.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/cacheLife","image":"https://nextjs.org/api/docs-og?title=next.config.js: cacheLife&amp;sig=9e060a6a8a98aca3","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/cacheLife.mdx) Scroll to top
