...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: authInterrupts","description":"Learn how to enable the experimental \`authInterrupts\` configuration option to use \`forbidden\` and \`unauthorized\`.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/authInterrupts","image":"https://nextjs.org/api/docs-og?title=next.config.js: authInterrupts&amp;sig=01e9a2777e57df57","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/authInterrupts.mdx) Scroll to top
