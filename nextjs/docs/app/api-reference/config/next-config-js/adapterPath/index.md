...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: adapterPath","description":"Configure a custom adapter for Next.js to hook into the build process.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/adapterPath","image":"https://nextjs.org/api/docs-og?title=next.config.js: adapterPath&amp;sig=35adf4094965eb50","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/adapterPath.mdx) Scroll to top
