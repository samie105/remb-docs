...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: env","description":"Learn to add and access environment variables in your Next.js application at build time.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/env","image":"https://nextjs.org/api/docs-og?title=next.config.js: env&amp;sig=a2bf9bc8c382afec","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/env.mdx) Scroll to top
