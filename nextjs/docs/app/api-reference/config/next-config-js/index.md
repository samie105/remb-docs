...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Configuration: next.config.js","description":"Learn how to configure your application with next.config.js.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js","image":"https://nextjs.org/api/docs-og?title=Configuration: next.config.js&amp;sig=311ae45d78938f03","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/index.mdx) Scroll to top
