...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: trailingSlash","description":"Configure Next.js pages to resolve with or without a trailing slash.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/trailingSlash","image":"https://nextjs.org/api/docs-og?title=next.config.js: trailingSlash&amp;sig=ddb36f7baa9f9130","dateModified":"2026-04-15","@type":"TechArticle"}

On this page

*   [Version History](#version-history)

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/trailingSlash.mdx) Scroll to top
