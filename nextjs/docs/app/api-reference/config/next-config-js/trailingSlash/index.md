...
When used with [`output: "export"`](../../../../guides/static-exports/index.md) configuration, the `/about` page will output `/about/index.html` (instead of the default `/about.html`).
