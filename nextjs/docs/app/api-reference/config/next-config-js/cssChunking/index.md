...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: cssChunking","description":"Use the \`cssChunking\` option to control how CSS files are chunked in your Next.js application.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/cssChunking","image":"https://nextjs.org/api/docs-og?title=next.config.js: cssChunking&amp;sig=6a3f759d097e3b8d","dateModified":"2026-04-15","@type":"TechArticle"}

On this page

*   [Options](#options)

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/cssChunking.mdx) Scroll to top
