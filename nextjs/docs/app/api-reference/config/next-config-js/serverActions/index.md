...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: serverActions","description":"Configure Server Actions behavior in your Next.js application.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/serverActions","image":"https://nextjs.org/api/docs-og?title=next.config.js: serverActions&amp;sig=25fdf4508d7b841b","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/serverActions.mdx) Scroll to top
