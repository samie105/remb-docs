...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: mdxRs","description":"Use the new Rust compiler to compile MDX files in the App Router.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/mdxRs","image":"https://nextjs.org/api/docs-og?title=next.config.js: mdxRs&amp;sig=8efb16a291e47498","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/mdxRs.mdx) Scroll to top
