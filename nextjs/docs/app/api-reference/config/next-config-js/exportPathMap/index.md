...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js: exportPathMap","description":"Customize the pages that will be exported as HTML files when using \`next export\`.","url":"https://nextjs.org/docs/app/api-reference/config/next-config-js/exportPathMap","image":"https://nextjs.org/api/docs-og?title=next.config.js: exportPathMap&amp;sig=f11dbcf30540f81e","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/05-config/01-next-config-js/exportPathMap.mdx) Scroll to top
