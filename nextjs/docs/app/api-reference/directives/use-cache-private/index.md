...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Directives: use cache: private","description":"Learn how to use the &quot;use cache: private&quot; directive to cache functions that access runtime request APIs.","url":"https://nextjs.org/docs/app/api-reference/directives/use-cache-private","image":"https://nextjs.org/api/docs-og?title=Directives: use cache: private&amp;sig=fdbfa87509901a40","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/01-directives/use-cache-private.mdx) Scroll to top
