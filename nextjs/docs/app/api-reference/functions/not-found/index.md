...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Functions: notFound","description":"API Reference for the notFound function.","url":"https://nextjs.org/docs/app/api-reference/functions/not-found","image":"https://nextjs.org/api/docs-og?title=Functions: notFound&amp;sig=d897269e37cbc541","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/04-functions/not-found.mdx) Scroll to top
