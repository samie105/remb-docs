...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Functions: cacheTag","description":"Learn how to use the cacheTag function to manage cache invalidation in your Next.js application.","url":"https://nextjs.org/docs/app/api-reference/functions/cacheTag","image":"https://nextjs.org/api/docs-og?title=Functions: cacheTag&amp;sig=abda924785225e33","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/04-functions/cacheTag.mdx) Scroll to top
