...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Functions: useReportWebVitals","description":"API Reference for the useReportWebVitals function.","url":"https://nextjs.org/docs/app/api-reference/functions/use-report-web-vitals","image":"https://nextjs.org/api/docs-og?title=Functions: useReportWebVitals&amp;sig=734094bd6148bfea","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/04-functions/use-report-web-vitals.mdx) Scroll to top
