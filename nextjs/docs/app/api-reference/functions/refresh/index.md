...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Functions: refresh","description":"API Reference for the refresh function.","url":"https://nextjs.org/docs/app/api-reference/functions/refresh","image":"https://nextjs.org/api/docs-og?title=Functions: refresh&amp;sig=d873a5ca9353ab0d","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/04-functions/refresh.mdx) Scroll to top
