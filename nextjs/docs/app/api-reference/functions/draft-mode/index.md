...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Functions: draftMode","description":"API Reference for the draftMode function.","url":"https://nextjs.org/docs/app/api-reference/functions/draft-mode","image":"https://nextjs.org/api/docs-og?title=Functions: draftMode&amp;sig=c7b42b6a03174fdb","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/04-functions/draft-mode.mdx) Scroll to top
