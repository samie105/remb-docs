...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Functions: generateSitemaps","description":"Learn how to use the generateSiteMaps function to create multiple sitemaps for your application.","url":"https://nextjs.org/docs/app/api-reference/functions/generate-sitemaps","image":"https://nextjs.org/api/docs-og?title=Functions: generateSitemaps&amp;sig=f2034d88a2991b55","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/04-functions/generate-sitemaps.mdx) Scroll to top
