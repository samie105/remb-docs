...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Functions: connection","description":"API Reference for the connection function.","url":"https://nextjs.org/docs/app/api-reference/functions/connection","image":"https://nextjs.org/api/docs-og?title=Functions: connection&amp;sig=2138692f70dff642","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/04-functions/connection.mdx) Scroll to top
