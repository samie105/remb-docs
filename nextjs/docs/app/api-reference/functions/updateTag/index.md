...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Functions: updateTag","description":"API Reference for the updateTag function.","url":"https://nextjs.org/docs/app/api-reference/functions/updateTag","image":"https://nextjs.org/api/docs-og?title=Functions: updateTag&amp;sig=c52a42baca129e6a","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/04-functions/updateTag.mdx) Scroll to top
