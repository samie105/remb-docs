...
kind: "framework"
adapter: "nextjs"
last_crawled_at: "2026-04-18T13:11:18.087Z"
content_hash: "331cc160577f6fc079ce4048f712a223c83beea0583b22fe261d51c65e9b6544"
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Functions: unstable\_catchError","description":"API Reference for the unstable\_catchError function.","url":"https://nextjs.org/docs/app/api-reference/functions/catchError","image":"https://nextjs.org/api/docs-og?title=Functions: unstable\_catchError&amp;sig=39b57ea4f37be633","dateModified":"2026-04-15","@type":"TechArticle"}
...
*   [Learn more about error handling](#learn-more-about-error-handling)

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/04-functions/catchError.mdx) Scroll to top
...
Re-fetches and re-renders the error boundary's children. If successful, the fallback is replaced with the re-rendered result.

`reset`

`() => void`

Resets the error state and re-renders without re-fetching. Use [`unstable_retry()`](/docs/app/api-reference/file-conventions/error#unstable_retry) in most cases.
...
`unstable_catchError` introduced.
