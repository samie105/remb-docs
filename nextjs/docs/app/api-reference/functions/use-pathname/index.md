...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Functions: usePathname","description":"API Reference for the usePathname hook.","url":"https://nextjs.org/docs/app/api-reference/functions/use-pathname","image":"https://nextjs.org/api/docs-og?title=Functions: usePathname&amp;sig=8a15e753f004fe88","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/04-functions/use-pathname.mdx) Scroll to top
