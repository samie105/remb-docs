...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Functions: useLinkStatus","description":"API Reference for the useLinkStatus hook.","url":"https://nextjs.org/docs/app/api-reference/functions/use-link-status","image":"https://nextjs.org/api/docs-og?title=Functions: useLinkStatus&amp;sig=da82ba102b638e5e","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/04-functions/use-link-status.mdx) Scroll to top
