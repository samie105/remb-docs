...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Functions: redirect","description":"API Reference for the redirect function.","url":"https://nextjs.org/docs/app/api-reference/functions/redirect","image":"https://nextjs.org/api/docs-og?title=Functions: redirect&amp;sig=cd908e5f16cb2144","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/04-functions/redirect.mdx) Scroll to top
