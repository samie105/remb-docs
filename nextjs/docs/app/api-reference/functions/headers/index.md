...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Functions: headers","description":"API reference for the headers function.","url":"https://nextjs.org/docs/app/api-reference/functions/headers","image":"https://nextjs.org/api/docs-og?title=Functions: headers&amp;sig=04114b76886702f1","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/04-functions/headers.mdx) Scroll to top
