...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Functions: useParams","description":"API Reference for the useParams hook.","url":"https://nextjs.org/docs/app/api-reference/functions/use-params","image":"https://nextjs.org/api/docs-og?title=Functions: useParams&amp;sig=ca81ba8e0f3ae9f1","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/03-api-reference/04-functions/use-params.mdx) Scroll to top
