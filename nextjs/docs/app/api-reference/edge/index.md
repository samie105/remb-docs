...
kind: "framework"
adapter: "nextjs"
last_crawled_at: "2026-04-27T18:08:22.719Z"
content_hash: "56acaf0bd3a90f519fbcd933bd619758e86bf8b2a79c60c3718e6979e0354b7d"
...
-   The **Edge Runtime** which contains a more limited [set of APIs](#reference), used in [Proxy](../file-conventions/proxy/index.md).

## Caveats[](#caveats)

-   The Edge Runtime does not support all Node.js APIs. Some packages may not work as expected.
-   The Edge Runtime does not support Incremental Static Regeneration (ISR).
-   Both runtimes can support [streaming](../file-conventions/loading/index.md) depending on your deployment adapter.
...
You can use `process.env` to access [Environment Variables](../../guides/environment-variables/index.md) for both `next dev` and `next build`.
