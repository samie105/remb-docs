...
canonical_url: "https://nextjs.org/docs/app/guides"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"App Router: Guides","description":"Learn how to implement common patterns and real-world use cases using Next.js","url":"https://nextjs.org/docs/app/guides","image":"https://nextjs.org/api/docs-og?title=App Router: Guides&amp;sig=bb084aec6c6f58c9","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/02-guides/index.mdx) Scroll to top
