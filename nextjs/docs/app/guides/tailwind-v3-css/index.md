...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Guides: Tailwind CSS v3","description":"Style your Next.js Application using Tailwind CSS v3 for broader browser support.","url":"https://nextjs.org/docs/app/guides/tailwind-v3-css","image":"https://nextjs.org/api/docs-og?title=Guides: Tailwind CSS v3&amp;sig=f09d133be2c09d04","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/02-guides/tailwind-v3-css.mdx) Scroll to top
