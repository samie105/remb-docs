...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Guides: Next.js MCP Server","description":"Learn how to use Next.js MCP support to allow coding agents access to your application state","url":"https://nextjs.org/docs/app/guides/mcp","image":"https://nextjs.org/api/docs-og?title=Guides: Next.js MCP Server&amp;sig=18312e2bbfd5455b","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/02-guides/mcp.mdx) Scroll to top
