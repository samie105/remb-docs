...
kind: "framework"
adapter: "nextjs"
last_crawled_at: "2026-04-27T18:16:15.840Z"
content_hash: "78c95323e9664ea0927837de2ba4ac866bdfffee977155598775ea2ee54c7577"
...
-   The `next export` command has been removed in favor of `output: 'export'` config. Please see the [docs](../../static-exports/index.md) for more information.
-   The `next/server` import for `ImageResponse` was renamed to `next/og`. A [codemod is available](../codemods/index.md#next-og-import) to safely and automatically rename your imports.
-   The `@next/font` package has been fully removed in favor of the built-in `next/font`. A [codemod is available](../codemods/index.md#built-in-next-font) to safely and automatically rename your imports.
