...
canonical_url: "https://nextjs.org/docs/app/guides/custom-server"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
last_crawled_at: "2026-04-18T13:14:24.350Z"
content_hash: "db25876ce388242a89fe1f4e88ea047201ab8dc623ae0cff8f6b255d0bbe8022"
menu_path: ["How to set up a custom server in Next.js"]
section_path: []
---
Menu
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Guides: Custom Server","description":"Start a Next.js app programmatically using a custom server.","url":"https://nextjs.org/docs/app/guides/custom-server","image":"https://nextjs.org/api/docs-og?title=Guides: Custom Server&amp;sig=6d70f70fc3b225fd","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/01-app/02-guides/custom-server.mdx) Scroll to top

[App Router](/docs/app)[Guides](/docs/app/guides)Custom Server
...
The same object you would use in `next.config.js`. Defaults to `{}`

`dev`

`Boolean`

(_Optional_) Whether or not to launch Next.js in dev mode. Defaults to `false`

`dir`

`String`

(_Optional_) Location of the Next.js project. Defaults to `'.'`

`quiet`

`Boolean`

(_Optional_) Hide error messages containing server information. Defaults to `false`

`hostname`

`String`

(_Optional_) The hostname the server is running behind

`port`

`Number`

(_Optional_) The port the server is running behind

`httpServer`

`node:http#Server`

(_Optional_) The HTTP Server that Next.js is running behind

`turbopack`

`Boolean`

(_Optional_) Enable Turbopack (enabled by default)

`webpack`

`Boolean`

(_Optional_) Enable webpack
