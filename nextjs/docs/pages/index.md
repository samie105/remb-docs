...
canonical_url: "https://nextjs.org/docs/pages"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Next.js Docs: Pages Router","description":"Before Next.js 13, the Pages Router was the main way to create routes in Next.js with an intuitive file-system router.","url":"https://nextjs.org/docs/pages","image":"https://nextjs.org/api/docs-og?title=Next.js Docs: Pages Router&amp;sig=add511eb02bcc3bf","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/index.mdx) Scroll to top
