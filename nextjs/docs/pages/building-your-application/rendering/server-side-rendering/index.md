...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Rendering: Server-side Rendering (SSR)","description":"Use Server-side Rendering to render pages on each request.","url":"https://nextjs.org/docs/pages/building-your-application/rendering/server-side-rendering","image":"https://nextjs.org/api/docs-og?title=Rendering: Server-side Rendering (SSR)&amp;sig=3db8c71baa9dacd0","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/03-building-your-application/02-rendering/01-server-side-rendering.mdx) Scroll to top
