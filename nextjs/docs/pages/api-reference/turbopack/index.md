...
kind: "framework"
adapter: "nextjs"
last_crawled_at: "2026-04-27T18:22:06.405Z"
content_hash: "4a75d037c48f1ef71014ca0c22c64d8d017d268cdc95f66cbf7843c8009d9bd2"
menu_path: ["Turbopack"]
section_path: []
version: "latest"
content_language: "en"
...
| **Babel** | **Supported** | Starting in Next.js 16, Turbopack uses Babel automatically if it detects [a configuration file](https://babeljs.io/docs/config-files). Unlike in webpack, SWC is always used for Next.js's internal transforms and downleveling to older ECMAScript revisions. Next.js with webpack disables SWC if a Babel configuration file is present. Files in `node_modules` are excluded, unless you [manually configure `babel-loader`](../../../app/api-reference/config/next-config-js/turbopack/index.md#configuring-webpack-loaders). |
...
| **Manual Aliases** | **Supported** | [Configure `resolveAlias` in `next.config.js`](../../../app/api-reference/config/next-config-js/turbopack/index.md#resolving-aliases) (similar to `webpack.resolve.alias`). |
| **Custom Extensions** | **Supported** | [Configure `resolveExtensions` in `next.config.js`](../../../app/api-reference/config/next-config-js/turbopack/index.md#resolving-custom-extensions). |
...
See [Lazy Loading](../../../app/guides/lazy-loading/index.md#magic-comments) for usage examples.
...
You can configure the filesystem root using [turbopack.root](../../../app/api-reference/config/next-config-js/turbopack/index.md#root-directory) option in `next.config.js`.

### CSS Module Ordering[](#css-module-ordering)

Turbopack will follow JS import order to order [CSS modules](../../../app/getting-started/css/index.md#css-modules) which are not otherwise ordered. For example:
...
-   [`experimental.turbopackFileSystemCacheForDev`](../../../app/api-reference/config/next-config-js/turbopackFileSystemCache/index.md) is enabled by default
-   [`experimental.turbopackFileSystemCacheForBuild`](../../../app/api-reference/config/next-config-js/turbopackFileSystemCache/index.md) is currently opt-in
...
Turbopack does not support webpack plugins. This affects third-party tools that rely on webpack's plugin system for integration. We do support [webpack loaders](../../../app/api-reference/config/next-config-js/turbopack/index.md#configuring-webpack-loaders). If you depend on webpack plugins, you'll need to find Turbopack-compatible alternatives or continue using webpack until equivalent functionality is available.
...
-   **`webpack()` configuration** in `next.config.js` Turbopack replaces webpack, so `webpack()` configs are not recognized. Use the [`turbopack` config](../../../app/api-reference/config/next-config-js/turbopack/index.md) instead.
...
For a full, detailed breakdown of each feature flag and its status, see the [Turbopack API Reference](../../../app/api-reference/config/next-config-js/turbopack/index.md).
...
-   **`rules`** Define additional [webpack loaders](../../../app/api-reference/config/next-config-js/turbopack/index.md#configuring-webpack-loaders) for file transformations.
...
-   **[`ignoreIssue`](../../../app/api-reference/config/next-config-js/turbopackIgnoreIssue/index.md)** Suppress specific Turbopack errors and warnings from the CLI output and error overlay.
...
| --- | --- | --- | --- |
| [`turbopackFileSystemCacheForDev`](../../../app/api-reference/config/next-config-js/turbopackFileSystemCache/index.md) | Enable filesystem cache for the dev server. | `true` | N/A |
| [`turbopackFileSystemCacheForBuild`](../../../app/api-reference/config/next-config-js/turbopackFileSystemCache/index.md) | Enable filesystem cache for builds. | N/A | `false` |
...
For more in-depth configuration examples, see the [Turbopack config documentation](../../../app/api-reference/config/next-config-js/turbopack/index.md).
