...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"File-system conventions: public","description":"Next.js allows you to serve static files, like images, in the public directory. You can learn how it works here.","url":"https://nextjs.org/docs/pages/api-reference/file-conventions/public-folder","image":"https://nextjs.org/api/docs-og?title=File-system conventions: public&amp;sig=e6ee1cf9c8473640","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/02-file-conventions/public-folder.mdx) Scroll to top
