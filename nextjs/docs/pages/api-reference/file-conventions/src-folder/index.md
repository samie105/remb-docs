...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"File-system conventions: src Directory","description":"Save pages under the \`src\` folder as an alternative to the root \`pages\` directory.","url":"https://nextjs.org/docs/pages/api-reference/file-conventions/src-folder","image":"https://nextjs.org/api/docs-og?title=File-system conventions: src Directory&amp;sig=17457377dc8891df","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/02-file-conventions/src-folder.mdx) Scroll to top
