...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"File-system conventions: Proxy","description":"Learn how to use Proxy to run code before a request is completed.","url":"https://nextjs.org/docs/pages/api-reference/file-conventions/proxy","image":"https://nextjs.org/api/docs-og?title=File-system conventions: Proxy&amp;sig=3512651f088186a9","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/02-file-conventions/proxy.mdx) Scroll to top
