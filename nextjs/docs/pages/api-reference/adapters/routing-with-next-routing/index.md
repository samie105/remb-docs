...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Adapters: Routing with @next/routing","description":"Use \`@next/routing\` to apply Next.js route matching behavior in adapters.","url":"https://nextjs.org/docs/pages/api-reference/adapters/routing-with-next-routing","image":"https://nextjs.org/api/docs-og?title=Adapters: Routing with @next/routing&amp;sig=a74c3dd995b2e9ce","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/06-adapters/05-routing-with-next-routing.mdx) Scroll to top

[API Reference](/docs/pages/api-reference)[Adapters](/docs/pages/api-reference/adapters)Routing with @next/routing
