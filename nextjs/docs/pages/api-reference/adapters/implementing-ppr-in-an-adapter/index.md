...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Adapters: Implementing PPR in an Adapter","description":"Implement Partial Prerendering support in an adapter using fallback output and cache hooks.","url":"https://nextjs.org/docs/pages/api-reference/adapters/implementing-ppr-in-an-adapter","image":"https://nextjs.org/api/docs-og?title=Adapters: Implementing PPR in an Adapter&amp;sig=13476493e6b61a4c","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/06-adapters/06-implementing-ppr-in-an-adapter.mdx) Scroll to top
