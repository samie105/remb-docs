...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Adapters: Creating an Adapter","description":"Create an adapter module that implements the \`NextAdapter\` interface.","url":"https://nextjs.org/docs/pages/api-reference/adapters/creating-an-adapter","image":"https://nextjs.org/api/docs-og?title=Adapters: Creating an Adapter&amp;sig=e6d6bcf4e114485d","dateModified":"2026-04-15","@type":"TechArticle"}

On this page

*   [Basic Adapter Structure](#basic-adapter-structure)

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/06-adapters/02-creating-an-adapter.mdx) Scroll to top
