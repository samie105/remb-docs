...
section_path: []
nav_prev: {"path": "nextjs/docs/pages/api-reference/adapters/api-reference/index.md", "title": "API Reference"}
nav_next: {"path": "nextjs/docs/pages/api-reference/adapters/routing-with-next-routing/index.md", "title": "Routing with @next/routing"}
---
