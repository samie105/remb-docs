...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Adapters: Configuration","description":"Configure \`adapterPath\` or \`NEXT\_ADAPTER\_PATH\` to use a custom deployment adapter.","url":"https://nextjs.org/docs/pages/api-reference/adapters/configuration","image":"https://nextjs.org/api/docs-og?title=Adapters: Configuration&amp;sig=1925b3572aca2a0f","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/06-adapters/01-configuration.mdx) Scroll to top
