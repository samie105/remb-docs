...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"API Reference: Adapters","description":"Build deployment adapters for Next.js platforms and infrastructure.","url":"https://nextjs.org/docs/pages/api-reference/adapters","image":"https://nextjs.org/api/docs-og?title=API Reference: Adapters&amp;sig=fbb190a1b65ec876","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/06-adapters/index.mdx) Scroll to top

[Pages Router](/docs/pages)[API Reference](/docs/pages/api-reference)Adapters
