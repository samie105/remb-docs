...
canonical_url: "https://nextjs.org/docs/pages/api-reference/functions/use-search-params"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Functions: useSearchParams","description":"API Reference for the useSearchParams hook in the Pages Router.","url":"https://nextjs.org/docs/pages/api-reference/functions/use-search-params","image":"https://nextjs.org/api/docs-og?title=Functions: useSearchParams&amp;sig=69c8c561e34ae745","dateModified":"2026-04-15","@type":"TechArticle"}
...
*   [Sharing components with App Router](#sharing-components-with-app-router)
*   [Version History](#version-history)

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/03-functions/use-search-params.mdx) Scroll to top
