...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Functions: getInitialProps","description":"Fetch dynamic data on the server for your React component with getInitialProps.","url":"https://nextjs.org/docs/pages/api-reference/functions/get-initial-props","image":"https://nextjs.org/api/docs-og?title=Functions: getInitialProps&amp;sig=9274c827d41e4b76","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/03-functions/get-initial-props.mdx) Scroll to top
