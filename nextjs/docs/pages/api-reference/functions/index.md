...
canonical_url: "https://nextjs.org/docs/pages/api-reference/functions"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"API Reference: Functions","description":"API Reference for Functions and Hooks in Pages Router.","url":"https://nextjs.org/docs/pages/api-reference/functions","image":"https://nextjs.org/api/docs-og?title=API Reference: Functions&amp;sig=fa3ed9ff35379a27","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/03-functions/index.mdx) Scroll to top
