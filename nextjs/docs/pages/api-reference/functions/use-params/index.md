...
canonical_url: "https://nextjs.org/docs/pages/api-reference/functions/use-params"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Functions: useParams","description":"API Reference for the useParams hook in the Pages Router.","url":"https://nextjs.org/docs/pages/api-reference/functions/use-params","image":"https://nextjs.org/api/docs-og?title=Functions: useParams&amp;sig=ca81ba8e0f3ae9f1","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/03-functions/use-params.mdx) Scroll to top
