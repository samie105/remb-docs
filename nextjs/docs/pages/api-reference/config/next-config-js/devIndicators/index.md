...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: devIndicators","description":"Optimized pages include an indicator to let you know if it&apos;s being statically optimized. You can opt-out of it here.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/devIndicators","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: devIndicators&amp;sig=cd59781d1a94218d","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/devIndicators.mdx) Scroll to top
