...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: allowedDevOrigins","description":"Use \`allowedDevOrigins\` to configure additional origins that can request the dev server.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/allowedDevOrigins","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: allowedDevOrigins&amp;sig=066acda327166474","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/allowedDevOrigins.mdx) Scroll to top
