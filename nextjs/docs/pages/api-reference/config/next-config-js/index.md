...
The `unstable_getResponseFromNextConfig` function runs the [`headers`](../../../../app/api-reference/config/next-config-js/headers/index.md), [`redirects`](../../../../app/api-reference/config/next-config-js/redirects/index.md), and [`rewrites`](../../../../app/api-reference/config/next-config-js/rewrites/index.md) functions from `next.config.js` with the provided request information and returns `NextResponse` with the results of the routing.
...
](bundlePagesRouterDependencies/index.md)[
