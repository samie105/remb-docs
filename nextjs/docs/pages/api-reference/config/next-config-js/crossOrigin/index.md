...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: crossOrigin","description":"Use the \`crossOrigin\` option to add a crossOrigin tag on the \`script\` tags generated by \`next/script\` and \`next/head\`.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/crossOrigin","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: crossOrigin&amp;sig=5d6d100027042ad9","dateModified":"2026-04-15","@type":"TechArticle"}

On this page

*   [Options](#options)

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/crossOrigin.mdx) Scroll to top
