...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: logging","description":"Configure logging behavior in the terminal when running Next.js in development mode.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/logging","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: logging&amp;sig=667bdec02886a196","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/logging.mdx) Scroll to top

[Configuration](/docs/pages/api-reference/config)[next.config.js Options](/docs/pages/api-reference/config/next-config-js)logging
