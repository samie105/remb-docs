...
canonical_url: "https://nextjs.org/docs/pages/api-reference/config/next-config-js/assetPrefix"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: assetPrefix","description":"Learn how to use the assetPrefix config option to configure your CDN.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/assetPrefix","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: assetPrefix&amp;sig=e33e3fe5e0910eba","dateModified":"2026-04-15","@type":"TechArticle"}

On this page

*   [Set up a CDN](#set-up-a-cdn)

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/assetPrefix.mdx) Scroll to top
