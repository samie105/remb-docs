...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: generateEtags","description":"Next.js will generate etags for every page by default. Learn more about how to disable etag generation here.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/generateEtags","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: generateEtags&amp;sig=954f69bf2e498c80","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/generateEtags.mdx) Scroll to top
