...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: rewrites","description":"Add rewrites to your Next.js app.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/rewrites","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: rewrites&amp;sig=c8668bafbc1a514c","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/rewrites.mdx) Scroll to top
