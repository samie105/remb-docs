...
canonical_url: "https://nextjs.org/docs/pages/api-reference/config/next-config-js/images"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: images","description":"Custom configuration for the next/image loader","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/images","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: images&amp;sig=ac03df0a08b9b0f7","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/images.mdx) Scroll to top
