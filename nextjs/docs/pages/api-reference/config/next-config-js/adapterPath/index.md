...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: adapterPath","description":"Configure a custom adapter for Next.js to hook into the build process.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/adapterPath","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: adapterPath&amp;sig=cded95f159afacca","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/adapterPath.mdx) Scroll to top
