...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: trailingSlash","description":"Configure Next.js pages to resolve with or without a trailing slash.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/trailingSlash","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: trailingSlash&amp;sig=241d43c2a52409d2","dateModified":"2026-04-15","@type":"TechArticle"}

On this page

*   [Version History](#version-history)

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/trailingSlash.mdx) Scroll to top
