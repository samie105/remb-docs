...
canonical_url: "https://nextjs.org/docs/pages/api-reference/config/next-config-js/exportPathMap"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: exportPathMap","description":"Customize the pages that will be exported as HTML files when using \`next export\`.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/exportPathMap","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: exportPathMap&amp;sig=f33c63f2e6c09ae7","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/exportPathMap.mdx) Scroll to top
