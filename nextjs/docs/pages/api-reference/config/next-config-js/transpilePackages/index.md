...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: transpilePackages","description":"Automatically transpile and bundle dependencies from local packages (like monorepos) or from external dependencies (\`node\_modules\`).","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/transpilePackages","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: transpilePackages&amp;sig=26ffdce172c4236c","dateModified":"2026-04-15","@type":"TechArticle"}

On this page

*   [Version History](#version-history)

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/transpilePackages.mdx) Scroll to top
