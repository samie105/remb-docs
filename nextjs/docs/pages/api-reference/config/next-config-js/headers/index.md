...
canonical_url: "https://nextjs.org/docs/pages/api-reference/config/next-config-js/headers"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: headers","description":"Add custom HTTP headers to your Next.js app.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/headers","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: headers&amp;sig=5ba1bfbfe0a8b416","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/headers.mdx) Scroll to top
