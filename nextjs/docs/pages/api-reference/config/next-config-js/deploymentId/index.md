---
title: "deploymentId"
source: "https://nextjs.org/docs/pages/api-reference/config/next-config-js/deploymentId"
canonical_url: "https://nextjs.org/docs/pages/api-reference/config/next-config-js/deploymentId"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: deploymentId","description":"Configure a deployment identifier used for version skew protection and cache busting.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/deploymentId","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: deploymentId&amp;sig=899b6fad644e0dcb","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/deploymentId.mdx) Scroll to top
