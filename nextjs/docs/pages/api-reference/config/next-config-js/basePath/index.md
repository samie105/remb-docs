...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: basePath","description":"Use \`basePath\` to deploy a Next.js application under a sub-path of a domain.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/basePath","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: basePath&amp;sig=2bc8ef244f00b1c8","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/basePath.mdx) Scroll to top
