...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: env","description":"Learn to add and access environment variables in your Next.js application at build time.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/env","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: env&amp;sig=04960fe2bf98d7be","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/env.mdx) Scroll to top
