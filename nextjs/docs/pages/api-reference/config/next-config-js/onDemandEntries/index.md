...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: onDemandEntries","description":"Configure how Next.js will dispose and keep in memory pages created in development.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/onDemandEntries","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: onDemandEntries&amp;sig=5da4587d53437246","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/onDemandEntries.mdx) Scroll to top
