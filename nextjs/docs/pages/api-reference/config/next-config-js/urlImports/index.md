...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: urlImports","description":"Configure Next.js to allow importing modules from external URLs.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/urlImports","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: urlImports&amp;sig=e744cf20b3664945","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/urlImports.mdx) Scroll to top
