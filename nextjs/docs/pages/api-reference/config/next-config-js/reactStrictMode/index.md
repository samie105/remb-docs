...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: reactStrictMode","description":"The complete Next.js runtime is now Strict Mode-compliant, learn how to opt-in","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/reactStrictMode","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: reactStrictMode&amp;sig=74f4fa2c989e4b73","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/reactStrictMode.mdx) Scroll to top
