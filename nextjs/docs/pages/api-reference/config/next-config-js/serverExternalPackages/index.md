...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: serverExternalPackages","description":"Opt-out specific dependencies from the dependency bundling enabled by \`bundlePagesRouterDependencies\`.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/serverExternalPackages","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: serverExternalPackages&amp;sig=1908ef8741b9dc56","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/serverExternalPackages.mdx) Scroll to top
