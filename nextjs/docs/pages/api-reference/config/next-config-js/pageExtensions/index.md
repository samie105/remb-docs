...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: pageExtensions","description":"Extend the default page extensions used by Next.js when resolving pages in the Pages Router.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/pageExtensions","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: pageExtensions&amp;sig=4eb4ba7a3f399d6c","dateModified":"2026-04-15","@type":"TechArticle"}

On this page

*   [Including non-page files in the pages directory](#including-non-page-files-in-the-pages-directory)

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/pageExtensions.mdx) Scroll to top
