...
canonical_url: "https://nextjs.org/docs/pages/api-reference/config/next-config-js/redirects"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: redirects","description":"Add redirects to your Next.js app.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/redirects","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: redirects&amp;sig=2396a0c2aba26218","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/redirects.mdx) Scroll to top
