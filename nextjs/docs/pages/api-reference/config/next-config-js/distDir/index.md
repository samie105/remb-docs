...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: distDir","description":"Set a custom build directory to use instead of the default .next directory.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/distDir","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: distDir&amp;sig=3db200d2ad7c0af0","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/distDir.mdx) Scroll to top
