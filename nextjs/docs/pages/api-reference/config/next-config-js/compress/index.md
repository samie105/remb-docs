...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: compress","description":"Next.js provides gzip compression to compress rendered content and static files, it only works with the server target. Learn more about it here.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/compress","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: compress&amp;sig=cef1d1a546b398f7","dateModified":"2026-04-15","@type":"TechArticle"}

On this page

*   [Disabling compression](#disabling-compression)

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/compress.mdx) Scroll to top
