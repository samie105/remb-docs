...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: useLightningcss","description":"Enable experimental support for Lightning CSS.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/useLightningcss","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: useLightningcss&amp;sig=86903e49e5bc5de8","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/useLightningcss.mdx) Scroll to top

[Configuration](/docs/pages/api-reference/config)[next.config.js Options](/docs/pages/api-reference/config/next-config-js)useLightningcss
