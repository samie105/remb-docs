...
canonical_url: "https://nextjs.org/docs/pages/api-reference/config/next-config-js/proxyClientMaxBodySize"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"next.config.js Options: experimental.proxyClientMaxBodySize","description":"Configure the maximum request body size when using proxy.","url":"https://nextjs.org/docs/pages/api-reference/config/next-config-js/proxyClientMaxBodySize","image":"https://nextjs.org/api/docs-og?title=next.config.js Options: experimental.proxyClientMaxBodySize&amp;sig=8b0219d66c501f51","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/01-next-config-js/proxyClientMaxBodySize.mdx) Scroll to top
