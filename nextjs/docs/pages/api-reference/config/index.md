...
canonical_url: "https://nextjs.org/docs/pages/api-reference/config"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"API Reference: Configuration","description":"Learn how to configure your Next.js application.","url":"https://nextjs.org/docs/pages/api-reference/config","image":"https://nextjs.org/api/docs-og?title=API Reference: Configuration&amp;sig=c222353350d5743c","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/04-config/index.mdx) Scroll to top
