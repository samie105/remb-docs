...
canonical_url: "https://nextjs.org/docs/pages/api-reference/components/image-legacy"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Components: Image (Legacy)","description":"Backwards compatible Image Optimization with the Legacy Image component.","url":"https://nextjs.org/docs/pages/api-reference/components/image-legacy","image":"https://nextjs.org/api/docs-og?title=Components: Image (Legacy)&amp;sig=c1cb53c19dff0b94","dateModified":"2026-04-15","@type":"TechArticle"}
...
*   [Customizing the Built-in Image Path](#customizing-the-built-in-image-path)
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/01-components/image-legacy.mdx) Scroll to top
