...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Components: Script","description":"Optimize third-party scripts in your Next.js application using the built-in \`next/script\` Component.","url":"https://nextjs.org/docs/pages/api-reference/components/script","image":"https://nextjs.org/api/docs-og?title=Components: Script&amp;sig=9b224e6c43dad694","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/01-components/script.mdx) Scroll to top
