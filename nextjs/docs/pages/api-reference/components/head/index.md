...
canonical_url: "https://nextjs.org/docs/pages/api-reference/components/head"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Components: Head","description":"Add custom elements to the \`head\` of your page with the built-in Head component.","url":"https://nextjs.org/docs/pages/api-reference/components/head","image":"https://nextjs.org/api/docs-og?title=Components: Head&amp;sig=5b1a4768a571c766","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/01-components/head.mdx) Scroll to top
