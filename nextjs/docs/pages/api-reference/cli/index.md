...
canonical_url: "https://nextjs.org/docs/pages/api-reference/cli"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"API Reference: CLI","description":"API Reference for the Next.js Command Line Interface (CLI) tools.","url":"https://nextjs.org/docs/pages/api-reference/cli","image":"https://nextjs.org/api/docs-og?title=API Reference: CLI&amp;sig=135e11b2ecab0b04","dateModified":"2026-04-15","@type":"TechArticle"}

[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/05-cli/index.mdx) Scroll to top
