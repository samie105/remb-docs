...
canonical_url: "https://nextjs.org/docs/pages/api-reference/cli/create-next-app"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
last_crawled_at: "2026-04-18T13:19:31.955Z"
content_hash: "980177e4fe596649864fbf706b13e5f765523f611d320661e09ce63b48ad7f1b"
menu_path: ["create-next-app CLI"]
section_path: []
---
Menu
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"CLI: create-next-app CLI","description":"Create Next.js apps using one command with the create-next-app CLI.","url":"https://nextjs.org/docs/pages/api-reference/cli/create-next-app","image":"https://nextjs.org/api/docs-og?title=CLI: create-next-app CLI&amp;sig=f9966b662751d6d6","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/04-api-reference/05-cli/create-next-app.mdx) Scroll to top

[API Reference](/docs/pages/api-reference)[CLI](/docs/pages/api-reference/cli)create-next-app CLI
