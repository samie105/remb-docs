...
The Next.js [`<Image>`](../../../app/api-reference/components/image/index.md) component extends the HTML `<img>` element to provide:
...
You can store static files, like images and fonts, under a folder called [`public`](../../../app/api-reference/file-conventions/public-folder/index.md) in the root directory. Files inside `public` can then be referenced by your code starting from the base URL (`/`).
