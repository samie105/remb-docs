...
canonical_url: "https://nextjs.org/docs/pages/getting-started/installation"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Getting Started: Installation","description":"How to create a new Next.js application with \`create-next-app\`. Set up TypeScript, ESLint,and configure your \`next.config.js\` file.","url":"https://nextjs.org/docs/pages/getting-started/installation","image":"https://nextjs.org/api/docs-og?title=Getting Started: Installation&amp;sig=4a34c202ab27b198","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/02-pages/01-getting-started/01-installation.mdx) Scroll to top
