...
{"@context":"https://schema.org","author":{"@type":"Organization","name":"Vercel"},"headline":"Architecture: Supported Browsers","description":"Browser support and which JavaScript features are supported by Next.js.","url":"https://nextjs.org/docs/architecture/supported-browsers","image":"https://nextjs.org/api/docs-og?title=Architecture: Supported Browsers&amp;sig=344c15766583e7c4","dateModified":"2026-04-15","@type":"TechArticle"}
...
[Edit this page on GitHub](https://github.com/vercel/next.js/edit/canary/docs/03-architecture/supported-browsers.mdx) Scroll to top
