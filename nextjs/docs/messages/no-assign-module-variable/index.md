...
version: "latest"
content_language: "en"
nav_prev: {"path": "../next-script-for-ga/index.md", "title": "Using Google Analytics with Next.js (through `@next/third-parties/google`)"}
nav_next: {"path": "../no-async-client-component/index.md", "title": "No async Client Component"}
---
