...
canonical_url: "https://nextjs.org/docs/messages/sync-dynamic-apis"
docset: "nextjs"
kind: "framework"
adapter: "nextjs"
...
### Unmigratable Cases[](#unmigratable-cases)
...
### Enforced Migration with Linter[](#enforced-migration-with-linter)
