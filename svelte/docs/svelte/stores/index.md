...
canonical_url: "https://svelte.dev/docs/svelte/stores"
docset: "svelte"
kind: "framework"
adapter: "generic"
last_crawled_at: "2026-04-18T16:41:23.585Z"
...
### writable[](#svelte-store-writable)
...
### readable[](#svelte-store-readable)
...
applying an aggregation function over its input values.
referencederived(const a: Writable<number>a, ($a: number$a) => $a: number$a * 2);
```
...
### readonly[](#svelte-store-readonly)
...
referenceget(const store: Writable<string>store);
```
...
[<svelte:options>](../svelte-options/index.md) [Context](../context/index.md)
