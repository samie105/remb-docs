...
menu_path: ["$host"]
section_path: []
nav_prev: {"path": "svelte/docs/svelte/$inspect/index.md", "title": "$inspect"}
nav_next: {"path": "svelte/docs/svelte/basic-markup/index.md", "title": "Basic markup"}
---
...
[$inspect](/docs/svelte/$inspect) [Basic markup](../basic-markup/index.md)
