...
canonical_url: "https://svelte.dev/docs/svelte/v4-migration-guide"
docset: "svelte"
kind: "framework"
adapter: "generic"
last_crawled_at: "2026-04-18T16:43:21.786Z"
...
## Browser conditions for bundlers[](#Browser-conditions-for-bundlers)
...
## Removal of CJS related output[](#Removal-of-CJS-related-output)
...
## Stricter types for Svelte functions[](#Stricter-types-for-Svelte-functions)
...
const dispatch: EventDispatcher
<"noArgument">(type: "noArgument", parameter?: null | undefined, options?: DispatchOptions | undefined) => booleandispatch('noArgument', 'surprise'); // error, cannot pass an argument
```
...
## Custom Elements with Svelte[](#Custom-Elements-with-Svelte)
...
## SvelteComponentTyped is deprecated[](#SvelteComponentTyped-is-deprecated)
...
To instantiate components, use mount instead.
See migration guide for more info.
referenceSvelteComponent<{ aProp: stringaProp: string }> {}
```
...
## Transitions are local by default[](#Transitions-are-local-by-default)
...
## Default slot bindings[](#Default-slot-bindings)
...
## New eslint package[](#New-eslint-package)
