...
section_path: []
nav_prev: {"path": "../failed-to-find-page-map-ssr/index.md", "title": "Astro couldn't find the correct page to render"}
nav_next: {"path": "../file-glob-not-supported/index.md", "title": "Glob patterns are not supported in the file loader"}
---
