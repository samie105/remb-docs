...
source: "https://docs.astro.build/en/reference/errors/session-without-supported-adapter-output-error/"
canonical_url: "https://docs.astro.build/en/reference/errors/session-without-supported-adapter-output-error/"
docset: "astro"
kind: "framework"
adapter: "generic"
last_crawled_at: "2026-04-18T16:46:39.005Z"
...
section_path: []
nav_prev: {"path": "../session-storage-save-error/index.md", "title": "Session data could not be saved."}
nav_next: {"path": "../static-client-address-not-available/index.md", "title": "Astro.clientAddress is not available in prerendered pages."}
---
