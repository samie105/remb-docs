...
For more information on internationalization support in Astro, see our [Internationalization guide](../../../guides/internationalization/index.md).

**See Also:**

*   [Internationalization](../../../guides/internationalization/index.md)
*   [`i18n` Configuration Reference](../../configuration-reference/index.md#i18n)
