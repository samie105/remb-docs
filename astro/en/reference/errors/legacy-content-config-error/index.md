...
A legacy content config file was found. Move the file to `src/content.config.ts` and update any collection definitions if needed. See the [Astro 6 migration guide](../../../guides/upgrade-to/v6/index.md#removed-legacy-content-collections) for more information.
