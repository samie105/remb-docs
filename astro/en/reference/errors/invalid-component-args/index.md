...
section_path: []
nav_prev: {"path": "astro/en/reference/errors/incorrect-strategy-for-i18n/index.md", "title": "You can't use the current function with the current strategy"}
nav_next: {"path": "astro/en/reference/errors/invalid-content-entry-data-error/index.md", "title": "Content entry data does not match schema."}
---
