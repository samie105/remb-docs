...
section_path: []
nav_prev: {"path": "../invalid-get-static-paths-entry/index.md", "title": "Invalid entry inside getStaticPath's return value"}
nav_next: {"path": "../invalid-glob/index.md", "title": "Invalid glob pattern."}
---
