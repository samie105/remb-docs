...
section_path: []
nav_prev: {"path": "../local-image-used-wrongly/index.md", "title": "Local images must be imported."}
nav_next: {"path": "../locals-not-serializable/index.md", "title": "Astro.locals is not serializable"}
---
