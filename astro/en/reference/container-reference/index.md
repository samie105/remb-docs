...
canonical_url: "https://docs.astro.build/en/reference/container-reference/"
docset: "astro"
kind: "framework"
adapter: "generic"
last_crawled_at: "2026-04-18T16:42:47.882Z"
...
**Type:** `(component: AstroComponentFactory; options?: [ContainerRenderOptions](#rendering-options)) => Promise<string>`
...
**Type:** `(component: AstroComponentFactory; options?: [ContainerRenderOptions](#rendering-options)) => Promise<Response>`
