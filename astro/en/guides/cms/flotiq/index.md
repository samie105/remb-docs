...
If you are using [SSR](../../on-demand-rendering/index.md) mode, you will need to fetch a single post based on its `slug`.
...
To deploy your website, visit Astro’s [deployment guides](../../deploy/index.md) and follow the instructions for your preferred hosting provider.
