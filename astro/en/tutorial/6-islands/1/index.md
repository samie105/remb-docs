...
*   [Astro Integrations Guide](../../../guides/integrations/index.md)
    
*   [Using UI Framework Components in Astro](../../../guides/framework-components/index.md#using-framework-components)
    
*   [Astro client directives reference](../../../reference/directives-reference/index.md#client-directives)
