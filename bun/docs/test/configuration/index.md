...
Files matching any of these patterns will be excluded from coverage calculation and reporting. See the [coverage documentation](bun/docs/test/code-coverage/index.md) for more details and examples.
