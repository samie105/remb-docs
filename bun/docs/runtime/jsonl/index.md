...
canonical_url: "https://bun.com/docs/runtime/jsonl"
docset: "bun"
kind: "language"
adapter: "generic"
last_crawled_at: "2026-04-18T17:00:31.360Z"
content_hash: "7c6c9cf719c22984d1dc88b8d98b6f2a5fe77f050072251946c3095ad635f142"
menu_path: ["JSONL"]
section_path: []
nav_prev: {"path": "bun/docs/runtime/json5/index.md", "title": "JSON5"}
nav_next: {"path": "bun/docs/runtime/jsx/index.md", "title": "JSX"}
---
...
Array of successfully parsed JSON values

`read`

`number`

Number of bytes (for `Uint8Array`) or characters (for strings) consumed

`done`

`boolean`

`true` if the entire input was consumed with no remaining data

`error`

`SyntaxError | null`

Parse error, or `null` if no error occurred
