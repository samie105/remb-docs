...
section_path: []
nav_prev: {"path": "../auto-install/index.md", "title": "Auto-install"}
nav_next: {"path": "../bun-apis/index.md", "title": "Bun APIs"}
---
...
For a more complete discussion of streams in Bun, see [API > Streams](../streams/index.md).
