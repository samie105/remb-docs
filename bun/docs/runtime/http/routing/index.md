...
canonical_url: "https://bun.com/docs/runtime/http/routing"
docset: "bun"
kind: "language"
adapter: "generic"
last_crawled_at: "2026-04-18T17:00:09.318Z"
content_hash: "a4a8afc66f5dc48e5dd03c4635e2e2ec7ec5e03eaa35bbfb32bf0e843ff57b60"
menu_path: ["Routing"]
section_path: []
nav_prev: {"path": "bun/docs/runtime/http/metrics/index.md", "title": "Metrics"}
nav_next: {"path": "bun/docs/runtime/http/server/index.md", "title": "Server"}
---
...
Static responses do not allocate additional memory after initialization. You can generally expect at least a 15% performance improvement over manually returning a `Response` object. Static route responses are cached for the lifetime of the server object. To reload static routes, call `server.reload(options)`.
