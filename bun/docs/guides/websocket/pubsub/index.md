...
section_path: []
nav_prev: {"path": "bun/docs/guides/websocket/context/index.md", "title": "Set per-socket contextual data on a WebSocket"}
nav_next: {"path": "bun/docs/guides/websocket/simple/index.md", "title": "Build a simple WebSocket server"}
---
