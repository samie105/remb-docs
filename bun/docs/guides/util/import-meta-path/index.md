...
Bun provides a handful of module-specific utilities on the [`import.meta`](../../../runtime/module-resolution/index.md#import-meta) object. Use `import.meta.path` to retrieve the absolute path of the current file.
