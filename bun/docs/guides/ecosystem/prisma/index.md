...
section_path: []
nav_prev: {"path": "bun/docs/guides/ecosystem/pm2/index.md", "title": "Run Bun as a daemon with PM2"}
nav_next: {"path": "bun/docs/guides/ecosystem/prisma-postgres/index.md", "title": "Use Prisma Postgres with Bun"}
---
