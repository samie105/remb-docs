...
canonical_url: "https://bun.com/docs/runtime/bunfig"
docset: "bun"
kind: "language"
adapter: "generic"
last_crawled_at: "2026-04-18T16:58:58.958Z"
...
nav_next: {"path": "bun/bun/docs/runtime/child-process/index.md", "title": "Spawn"}
---
...
Configure the linker strategy for installing dependencies. Defaults to `"isolated"` for new workspaces, `"hoisted"` for new single-package projects and existing projects (made pre-v1.3.2). For complete documentation refer to [Package manager > Isolated installs](bun/bun/docs/pm/isolated-installs/index.md).
...
Learn more about [using and writing security scanners](bun/bun/docs/pm/security-scanner-api/index.md).
...
For more details see [Minimum release age](bun/bun/docs/pm/cli/install/index.md#minimum-release-age) in the install documentation.
