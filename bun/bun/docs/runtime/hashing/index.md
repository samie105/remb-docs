...
canonical_url: "https://bun.com/docs/runtime/hashing"
docset: "bun"
kind: "language"
adapter: "generic"
last_crawled_at: "2026-04-18T16:59:53.547Z"
content_hash: "77616064f9f1045602057e746dd9eed30fa13f1f93baed269cf6bf50891e1cab"
menu_path: ["Hashing"]
section_path: []
nav_prev: {"path": "bun/bun/docs/runtime/globals/index.md", "title": "Globals"}
nav_next: {"path": "bun/bun/docs/runtime/html-rewriter/index.md", "title": "HTMLRewriter"}
---
...
In the following [Modular Crypt Format](https://passlib.readthedocs.io/en/stable/modular_crypt_format.html) hash (used by `bcrypt`): Input:
...
In the following [PHC format](https://github.com/P-H-C/phc-string-format/blob/master/phc-sf-spec.md) hash (used by `argon2`): Input:
...
`Bun.hash` is a collection of utilities for _non-cryptographic_ hashing. Non-cryptographic hashing algorithms are optimized for speed of computation over collision-resistance or security. The standard `Bun.hash` functions uses [Wyhash](https://github.com/wangyi-fudan/wyhash) to generate a 64-bit hash from an input of arbitrary size.
