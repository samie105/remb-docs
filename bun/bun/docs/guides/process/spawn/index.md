...
section_path: []
nav_prev: {"path": "bun/bun/docs/guides/process/os-signals/index.md", "title": "Listen to OS signals"}
nav_next: {"path": "bun/bun/docs/guides/process/spawn-stderr/index.md", "title": "Read stderr from a child process"}
---
