...
section_path: []
nav_prev: {"path": "bun/bun/docs/guides/process/spawn-stdout/index.md", "title": "Read stdout from a child process"}
nav_next: {"path": "bun/bun/docs/guides/read-file/arraybuffer/index.md", "title": "Read a file to an ArrayBuffer"}
---
