...
section_path: []
nav_prev: {"path": "bun/bun/docs/guides/http/fetch-unix/index.md", "title": "fetch with unix domain sockets in Bun"}
nav_next: {"path": "bun/bun/docs/guides/http/hot/index.md", "title": "Hot reload an HTTP server"}
---
