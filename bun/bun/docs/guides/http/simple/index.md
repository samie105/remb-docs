...
section_path: []
nav_prev: {"path": "bun/bun/docs/guides/http/server/index.md", "title": "Common HTTP server usage"}
nav_next: {"path": "bun/bun/docs/guides/http/sse/index.md", "title": "Server-Sent Events (SSE) with Bun"}
---
