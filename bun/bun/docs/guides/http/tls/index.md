...
section_path: []
nav_prev: {"path": "bun/bun/docs/guides/http/stream-node-streams-in-bun/index.md", "title": "Streaming HTTP Server with Node.js Streams"}
nav_next: {"path": "bun/bun/docs/guides/install/add/index.md", "title": "Add a dependency"}
---
