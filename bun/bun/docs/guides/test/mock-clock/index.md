...
section_path: []
nav_prev: {"path": "bun/bun/docs/guides/test/migrate-from-jest/index.md", "title": "Migrate from Jest to Bun's test runner"}
nav_next: {"path": "bun/bun/docs/guides/test/mock-functions/index.md", "title": "Mock functions in `bun test`"}
---
...
The `setSystemTime` function is commonly used on conjunction with [Lifecycle Hooks](bun/bun/docs/test/lifecycle/index.md) to configure a testing environment with a deterministic “fake clock”.
