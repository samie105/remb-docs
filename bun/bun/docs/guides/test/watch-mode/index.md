...
section_path: []
nav_prev: {"path": "bun/bun/docs/guides/test/update-snapshots/index.md", "title": "Update snapshots in `bun test`"}
nav_next: {"path": "bun/bun/docs/guides/util/base64/index.md", "title": "Encode and decode base64 strings"}
---
