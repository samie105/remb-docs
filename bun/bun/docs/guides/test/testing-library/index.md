...
section_path: []
nav_prev: {"path": "bun/bun/docs/guides/test/svelte-test/index.md", "title": "import, require, and test Svelte components with bun test"}
nav_next: {"path": "bun/bun/docs/guides/test/timeout/index.md", "title": "Set a per-test timeout with the Bun test runner"}
---
...
As a prerequisite to using Testing Library you will need to install [Happy Dom](https://github.com/capricorn86/happy-dom). ([see Bun’s Happy DOM guide for more information](bun/bun/docs/guides/test/happy-dom/index.md)).
...
Next you will need to create a preload script for Happy DOM and for Testing Library. For more details about the Happy DOM setup script see [Bun’s Happy DOM guide](bun/bun/docs/guides/test/happy-dom/index.md).
