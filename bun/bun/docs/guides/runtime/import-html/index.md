...
section_path: []
nav_prev: {"path": "bun/bun/docs/guides/runtime/heap-snapshot/index.md", "title": "Inspect memory usage using V8 heap snapshots"}
nav_next: {"path": "bun/bun/docs/guides/runtime/import-json/index.md", "title": "Import a JSON file"}
---
