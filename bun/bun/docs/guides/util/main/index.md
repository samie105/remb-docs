...
section_path: []
nav_prev: {"path": "bun/bun/docs/guides/util/javascript-uuid/index.md", "title": "Generate a UUID"}
nav_next: {"path": "bun/bun/docs/guides/util/path-to-file-url/index.md", "title": "Convert an absolute path to a file URL"}
---
