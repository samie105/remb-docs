...
section_path: []
nav_prev: {"path": "bun/bun/docs/guides/util/import-meta-dir/index.md", "title": "Get the directory of the current file"}
nav_next: {"path": "bun/bun/docs/guides/util/import-meta-path/index.md", "title": "Get the absolute path of the current file"}
---
