...
section_path: []
nav_prev: {"path": "bun/bun/docs/guides/test/watch-mode/index.md", "title": "Run tests in watch mode with Bun"}
nav_next: {"path": "bun/bun/docs/guides/util/deep-equals/index.md", "title": "Check if two objects are deeply equal"}
---
