...
section_path: []
nav_prev: {"path": "bun/bun/docs/guides/util/detect-bun/index.md", "title": "Detect when code is executed with Bun"}
nav_next: {"path": "bun/bun/docs/guides/util/escape-html/index.md", "title": "Escape an HTML string"}
---
