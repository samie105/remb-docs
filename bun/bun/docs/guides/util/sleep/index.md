...
section_path: []
nav_prev: {"path": "bun/bun/docs/guides/util/path-to-file-url/index.md", "title": "Convert an absolute path to a file URL"}
nav_next: {"path": "bun/bun/docs/guides/util/upgrade/index.md", "title": "Upgrade Bun to the latest version"}
---
