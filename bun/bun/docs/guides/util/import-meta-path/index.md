...
section_path: []
nav_prev: {"path": "bun/bun/docs/guides/util/import-meta-file/index.md", "title": "Get the file name of the current file"}
nav_next: {"path": "bun/bun/docs/guides/util/javascript-uuid/index.md", "title": "Generate a UUID"}
---
