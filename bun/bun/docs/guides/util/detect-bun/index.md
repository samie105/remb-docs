...
section_path: []
nav_prev: {"path": "bun/bun/docs/guides/util/deflate/index.md", "title": "Compress and decompress data with DEFLATE"}
nav_next: {"path": "bun/bun/docs/guides/util/entrypoint/index.md", "title": "Check if the current file is the entrypoint"}
---
