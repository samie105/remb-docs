...
section_path: []
nav_prev: {"path": "bun/bun/docs/guides/binary/buffer-to-blob/index.md", "title": "Convert a Buffer to a blob"}
nav_next: {"path": "bun/bun/docs/guides/binary/buffer-to-string/index.md", "title": "Convert a Buffer to a string"}
---
