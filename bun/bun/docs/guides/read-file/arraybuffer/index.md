...
section_path: []
nav_prev: {"path": "bun/bun/docs/guides/process/stdin/index.md", "title": "Read from stdin"}
nav_next: {"path": "bun/bun/docs/guides/read-file/buffer/index.md", "title": "Read a file to a Buffer"}
---
