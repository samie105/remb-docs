...
section_path: []
nav_prev: {"path": "bun/bun/docs/guides/read-file/buffer/index.md", "title": "Read a file to a Buffer"}
nav_next: {"path": "bun/bun/docs/guides/read-file/json/index.md", "title": "Read a JSON file"}
---
