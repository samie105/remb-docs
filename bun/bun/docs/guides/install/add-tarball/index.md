...
section_path: []
nav_prev: {"path": "bun/bun/docs/guides/install/add-peer/index.md", "title": "Add a peer dependency"}
nav_next: {"path": "bun/bun/docs/guides/install/azure-artifacts/index.md", "title": "Using bun install with an Azure Artifacts npm registry"}
---
