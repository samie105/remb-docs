...
section_path: []
nav_prev: {"path": "bun/bun/docs/guides/install/from-npm-install-to-bun-install/index.md", "title": "Migrate from npm install to bun install"}
nav_next: {"path": "bun/bun/docs/guides/install/jfrog-artifactory/index.md", "title": "Using bun install with Artifactory"}
---
