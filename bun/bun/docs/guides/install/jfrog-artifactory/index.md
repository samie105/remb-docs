...
section_path: []
nav_prev: {"path": "bun/bun/docs/guides/install/git-diff-bun-lockfile/index.md", "title": "Configure git to diff Bun's lockb lockfile"}
nav_next: {"path": "bun/bun/docs/guides/install/npm-alias/index.md", "title": "Install a package under a different name"}
---
