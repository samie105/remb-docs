...
canonical_url: "https://supabase.com/docs/guides/platform/custom-domains"
docset: "supabase"
kind: "platform"
adapter: "generic"
last_crawled_at: "2026-04-18T16:47:29.180Z"
...
```
1import { createClient } from '@supabase/supabase-js'23// Use a custom domain as the supabase URL4const supabase = createClient('https://api.example.com', 'sb_publishable_...')
```
...
```
1supabase vanity-subdomains --project-ref abcdefghijklmnopqrst activate --desired-subdomain my-example-brand --experimental
```
