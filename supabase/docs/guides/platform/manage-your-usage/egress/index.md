...
canonical_url: "https://supabase.com/docs/guides/platform/manage-your-usage/egress"
docset: "supabase"
kind: "platform"
adapter: "generic"
last_crawled_at: "2026-04-18T17:00:04.159Z"
...
### Shared pooler Egress[#](#shared-pooler-egress)
...
![Unified Egress](/docs/img/guides/platform/unified-egress--light.png)

Separately, you can see the cached egress right below:

![Unified Egress](/docs/img/guides/platform/cached-egress--light.png)
...
![Egress report](/docs/img/guides/platform/egress-report--light.png)
...
![Most frequent queries](/docs/img/guides/platform/advisor-most-frequent-queries--light.png)
...
![Top paths](/docs/img/guides/platform/logs-top-paths--light.png)
