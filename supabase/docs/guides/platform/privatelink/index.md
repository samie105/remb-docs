---
title: "PrivateLink"
source: "https://supabase.com/docs/guides/platform/privatelink"
canonical_url: "https://supabase.com/docs/guides/platform/privatelink"
docset: "supabase"
kind: "platform"
adapter: "generic"
last_crawled_at: "2026-04-18T16:48:04.743Z"
...
nav_prev: {"path": "../permissions/index.md", "title": "Permissions"}
nav_next: {"path": "../project-transfer/index.md", "title": "Project Transfers"}
---
...
PrivateLink is currently in beta and available only to Team and Enterprise customers. Contact support if you would like to create a PrivateLink connection for a read-only replica.
...
#### Step 1: Add AWS account[#](#step-1-add-aws-account)
...
#### Step 2: Accept resource share[#](#step-2-accept-resource-share)
...
#### Step 6: Update applications[#](#step-6-update-applications)
...
#### Step 7: Disable public connectivity (optional)[#](#step-7-disable-public-connectivity-optional)
