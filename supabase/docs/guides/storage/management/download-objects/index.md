...
See the [S3 authentication doc](../../s3/authentication/index.md) for full connection details.
...
*   **Node.js script** — see "Migrating storage objects" in the [migration guide](../../../platform/migrating-within-supabase/backup-restore/index.md)
*   **Google Colab script** — see "Migrate storage objects to new project's S3 storage" in the [dashboard restore guide](../../../platform/migrating-within-supabase/dashboard-restore/index.md)

## File metadata[#](#file-metadata)

File metadata is stored separately from the actual files. It lives in the `storage.buckets` and `storage.objects` tables in your Postgres database. If you need a complete backup (files + metadata), see the [backup and restore guide](../../../platform/migrating-within-supabase/backup-restore/index.md).
