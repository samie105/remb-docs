...
canonical_url: "https://supabase.com/docs/guides/functions/architecture"
docset: "supabase"
kind: "platform"
adapter: "generic"
last_crawled_at: "2026-04-18T16:43:30.861Z"
...
## 1\. Understanding Edge Functions through an example: Image filtering[#](#1-understanding-edge-functions-through-an-example-image-filtering)
...
## 3\. Global distribution and routing[#](#3-global-distribution-and-routing)
...
## 4\. Execution mechanics: Fast and isolated[#](#4-execution-mechanics-fast-and-isolated)
