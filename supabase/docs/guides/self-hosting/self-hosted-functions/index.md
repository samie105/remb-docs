...
nav_prev: {"path": "../self-hosted-auth-keys/index.md", "title": "New API Keys and Asymmetric Authentication"}
nav_next: {"path": "../self-hosted-oauth/index.md", "title": "Configure Social Login (OAuth) Providers"}
---
