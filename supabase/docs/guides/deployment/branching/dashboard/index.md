...
source: "https://supabase.com/docs/guides/deployment/branching/dashboard"
canonical_url: "https://supabase.com/docs/guides/deployment/branching/dashboard"
docset: "supabase"
kind: "platform"
adapter: "generic"
last_crawled_at: "2026-04-18T16:57:05.854Z"
...
## Enable branch management via the dashboard[#](#enable-branch-management-via-the-dashboard)
...
## Making changes to a branch[#](#making-changes-to-a-branch)
...
## Pulling changes from production into a branch[#](#pulling-changes-from-production-into-a-branch)
