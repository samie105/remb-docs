...
The Dashboard is a quick and easy tool for building applications while you are prototyping. That said, we strongly recommend using [Migrations](../database-migrations/index.md) to manage your database changes. You can use our CLI to [capture any changes](/docs/reference/cli/supabase-db-diff) you have made on the Dashboard so that you can commit them a version control system, like git.
...
*   [Database migrations](../database-migrations/index.md)
*   [Managing access on the Dashboard](../../platform/access-control/index.md)
*   [PGAudit for Postgres](../../database/extensions/pgaudit/index.md)
...
*   The Dashboard has various [access levels](../../platform/access-control/index.md) that can prevent changes being made via the UI.
...
*   Restrict production access to your database using [Network Restrictions](../../platform/network-restrictions/index.md).
*   As your database to grows, we strongly recommend moving to [Point-in-Time Recovery](../../platform/backups/index.md#point-in-time-recovery). This is safer and has less impact on your database performance during maintenance windows.
