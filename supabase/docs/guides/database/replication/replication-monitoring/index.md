...
canonical_url: "https://supabase.com/docs/guides/database/replication/replication-monitoring"
docset: "supabase"
kind: "platform"
adapter: "generic"
last_crawled_at: "2026-04-18T16:57:01.052Z"
...
![Destinations List](/docs/img/database/replication/replication-destinations-list.png)
...
Pipeline is being started

**Running**

Pipeline is actively replicating data
...
Pipeline has encountered an error (hover over the status to view error details)

### Viewing detailed pipeline metrics[#](#viewing-detailed-pipeline-metrics)
...
![Pipeline Status View](/docs/img/database/replication/replication-view-status.png)

#### Replication lag metrics[#](#replication-lag-metrics)
...
Table is getting ready to be copied

**Copying**

Initial snapshot of the table is being copied

**Copied**

Table snapshot is complete and getting ready for real-time replication

**Live**

Table is now replicating data in near real-time

**Error**

Table has experienced an error during replication
...
![Table Error Details](/docs/img/database/replication/replication-pipeline-table-error.png)
...
![Pipeline Error Details](/docs/img/database/replication/replication-pipeline-error.png)
...
![Replication Logs](/docs/img/database/replication/replication-logs.png)
...
#### Checking if replication is healthy[#](#checking-if-replication-is-healthy)
