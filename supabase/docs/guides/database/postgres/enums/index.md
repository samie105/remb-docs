...
nav_prev: {"path": "../dropping-all-tables-in-schema/index.md", "title": "Drop all tables in a Postgres schema"}
nav_next: {"path": "../event-triggers/index.md", "title": "Event Triggers"}
---
