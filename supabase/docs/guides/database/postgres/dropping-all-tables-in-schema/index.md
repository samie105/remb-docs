...
This deletes all tables and their associated data. Ensure you have a recent [backup](../../../platform/backups/index.md) before proceeding.
...
You can run this query using the [SQL Editor](/dashboard/project/_/sql) in the Supabase Dashboard, or via `psql` if you're [connecting directly to the database](../../connecting-to-postgres/index.md#direct-connections).
