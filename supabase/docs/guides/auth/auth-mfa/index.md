...
canonical_url: "https://supabase.com/docs/guides/auth/auth-mfa"
docset: "supabase"
kind: "platform"
adapter: "generic"
last_crawled_at: "2026-04-18T16:37:17.767Z"
...
*   The `<@` operator is Postgres's ["contained in" operator.](https://www.postgresql.org/docs/current/functions-array.html)
*   **Using `as restrictive` ensures this policy will restrict all commands on the table regardless of other policies!**
