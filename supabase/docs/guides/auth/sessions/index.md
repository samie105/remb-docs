...
canonical_url: "https://supabase.com/docs/guides/auth/sessions"
docset: "supabase"
kind: "platform"
adapter: "generic"
last_crawled_at: "2026-04-18T16:39:14.242Z"
...
```
1import { createClient } from '@supabase/supabase-js'23const supabase = createClient('SUPABASE_URL', 'SUPABASE_PUBLISHABLE_KEY', {4  auth: {5    storage: {6      getItem: () => {7        return Promise.resolve('FETCHED_COOKIE')8      },9      setItem: () => {},10      removeItem: () => {},11    },12  },13})
```
