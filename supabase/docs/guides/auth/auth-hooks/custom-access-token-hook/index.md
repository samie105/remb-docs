...
Sometimes the size of the JWT can be a problem especially if you're using a [Server-Side Rendering framework](../../server-side/index.md). Common situations where the JWT can get too large include:
