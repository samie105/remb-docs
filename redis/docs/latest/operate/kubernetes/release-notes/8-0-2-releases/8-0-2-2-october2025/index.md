...
source: "https://redis.io/docs/latest/operate/kubernetes/release-notes/8-0-2-releases/8-0-2-2-october2025/"
canonical_url: "https://redis.io/docs/latest/operate/kubernetes/release-notes/8-0-2-releases/8-0-2-2-october2025/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:36:11.982Z"
...
For more information about Redis Software 8.0.2-17, see the [Redis Software 8.0.2-17 release notes](/docs/latest/operate/rs/release-notes/rs-8-0-releases/rs-8-0-2-17/).
...
Enables a new alert in alert settings

REC

Change

Changed the storage version of the API to v1 (from v1alpha1)
...
For Redis version 8 and later, bundled modules are enabled automatically, so you don't need to specify them

REDB

`spec.moduleList.[DbModule].version`

Change

Module versions in regular deployments are automatically selected by the Redis Enterprise cluster. Specified module versions are ignored. In Active-Active setups, you must specify the module version.
...
For additional breaking changes related to Redis Software 8.0.2-17, see [Redis 8 breaking changes](/docs/latest/operate/rs/release-notes/rs-8-0-releases/rs-8-0-2-17/#redis-8-breaking-changes).
