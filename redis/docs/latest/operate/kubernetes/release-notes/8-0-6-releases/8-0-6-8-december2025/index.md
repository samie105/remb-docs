...
source: "https://redis.io/docs/latest/operate/kubernetes/release-notes/8-0-6-releases/8-0-6-8-december2025/"
canonical_url: "https://redis.io/docs/latest/operate/kubernetes/release-notes/8-0-6-releases/8-0-6-8-december2025/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:36:37.234Z"
...
Redis Enterprise for Kubernetes 8.0.6-8 is a feature release that supports Redis Software [8.0.6-54](/docs/latest/operate/rs/release-notes/rs-8-0-releases/rs-8-0-6-54/), and includes enhancements, supported distribution updates and bug fixes.

## Highlights

*   Support for external module repositories (custom modules)
*   Support for Redis Software [8.0.6-54](/docs/latest/operate/rs/release-notes/rs-8-0-releases/rs-8-0-6-54/)
...
*   Redis Software [8.0.6-54](/docs/latest/operate/rs/release-notes/rs-8-0-releases/rs-8-0-6-54/)
*   User-defined certificates for [internode encryption](/docs/latest/operate/kubernetes/security/internode-encryption/)
...
*   Fixed operator syncing REAADB in a loop when S3 backup is enabled
*   Security patches
