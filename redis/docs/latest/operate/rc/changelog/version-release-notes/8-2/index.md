...
If you are upgrading from Redis 7.4, review the [Redis 8.0 breaking changes](../8-0/index.md#breaking-changes) before upgrading.

### Terraform compatibility limitation

If you use the [Redis Cloud Terraform provider](../../../../../integrate/terraform-provider-for-redis-cloud/index.md) versions 2.1.2 through 2.4.5 with Redis 8.2 databases, database creation will fail. This issue only affects the Terraform provider and does not impact existing databases or data.
