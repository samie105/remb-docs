...
source: "https://redis.io/docs/latest/operate/redisinsight/install/install-on-k8s/"
canonical_url: "https://redis.io/docs/latest/operate/redisinsight/install/install-on-k8s/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:55:03.331Z"
...
This tutorial shows how to install Redis Insight on [Kubernetes](https://kubernetes.io/) (K8s). This is an easy way to use Redis Insight with a [Redis Enterprise K8s deployment](/docs/latest/operate/kubernetes/).
