...
If you don't have access to your Redis database log files, you can use pub/sub. The following example demonstrates how to use the [client.call](../concepts/javascript_api/index.md#clientcall) API to publish to a pub/sub channel.
