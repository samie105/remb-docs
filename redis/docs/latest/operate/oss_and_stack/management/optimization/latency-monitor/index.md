...
source: "https://redis.io/docs/latest/operate/oss_and_stack/management/optimization/latency-monitor/"
canonical_url: "https://redis.io/docs/latest/operate/oss_and_stack/management/optimization/latency-monitor/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:41:24.181Z"
...
The user interface to the latency monitoring subsystem is the [`LATENCY`](/commands/latency) command. Like many other Redis commands, [`LATENCY`](/commands/latency) accepts subcommands that modify its behavior. These subcommands are:
