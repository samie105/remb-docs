...
source: "https://redis.io/docs/latest/develop/ai/search-and-query/vectors/svs-compression/"
canonical_url: "https://redis.io/docs/latest/develop/ai/search-and-query/vectors/svs-compression/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:51:09.901Z"
...
Fast search and low memory use

Consider LeanVec for even faster search

LeanVec4x8

Fastest search and ingestion

LeanVec dimensionality reduction might reduce recall

LVQ4

Maximum memory saving

Recall might be insufficient

LVQ8

Faster ingestion than LVQ4x4

Search likely slower than LVQ4x4

LeanVec8x8

Improved recall when LeanVec4x8 is insufficient

LeanVec dimensionality reduction might reduce recall

LVQ4x8

Improved recall when LVQ4x4 is insufficient

Slightly worse memory savings
...
If you are using Redis Open Source under the AGPLv3 or SSPLv1 licenses, you cannot use it together with the Intel Optimization binaries (LeanVec and LVQ). The reason is that the Intel SVS license is not compatible with those licenses. The LeanVec and LVQ techniques are closed source and are only available for use with Redis Open Source when distributed under the RSALv2 license. For more details, please refer to the [information provided by Intel](https://github.com/intel/ScalableVectorSearch).

### Build Redis Open Source

Follow the [Redis Open Source build instructions](/docs/latest/operate/oss_and_stack/install/build-stack/). Before executing `make`, define the following environment variable.
