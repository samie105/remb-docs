...
source: "https://redis.io/docs/latest/develop/ai/search-and-query/administration/extensions/"
canonical_url: "https://redis.io/docs/latest/develop/ai/search-and-query/administration/extensions/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T17:14:07.144Z"
...
section_path: ["Docs\n        Docs","Docs\n        Docs","Docs","Docs","→\n      \n        Develop with Redis","→","Develop with Redis","→\n      \n        Redis for AI and search","→","Redis for AI and search","→\n      \n        Redis Search","→","Redis Search","→\n      \n        Administration","→","Administration","→\n      \n        Extend existing search and query features","→","Extend existing search and query features"]
nav_prev: {"path": "../design/index.md", "title": "Internal design"}
nav_next: {"path": "../gc/index.md", "title": "Garbage collection"}
---
...
It should return REDISEARCH\_ERR on error or REDISEARCH\_OK on success.
...
The return value of the function is a `double` representing the final score of the result. Returning 0 causes the result to be counted, but if there are results with a score greater than 0, they will appear above it. To completely filter out a result and not count it in the totals, the scorer should return the special value `RS_SCORE_FILTEROUT`, which is internally set to negative infinity, or -1/0.
