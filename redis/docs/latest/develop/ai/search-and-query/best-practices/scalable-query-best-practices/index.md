...
source: "https://redis.io/docs/latest/develop/ai/search-and-query/best-practices/scalable-query-best-practices/"
canonical_url: "https://redis.io/docs/latest/develop/ai/search-and-query/best-practices/scalable-query-best-practices/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:43:44.449Z"
...
If you're using Redis Software or Redis Cloud, see the [best practices for scalable Redis Search](/docs/latest/operate/oss_and_stack/stack-with-enterprise/search/scalable-query-best-practices/) page.
...
*   Review [`FT.INFO`](/docs/latest/commands/ft.info/) and [`FT.PROFILE`](/docs/latest/commands/ft.profile/) outputs for anomalies and/or errors.
*   Conduct load testing in a test environment with real-world queries and a load generated by either [memtier\_benchmark](https://github.com/redislabs/memtier_benchmark) or a custom load application.
...
*   Only make fields [`SORTABLE`](/docs/latest/develop/ai/search-and-query/advanced-concepts/sorting/) if they are used in [`SORTBY`](/docs/latest/develop/ai/search-and-query/advanced-concepts/sorting/#specifying-sortby) queries.
*   Use [`DIALECT 2`](/docs/latest/develop/ai/search-and-query/advanced-concepts/dialects/#dialect-2).
...
*   Set TAG fields to [UNF](/docs/latest/develop/ai/search-and-query/advanced-concepts/sorting/#normalization-unf-option).
...
You can analyze [`FT.PROFILE`](/docs/latest/commands/ft.profile/) output to gain insights about query execution. The following informational items are available for analysis:
