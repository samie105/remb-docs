...
source: "https://redis.io/docs/latest/develop/ai/redisvl/user_guide/semantic_router/"
canonical_url: "https://redis.io/docs/latest/develop/ai/redisvl/user_guide/semantic_router/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T17:13:09.739Z"
...
section_path: ["Docs\n        Docs","Docs\n        Docs","Docs","Docs","→\n      \n        Develop with Redis","→","Develop with Redis","→\n      \n        Redis for AI and search","→","Redis for AI and search","→\n      \n        RedisVL","→","RedisVL","→\n      \n        User Guides","→","User Guides","→\n      \n        Semantic Routing","→","Semantic Routing"]
nav_prev: {"path": "../rerankers/index.md", "title": "Rerankers"}
nav_next: {"path": "../session_manager/index.md", "title": "LLM Session Memory"}
---
