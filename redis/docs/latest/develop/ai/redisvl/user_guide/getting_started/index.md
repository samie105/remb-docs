...
source: "https://redis.io/docs/latest/develop/ai/redisvl/user_guide/getting_started/"
canonical_url: "https://redis.io/docs/latest/develop/ai/redisvl/user_guide/getting_started/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:40:43.174Z"
...
section_path: ["Docs\n        Docs","Docs\n        Docs","Docs","Docs","→\n      \n        Develop with Redis","→","Develop with Redis","→\n      \n        Redis for AI and search","→","Redis for AI and search","→\n      \n        RedisVL","→","RedisVL","→\n      \n        User Guides","→","User Guides","→\n      \n        Getting Started with RedisVL","→","Getting Started with RedisVL"]
nav_prev: {"path": "../index.md", "title": "User Guides"}
nav_next: {"path": "../hash_vs_json/index.md", "title": "Hash vs JSON Storage"}
---
...
For more information on creating real-world embeddings, refer to this [article](https://mlops.community/vector-similarity-search-from-basics-to-production/).
...
Next we will create a vector query object for our newly populated index. This example will use a simple vector to demonstrate how vector similarity works. Vectors in production will likely be much larger than 3 floats and often require Machine Learning models (i.e. Huggingface sentence transformers) or an embeddings API (Cohere, OpenAI). `redisvl` provides a set of [Vectorizers](/docs/latest/develop/ai/redisvl/user_guide/vectorizers/#openai) to assist in vector creation.
