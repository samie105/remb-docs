...
source: "https://redis.io/docs/latest/develop/ai/redisvl/user_guide/threshold_optimization/"
canonical_url: "https://redis.io/docs/latest/develop/ai/redisvl/user_guide/threshold_optimization/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T17:15:14.802Z"
content_hash: "977ddbf6304690062073217be351c05528bd0ca30a9f584f0b52dc99cfa58c47"
menu_path: ["Docs\n        Docs","Docs\n        Docs","Docs","Docs","→\n      \n        Develop with Redis","→","Develop with Redis","→\n      \n        Redis for AI and search","→","Redis for AI and search","→\n      \n        RedisVL","→","RedisVL","→\n      \n        User Guides","→","User Guides","→\n      \n        Threshold Optimization","→","Threshold Optimization"]
section_path: ["Docs\n        Docs","Docs\n        Docs","Docs","Docs","→\n      \n        Develop with Redis","→","Develop with Redis","→\n      \n        Redis for AI and search","→","Redis for AI and search","→\n      \n        RedisVL","→","RedisVL","→\n      \n        User Guides","→","User Guides","→\n      \n        Threshold Optimization","→","Threshold Optimization"]
nav_prev: {"path": "../svs_vamana/index.md", "title": "SVS-VAMANA Vector Search"}
nav_next: {"path": "../vectorizers/index.md", "title": "Vectorizers"}
---
...
Let's say you setup the following semantic cache with a distance\_threshold of `X` and store the entries:
...
This works well but we want to make sure the cache only applies for the appropriate questions. If we test the cache with a question we don't want a response to we see that the current distance\_threshold is too high.
...
### Define test\_data and optimize
