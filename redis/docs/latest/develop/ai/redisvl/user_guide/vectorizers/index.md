---
title: "Vectorizers"
source: "https://redis.io/docs/latest/develop/ai/redisvl/user_guide/vectorizers/"
canonical_url: "https://redis.io/docs/latest/develop/ai/redisvl/user_guide/vectorizers/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T17:00:58.464Z"
content_hash: "4c8930c7d9cd17f46703946b5c2cb7ac2f90ca6a2a70ccb15abd54d1cef5b6a2"
menu_path: ["Docs\n        Docs","Docs\n        Docs","Docs","Docs","→\n      \n        Develop with Redis","→","Develop with Redis","→\n      \n        Redis for AI and search","→","Redis for AI and search","→\n      \n        RedisVL","→","RedisVL","→\n      \n        User Guides","→","User Guides","→\n      \n        Vectorizers","→","Vectorizers"]
section_path: ["Docs\n        Docs","Docs\n        Docs","Docs","Docs","→\n      \n        Develop with Redis","→","Develop with Redis","→\n      \n        Redis for AI and search","→","Redis for AI and search","→\n      \n        RedisVL","→","RedisVL","→\n      \n        User Guides","→","User Guides","→\n      \n        Vectorizers","→","Vectorizers"]
nav_prev: {"path": "../threshold_optimization/index.md", "title": "Threshold Optimization"}
nav_next: {"path": "../../../search-and-query/administration/index.md", "title": "Administration"}
---
...
Special attention needs to be paid to the `input_type` parameter for each `embed` call. For example, for embedding queries, you should set `input_type='search_query'`; for embedding documents, set `input_type='search_document'`. See more information [here](https://docs.cohere.com/reference/embed)
...
Special attention needs to be paid to the `input_type` parameter for each `embed` call. For example, for embedding queries, you should set `input_type='query'`; for embedding documents, set `input_type='document'`. See more information [here](https://docs.voyageai.com/docs/embeddings)
...
[Mistral](https://console.mistral.ai/) offers LLM and embedding APIs for you to implement into your product. The `MistralAITextVectorizer` makes it simple to use RedisVL with their embeddings model. You will need to install `mistralai`.
