...
canonical_url: "https://redis.io/docs/latest/develop/whats-new/8-6/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:52:37.062Z"
...
Redis 8.6 introduces powerful idempotency features for [Redis Streams](/docs/latest/develop/data-types/streams/) that provide at-most-once delivery guarantees:
...
Redis 8.6 introduces new [eviction policies](/docs/latest/develop/reference/eviction/) that provide more granular control over memory management:
...
The new [`HOTKEYS`](/docs/latest/commands/hotkeys/) commands enable real-time detection and reporting of frequently accessed keys. This feature helps identify performance bottlenecks and optimize data distribution in clustered environments.
...
Redis 8.6 extends [time series](/docs/latest/develop/data-types/timeseries/) functionality with:
...
*   **RM\_CreateKeyMetaClass**: Define new key-metadata classes for custom data organization.
*   **RM\_ReleaseKeyMetaClass**: Release key-metadata classes when no longer needed.
*   **RM\_SetKeyMeta**: Attach or update metadata values for keys under specific metadata classes.
*   **RM\_GetKeyMeta**: Retrieve metadata values for keys under specific metadata classes.
...
*   [Redis 8.6](/docs/latest/operate/oss_and_stack/stack-with-enterprise/release-notes/redisce/redisos-8.6-release-notes/)
