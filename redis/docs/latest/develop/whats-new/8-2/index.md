---
title: "Redis 8.2"
source: "https://redis.io/docs/latest/develop/whats-new/8-2/"
canonical_url: "https://redis.io/docs/latest/develop/whats-new/8-2/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T17:01:16.286Z"
...
*   [`XDELEX`](/docs/latest/commands/xdelex/): Delete entries from streams with advanced consumer group handling options.
*   [`XACKDEL`](/docs/latest/commands/xackdel/): Acknowledge and delete stream entries in a single atomic operation.
...
The [`XADD`](/docs/latest/commands/xadd/) and [`XTRIM`](/docs/latest/commands/xtrim/) commands have also been extended with these same options, providing consistent behavior across all commands that remove stream entries.

### Cluster monitoring improvements

The new [`CLUSTER SLOT-STATS`](/docs/latest/commands/cluster-slot-stats/) command provides detailed per-slot usage metrics including:
...
Redis 8.2 extends the [`BITOP`](/docs/latest/commands/bitop/) command with new operators that provide more sophisticated bit manipulation capabilities:
...
*   **TYPE\_CHANGED**: Fired when a key's data type changes.
