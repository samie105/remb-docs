...
source: "https://redis.io/docs/latest/develop/data-types/json/developer/"
canonical_url: "https://redis.io/docs/latest/develop/data-types/json/developer/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T17:09:20.996Z"
content_hash: "f369ab491e61514daeeec98d104b9aefaff02c5d07127f450aad3be9d35b45ba"
menu_path: ["Docs\n        Docs","Docs\n        Docs","Docs","Docs","→\n      \n        Develop with Redis","→","Develop with Redis","→\n      \n        Redis data types","→","Redis data types","→\n      \n        JSON","→","JSON","→\n      \n        Developer notes","→","Developer notes"]
section_path: ["Docs\n        Docs","Docs\n        Docs","Docs","Docs","→\n      \n        Develop with Redis","→","Develop with Redis","→\n      \n        Redis data types","→","Redis data types","→\n      \n        JSON","→","JSON","→\n      \n        Developer notes","→","Developer notes"]
nav_prev: {"path": "../../compare-data-types/index.md", "title": "Compare data types"}
nav_next: {"path": "../indexing_json/index.md", "title": "Index/Search JSON documents"}
---
...
To include debugging information, you need to set the [`DEBUG`](/docs/latest/commands/debug/) environment variable before you compile RedisJSON. For example, run `export DEBUG=1`.
