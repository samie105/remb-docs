...
source: "https://redis.io/docs/latest/develop/data-types/timeseries/out-of-order_performance_considerations/"
canonical_url: "https://redis.io/docs/latest/develop/data-types/timeseries/out-of-order_performance_considerations/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T17:04:33.067Z"
...
nav_next: {"path": "../use_cases/index.md", "title": "Use cases"}
---
...
*   We've observed a maximum 95% drop in the achievable ops/sec even at 99% out-of-order ingestion. (Again, reducing the chunk size can cut the impact in half.)
 ...
 [![compressed-overall-ops-sec-vs-out-of-order-percentage](/docs/latest/images/timeseries/compressed-overall-ops-sec-vs-out-of-order-percentage.webp)](/docs/latest/images/timeseries/compressed-overall-ops-sec-vs-out-of-order-percentage.webp)[![compressed-overall-p50-lat-vs-out-of-order-percentage](/docs/latest/images/timeseries/compressed-overall-p50-lat-vs-out-of-order-percentage.webp) ](/docs/latest/images/timeseries/compressed-overall-p50-lat-vs-out-of-order-percentage.webp)[![compressed-out-of-order-overhead-table](/docs/latest/images/timeseries/compressed-out-of-order-overhead-table.webp)](/docs/latest/images/timeseries/compressed-out-of-order-overhead-table.webp)
