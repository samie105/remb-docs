...
source: "https://redis.io/docs/latest/develop/clients/lettuce/connect/"
canonical_url: "https://redis.io/docs/latest/develop/clients/lettuce/connect/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:46:42.919Z"
...
To disable SCH, use `MaintNotificationsConfig.disabled()` and pass the instance it returns to the `ClientOptions` builder:
...
Enable/disable SCH. The default is `true` (enabled).
...
Among other options, the `TimeoutOptions` builder accepts the following option that is relevant to SCH:
