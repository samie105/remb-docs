...
The `embedding` field specifies [HNSW](../../../ai/search-and-query/vectors/index.md#hnsw-index) indexing, the [L2](../../../ai/search-and-query/vectors/index.md#distance-metrics) vector distance metric, `Float32` values to represent the vector's components, and 384 dimensions, as required by the `all-MiniLM-L6-v2` embedding model.
