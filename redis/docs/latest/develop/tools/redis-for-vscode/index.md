...
source: "https://redis.io/docs/latest/develop/tools/redis-for-vscode/"
canonical_url: "https://redis.io/docs/latest/develop/tools/redis-for-vscode/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T17:05:55.975Z"
...
section_path: ["Docs\n        Docs","Docs\n        Docs","Docs","Docs","→\n      \n        Develop with Redis","→","Develop with Redis","→\n      \n        Client tools","→","Client tools","→\n      \n        Redis for VS Code","→","Redis for VS Code"]
nav_prev: {"path": "../insight/release-notes/v2.8.0/index.md", "title": "RedisInsight v2.8.0, August 2022"}
nav_next: {"path": "release-notes/index.md", "title": "Redis for VS Code release notes"}
---
...
*   [Hash](/docs/latest/develop/data-types/hashes/)
*   [List](/docs/latest/develop/data-types/lists/)
*   [Set](/docs/latest/develop/data-types/sets/)
*   [Sorted Set](/docs/latest/develop/data-types/sorted-sets/)
*   [String](/docs/latest/develop/data-types/strings/)
*   [JSON](/docs/latest/develop/data-types/json/)
...
[![](/docs/latest/images/dev/connect/vscode/vscode-install1.png)](/docs/latest/images/dev/connect/vscode/vscode-install1.png)

Once installed, check the **Auto Update** button to allow VS Code to install future revisions of the extension automatically.

[![](/docs/latest/images/dev/connect/vscode/vscode-install2.png)](/docs/latest/images/dev/connect/vscode/vscode-install2.png)

After installing the extension, your VS Code menu will look similar to the following.

[![](/docs/latest/images/dev/connect/vscode/vscode-menu.png)](/docs/latest/images/dev/connect/vscode/vscode-menu.png)
...
[![](/docs/latest/images/dev/connect/vscode/vscode-initial.png)](/docs/latest/images/dev/connect/vscode/vscode-initial.png)

Click on the **\+ Connect database** button. A dialog will display in the main pane. In the image shown below, all the options have been checked to show the available details for each connection. These connection details are similar to those accessible from [`redis-cli`](/docs/latest/develop/tools/cli/).
...
[![](/docs/latest/images/dev/connect/vscode/vscode-add-menu.png)](/docs/latest/images/dev/connect/vscode/vscode-add-menu.png)
...
[![](/docs/latest/images/dev/connect/vscode/vscode-cnx-view.png)](/docs/latest/images/dev/connect/vscode/vscode-cnx-view.png)
...
[![](/docs/latest/images/dev/connect/vscode/vscode-cnx-tools.png)](/docs/latest/images/dev/connect/vscode/vscode-cnx-tools.png)
...
[![](/docs/latest/images/dev/connect/vscode/vscode-key-view-w-wo-keys.png)](/docs/latest/images/dev/connect/vscode/vscode-key-view-w-wo-keys.png)
...
[![](/docs/latest/images/dev/connect/vscode/vscode-settings.png)](/docs/latest/images/dev/connect/vscode/vscode-settings.png)

Click on a key to display its contents.

[![](/docs/latest/images/dev/connect/vscode/vscode-key-view.png)](/docs/latest/images/dev/connect/vscode/vscode-key-view.png)
...
[![](/docs/latest/images/dev/connect/vscode/vscode-edit-name.png)](/docs/latest/images/dev/connect/vscode/vscode-edit-name.png)

*   **Set time-to-live (TTL)**. Click on the **TTL** field to set the duration in seconds.

[![](/docs/latest/images/dev/connect/vscode/vscode-edit-ttl.png)](/docs/latest/images/dev/connect/vscode/vscode-edit-ttl.png)
...
[![](/docs/latest/images/dev/connect/vscode/vscode-edit-del.png)](/docs/latest/images/dev/connect/vscode/vscode-edit-del.png)
...
[![](/docs/latest/images/dev/connect/vscode/vscode-edit-add.png)](/docs/latest/images/dev/connect/vscode/vscode-edit-add.png)
...
[![](/docs/latest/images/dev/connect/vscode/vscode-recycle-before-after.png)](/docs/latest/images/dev/connect/vscode/vscode-recycle-before-after.png)
...
[![](/docs/latest/images/dev/connect/vscode/vscode-edit-value-formatters.png)](/docs/latest/images/dev/connect/vscode/vscode-edit-value-formatters.png)
...
[![](/docs/latest/images/dev/connect/vscode/vscode-cli.png)](/docs/latest/images/dev/connect/vscode/vscode-cli.png)
