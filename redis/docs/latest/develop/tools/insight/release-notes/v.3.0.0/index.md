...
source: "https://redis.io/docs/latest/develop/tools/insight/release-notes/v.3.0.0/"
canonical_url: "https://redis.io/docs/latest/develop/tools/insight/release-notes/v.3.0.0/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:32:26.026Z"
content_hash: "8f4857edceab6d0deec77861efba4447d4c96d6293d235c2e0577c9d3bf64d9b"
menu_path: ["Docs\n        Docs","Docs\n        Docs","Docs","Docs","→\n      \n        Develop with Redis","→","Develop with Redis","→\n      \n        Client tools","→","Client tools","→\n      \n        Redis Insight","→","Redis Insight","→\n      \n        Redis Insight release notes","→","Redis Insight release notes","→\n      \n        Redis Insight v3.0.0, November 2025","→","Redis Insight v3.0.0, November 2025"]
section_path: ["Docs\n        Docs","Docs\n        Docs","Docs","Docs","→\n      \n        Develop with Redis","→","Develop with Redis","→\n      \n        Client tools","→","Client tools","→\n      \n        Redis Insight","→","Redis Insight","→\n      \n        Redis Insight release notes","→","Redis Insight release notes","→\n      \n        Redis Insight v3.0.0, November 2025","→","Redis Insight v3.0.0, November 2025"]
...
nav_next: {"path": "redis/docs/latest/develop/tools/insight/release-notes/v.3.0.2/index.md", "title": "Redis Insight v3.0.2, January 2026"}
---

# Redis Insight v3.0.0, November 2025

Redis Insight v3.0.0
...
uv0RwVZt5xIBbFWepOgss0Zdiz8/TuyEcUKYBnzaVPPkIfpxHFpV2LaJ+MNHuQoJETObNQtGcSGtqL/o09pMJQ==

Linux AppImage

IgQoAayGvrvEHCqix+4GsWt5+nHA5ROJ0vjSdg6+NggTPwfOpP6pHuGIvMlQP2pXjdeynaDPeWY5d+hQWpYtNA==

Linux Debian

nD27nc7EO0OaML9McebDwrLwp1nfDPwZx9OWQvseomwgvDU0OWbjib5DL31CVqFBE6YNQedYMTatiSF5qmymlw==

Linux RPM

GzzN86sAmQiikfbfV4k3Hc6mV+9DZZAkvDLqDOs6swYwgcjNmDmjwf89PGUp3BokugPwfHuVAmOfSa3khxSFvA==

MacOS Intel

zux1c8wOy69USAE88GGaOxGuvsCQxTN6/HlYMpWVgevWe9SFCxrFePb5bD4f7QZoDN0v958aVDiqF3bEYvGwLg==

MacOS Apple silicon

F6YFC+6Quyl7SQMvlyscKq7WXlF2Wkmuf+q6qL6wU/wmzLKa1tfrP0anbtyEl9eGQESpUCZ5bUQo4LB4FBiw6A==
