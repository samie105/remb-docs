...
source: "https://redis.io/docs/latest/develop/tools/insight/release-notes/v.2.68.0/"
canonical_url: "https://redis.io/docs/latest/develop/tools/insight/release-notes/v.2.68.0/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:32:39.298Z"
content_hash: "6369af3a3989635f01daa1040649c57170da24dce2ccaef41ae4d2d90eb4622f"
menu_path: ["Docs\n        Docs","Docs\n        Docs","Docs","Docs","→\n      \n        Develop with Redis","→","Develop with Redis","→\n      \n        Client tools","→","Client tools","→\n      \n        Redis Insight","→","Redis Insight","→\n      \n        Redis Insight release notes","→","Redis Insight release notes","→\n      \n        Redis Insight v2.68.0, April 2025","→","Redis Insight v2.68.0, April 2025"]
section_path: ["Docs\n        Docs","Docs\n        Docs","Docs","Docs","→\n      \n        Develop with Redis","→","Develop with Redis","→\n      \n        Client tools","→","Client tools","→\n      \n        Redis Insight","→","Redis Insight","→\n      \n        Redis Insight release notes","→","Redis Insight release notes","→\n      \n        Redis Insight v2.68.0, April 2025","→","Redis Insight v2.68.0, April 2025"]
nav_prev: {"path": "redis/docs/latest/develop/tools/insight/release-notes/v.2.66.0/index.md", "title": "Redis Insight v2.66.0, January 2025"}
nav_next: {"path": "redis/docs/latest/develop/tools/insight/release-notes/v.2.70.0/index.md", "title": "Redis Insight v2.70.0, May 2025"}
---
...
*   You can now test the connectivity to your source database when setting up a [Redis Data Integration](redis/docs/latest/integrate/redis-data-integration/index.md) (RDI) data pipeline in Redis Insight. This will help ensure that RDI can connect to the source database and keep your Redis cache updated with changes from the source database.
...
*   [#4335](https://github.com/RedisInsight/RedisInsight/pull/4335) [Redis Data Integration](redis/docs/latest/integrate/redis-data-integration/index.md) deployment errors are now stored in a file instead of being displayed in error messages, improving space efficiency.
...
*   [#4296](https://github.com/RedisInsight/RedisInsight/pull/4296) When working with JSON data types, Redis Insight now uses [JSONPath ($) syntax](redis/docs/latest/develop/data-types/json/path/index.md).
...
50YAPT59n2cLQu+P7kvc+kT+FxnW67pV53F1xz/C1IfgjmycgWpemycosbooQdLvXWPK4GLgk/NOnoZMI/15Lg==

Linux AppImage

QbI7V8jCCVPum4jdd1W8CEOqT+iFzwUTrt9tVbu9Kpv81Pub27aIJve3kWDdXWyvxHPUlUOsBHIo/uHIzdFJPw==

Linux Debian

V0/W8RclF6q0uT6uBR/lDNMt+OXqm7xmkSYf9vd8xCe4mGWUQBHiACX/aIgWs8l3Na5AQCNSJLrHnDXWiDD9Fw==

MacOS Intel

j3bdEX0rvxPGBUMZ6hD9aD+C/WTR1bOZT+lekJqujkDnRSPMZS5syGfkd1cQfx8QSnM10qYBO4RCH0Ew0m3g0A==

MacOS Apple silicon

iKOsvtOLOMcAvlbxL1LJI+45DgJxc+VIe9mVdoJZaNtMPCTAdxBX07GcvVVGfJOE8MdomsKrN8S2yYek7L6YLQ==
