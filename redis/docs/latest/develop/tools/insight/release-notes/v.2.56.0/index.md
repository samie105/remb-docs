...
source: "https://redis.io/docs/latest/develop/tools/insight/release-notes/v.2.56.0/"
canonical_url: "https://redis.io/docs/latest/develop/tools/insight/release-notes/v.2.56.0/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:33:28.689Z"
...
section_path: ["Docs\n        Docs","Docs\n        Docs","Docs","Docs","→\n      \n        Develop with Redis","→","Develop with Redis","→\n      \n        Client tools","→","Client tools","→\n      \n        Redis Insight","→","Redis Insight","→\n      \n        Redis Insight release notes","→","Redis Insight release notes","→\n      \n        Redis Insight v2.56.0, September 2024","→","Redis Insight v2.56.0, September 2024"]
nav_prev: {"path": "../v.2.54.0/index.md", "title": "Redis Insight v2.54.0, August 2024"}
nav_next: {"path": "../v.2.58.0/index.md", "title": "Redis Insight v2.58.0, October 2024"}
---
...
*   [#3665](https://github.com/RedisInsight/RedisInsight/pull/3665) A new timestamp formatter in the Browser to improve data readability. This formatter converts timestamps in hash fields to a human-readable format, making it easier to interpret results, validate and optimize queries, and inspect indexed data when using [Redis Search](https://redis.io/docs/latest/develop/ai/search-and-query/?utm_source=redisinsight&utm_medium=repository&utm_campaign=release_notes).
