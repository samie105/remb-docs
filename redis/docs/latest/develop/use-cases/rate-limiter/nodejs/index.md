...
source: "https://redis.io/docs/latest/develop/use-cases/rate-limiter/nodejs/"
canonical_url: "https://redis.io/docs/latest/develop/use-cases/rate-limiter/nodejs/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:50:22.995Z"
...
The `TokenBucket` class provides an async interface for rate limiting ([source](tokenBucket.js)):
...
A demonstration HTTP server is included to show the rate limiter in action ([source](demoServer.js)):
