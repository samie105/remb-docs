...
source: "https://redis.io/docs/latest/develop/use-cases/rate-limiter/"
canonical_url: "https://redis.io/docs/latest/develop/use-cases/rate-limiter/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:42:48.414Z"
...
The `TokenBucket` class provides a simple interface for rate limiting ([source](token_bucket.py)):
...
A demonstration web server is included to show the rate limiter in action ([source](demo_server.py)):
...
The demo assumes Redis is running on `localhost:6379` but you can easily change the host and port in the `demo_server.py` script. Visit `http://localhost:8080` in your browser to try it out.
