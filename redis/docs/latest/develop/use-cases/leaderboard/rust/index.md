...
source: "https://redis.io/docs/latest/develop/use-cases/leaderboard/rust/"
canonical_url: "https://redis.io/docs/latest/develop/use-cases/leaderboard/rust/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T17:14:53.658Z"
...
The module provides both a synchronous `RedisLeaderboard` and an asynchronous `AsyncRedisLeaderboard` ([source](leaderboard.rs)).
...
A local demo server is included to show the leaderboard in action ([source](demo_server.rs)):
