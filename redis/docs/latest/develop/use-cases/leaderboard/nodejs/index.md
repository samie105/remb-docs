...
source: "https://redis.io/docs/latest/develop/use-cases/leaderboard/nodejs/"
canonical_url: "https://redis.io/docs/latest/develop/use-cases/leaderboard/nodejs/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:50:02.675Z"
...
section_path: ["Docs\n        Docs","Docs\n        Docs","Docs","Docs","→\n      \n        Develop with Redis","→","Develop with Redis","→\n      \n        Redis use cases","→","Redis use cases","→\n      \n        Redis leaderboard","→","Redis leaderboard","→\n      \n        Redis leaderboard with node-redis","→","Redis leaderboard with node-redis"]
nav_prev: {"path": "../java-lettuce/index.md", "title": "Redis leaderboard with Java (Lettuce)"}
nav_next: {"path": "../php/index.md", "title": "Redis leaderboard with PHP"}
---
...
This guide shows you how to implement a Redis-backed leaderboard in JavaScript with [`node-redis`](/docs/latest/develop/clients/nodejs/). It uses a sorted set to store rank order, Redis hashes to store per-user metadata, and a small local web server so you can explore the leaderboard interactively in your browser.
...
The `RedisLeaderboard` class wraps common leaderboard operations ([source](leaderboard.js)):
...
*   [`ZADD`](/docs/latest/commands/zadd/) to add or update leaderboard scores
*   [`ZRANGE`](/docs/latest/commands/zrange/) with the `REV` option to fetch the highest-ranked members
*   [`ZREVRANK`](/docs/latest/commands/zrevrank/) to find a user's rank from the top
*   [`ZREMRANGEBYRANK`](/docs/latest/commands/zremrangebyrank/) to trim the lowest-ranked overflow entries
*   [`HSET`](/docs/latest/commands/hset/) and [`HGETALL`](/docs/latest/commands/hgetall/) to store and load user metadata
*   [`DEL`](/docs/latest/commands/del/) to remove metadata for trimmed or deleted users
...
A local demo server is included to show the leaderboard in action ([source](demoServer.js)):
