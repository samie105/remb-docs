...
source: "https://redis.io/docs/latest/develop/use-cases/leaderboard/go/"
canonical_url: "https://redis.io/docs/latest/develop/use-cases/leaderboard/go/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:54:04.829Z"
...
The `RedisLeaderboard` type wraps common leaderboard operations ([source](leaderboard.go)):
...
A local demo server is included to show the leaderboard in action ([source](demo_server.go)):
