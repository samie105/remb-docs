...
source: "https://redis.io/docs/latest/develop/use-cases/leaderboard/ruby/"
canonical_url: "https://redis.io/docs/latest/develop/use-cases/leaderboard/ruby/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T17:12:51.390Z"
...
This guide shows you how to implement a Redis-backed leaderboard in Ruby with the [`redis-rb`](/docs/latest/develop/clients/ruby/) client library. It uses a sorted set to store rank order, Redis hashes to store per-user metadata, and a small local web server so you can explore the leaderboard interactively in your browser.
...
The `RedisLeaderboard` class wraps common leaderboard operations ([source](leaderboard.rb)):
...
A local demo server is included to show the leaderboard in action ([source](demo_server.rb)):
