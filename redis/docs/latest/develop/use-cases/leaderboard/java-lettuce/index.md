...
source: "https://redis.io/docs/latest/develop/use-cases/leaderboard/java-lettuce/"
canonical_url: "https://redis.io/docs/latest/develop/use-cases/leaderboard/java-lettuce/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T17:03:58.083Z"
...
The async implementation is provided by `AsyncRedisLeaderboard` ([source](AsyncRedisLeaderboard.java)):
...
The reactive implementation is provided by `ReactiveRedisLeaderboard` ([source](ReactiveRedisLeaderboard.java)):
...
A local demo server is included to show the leaderboard in action ([source](DemoServer.java)):
