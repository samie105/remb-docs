...
source: "https://redis.io/docs/latest/develop/use-cases/leaderboard/php/"
canonical_url: "https://redis.io/docs/latest/develop/use-cases/leaderboard/php/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T17:10:36.613Z"
...
The `RedisLeaderboard` class wraps common leaderboard operations ([source](RedisLeaderboard.php)):
...
A local demo server is included to show the leaderboard in action ([source](demo_server.php)):
