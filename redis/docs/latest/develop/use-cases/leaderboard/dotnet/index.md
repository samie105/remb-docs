...
source: "https://redis.io/docs/latest/develop/use-cases/leaderboard/dotnet/"
canonical_url: "https://redis.io/docs/latest/develop/use-cases/leaderboard/dotnet/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T17:07:06.695Z"
...
The `RedisLeaderboard` class wraps common leaderboard operations ([source](RedisLeaderboard.cs)):
...
A local demo server is included to show the leaderboard in action ([source](Program.cs)):
