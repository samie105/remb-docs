...
source: "https://redis.io/docs/latest/develop/use-cases/leaderboard/redis-py/"
canonical_url: "https://redis.io/docs/latest/develop/use-cases/leaderboard/redis-py/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:44:24.447Z"
...
Implement a Redis leaderboard in Python with redis-py and sorted sets

This guide shows you how to implement a Redis-backed leaderboard in Python with [`redis-py`](/docs/latest/develop/clients/redis-py/). It uses a sorted set to store rank order, Redis hashes to store per-user metadata, and a small local web server so you can explore the leaderboard interactively in your browser.
...
The `RedisLeaderboard` class wraps the common leaderboard operations ([source](leaderboard.py)):
...
A local demo server is included to show the leaderboard in action ([source](demo_server.py)):
