...
source: "https://redis.io/docs/latest/develop/use-cases/session-store/rust/"
canonical_url: "https://redis.io/docs/latest/develop/use-cases/session-store/rust/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T17:13:04.509Z"
...
The `RedisSessionStore` struct wraps the basic session operations ([source](session_store.rs)).
...
A local demo server is included to show the session store in action ([source](demo_server.rs)):
