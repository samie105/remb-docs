...
source: "https://redis.io/docs/latest/develop/use-cases/session-store/php/"
canonical_url: "https://redis.io/docs/latest/develop/use-cases/session-store/php/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T17:08:16.841Z"
...
The `RedisSessionStore` class wraps the basic session operations ([source](SessionStore.php)):
...
A local demo server is included to show the session store in action ([source](demo_server.php)):
