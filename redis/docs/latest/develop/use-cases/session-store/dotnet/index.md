...
source: "https://redis.io/docs/latest/develop/use-cases/session-store/dotnet/"
canonical_url: "https://redis.io/docs/latest/develop/use-cases/session-store/dotnet/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T17:01:51.987Z"
...
The `RedisSessionStore` class wraps the basic session operations ([source](RedisSessionStore.cs)):
...
A local demo server is included to show the session store in action ([source](Program.cs)):
