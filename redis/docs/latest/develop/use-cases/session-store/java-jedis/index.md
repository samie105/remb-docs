...
source: "https://redis.io/docs/latest/develop/use-cases/session-store/java-jedis/"
canonical_url: "https://redis.io/docs/latest/develop/use-cases/session-store/java-jedis/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:59:21.278Z"
...
The `RedisSessionStore` class wraps the basic session operations ([source](RedisSessionStore.java)):
...
A local demo server is included to show the session store in action ([source](DemoServer.java)):
