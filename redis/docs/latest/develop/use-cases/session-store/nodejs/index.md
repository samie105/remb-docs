...
source: "https://redis.io/docs/latest/develop/use-cases/session-store/nodejs/"
canonical_url: "https://redis.io/docs/latest/develop/use-cases/session-store/nodejs/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:50:22.121Z"
...
section_path: ["Docs\n        Docs","Docs\n        Docs","Docs","Docs","→\n      \n        Develop with Redis","→","Develop with Redis","→\n      \n        Redis use cases","→","Redis use cases","→\n      \n        Redis session store","→","Redis session store","→\n      \n        Redis session store with node-redis","→","Redis session store with node-redis"]
nav_prev: {"path": "../java-lettuce/index.md", "title": "Redis session store with Java (Lettuce)"}
nav_next: {"path": "../php/index.md", "title": "Redis session store with PHP"}
---

# Redis session store with node-redis

Implement a Redis-backed session store in Node.js with node-redis

This guide shows you how to implement a Redis-backed session store in Node.js with [`node-redis`](/docs/latest/develop/clients/nodejs/). It includes a small local web server built with Node's standard `http` module so you can see the session lifecycle end to end.
...
The `RedisSessionStore` class wraps the basic session operations ([source](sessionStore.js)):
...
*   [`HSET`](/docs/latest/commands/hset/) to create and update session fields
*   [`HGETALL`](/docs/latest/commands/hgetall/) to load the session
*   [`HINCRBY`](/docs/latest/commands/hincrby/) to update counters
*   [`EXPIRE`](/docs/latest/commands/expire/) to implement sliding expiration
*   [`DEL`](/docs/latest/commands/del/) to remove a session on logout
...
A local demo server is included to show the session store in action ([source](demoServer.js)):
...
*   [node-redis guide](/docs/latest/develop/clients/nodejs/)
