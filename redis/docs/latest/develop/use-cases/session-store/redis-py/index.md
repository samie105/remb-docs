...
source: "https://redis.io/docs/latest/develop/use-cases/session-store/redis-py/"
canonical_url: "https://redis.io/docs/latest/develop/use-cases/session-store/redis-py/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:44:22.375Z"
...
The `RedisSessionStore` class wraps the basic session operations ([source](session_store.py)):
...
A local demo server is included to show the session store in action ([source](demo_server.py)):
