...
source: "https://redis.io/docs/latest/develop/use-cases/session-store/go/"
canonical_url: "https://redis.io/docs/latest/develop/use-cases/session-store/go/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:54:05.796Z"
...
The `RedisSessionStore` type wraps the basic session operations ([source](session_store.go)):
...
A local demo server is included to show the session store in action ([source](demo_server.go)):
