...
source: "https://redis.io/docs/latest/develop/use-cases/time-series-dashboard/go/"
canonical_url: "https://redis.io/docs/latest/develop/use-cases/time-series-dashboard/go/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:58:35.770Z"
...
This guide shows you how to build a compact rolling sensor graph demo in Go with the [`go-redis`](/docs/latest/develop/clients/go/) client library and Redis time series support. The example simulates three power sensors, ingests readings into Redis, and serves a local browser dashboard that updates in real time.
...
3.  A small local HTTP server built with Go's standard `net/http` package renders three stacked combined graph-and-bucket views and polls a JSON snapshot endpoint
...
The implementation uses these time series commands directly through `go-redis`:
...
```bash
./dashboard -redis-host 127.0.0.1 -redis-port 6379 -port 8080
```
...
*   [Go client guide](/docs/latest/develop/clients/go/) - Install and use the Go client
