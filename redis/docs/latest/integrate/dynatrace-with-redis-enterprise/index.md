---
title: "Dynatrace with Redis Software"
source: "https://redis.io/docs/latest/integrate/dynatrace-with-redis-enterprise/"
canonical_url: "https://redis.io/docs/latest/integrate/dynatrace-with-redis-enterprise/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T17:09:38.384Z"
...
The Dynatrace Integration for Redis Software uses Prometheus remote write functionality to connect Prometheus data sources to Dynatrace. This integration enables Redis Software users to export metrics to Dynatrace for analysis, and includes Redis-designed dashboards for use in monitoring Redis Software clusters.
...
[![](/docs/latest/images/rs/redis-enterprise-dynatrace.png)](/docs/latest/images/rs/redis-enterprise-dynatrace.png)

## Install Redis' Dynatrace Integration for Redis Software

At the present time the Dynatrace integration is not signed by Dynatrace, meaning that it will be necessary to download the source configuration and dashboards and assemble them and sign them cryptologically with a certificate that you have created. The instructions for this procedure can be found on the Dynatrace [site](https://docs.dynatrace.com/docs/extend-dynatrace/extensions20/sign-extension). Please note that the instructions would have you place the dashboards next to the src folder; this is incorrect, the dashboards should be located inside the src folder.

## View metrics

The Redis Software Integration for Dynatrace contains pre-defined dashboards to aid in monitoring your Redis Software deployment.
