...
source: "https://redis.io/docs/latest/integrate/terraform-provider-for-redis-cloud/"
canonical_url: "https://redis.io/docs/latest/integrate/terraform-provider-for-redis-cloud/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T17:00:36.894Z"
...
Redis develops and maintains a [Terraform provider for Redis Cloud](https://registry.terraform.io/providers/RedisLabs/rediscloud/latest). The Redis Cloud Terraform provider allows many of the same actions as found in the [Redis Cloud API](/docs/latest/operate/rc/api/).

See [Get started with Terraform](/docs/latest/integrate/terraform-provider-for-redis-cloud/get-started/) for an example of how to use the Terraform provider.
...
*   [Get started with Terraform](/docs/latest/integrate/terraform-provider-for-redis-cloud/get-started/)
