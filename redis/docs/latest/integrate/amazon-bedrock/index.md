...
1.  [Set up a Redis Cloud subscription and vector database](set-up-redis/index.md) for Bedrock.
    
2.  [Create a knowledge base](create-knowledge-base/index.md) connected to your vector database.
    
3.  [Create an agent](create-agent/index.md) connected to your knowledge base.
