...
source: "https://redis.io/docs/latest/integrate/uptrace-with-redis-enterprise/"
canonical_url: "https://redis.io/docs/latest/integrate/uptrace-with-redis-enterprise/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T17:11:36.257Z"
...
*   Collect and display data metrics not available in the [admin console](/docs/latest/operate/rs/references/metrics/).
...
[![](/docs/latest/images/rs/uptrace-redis-nodes.png)](/docs/latest/images/rs/uptrace-redis-nodes.png)
