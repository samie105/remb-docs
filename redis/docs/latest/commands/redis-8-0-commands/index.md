...
source: "https://redis.io/docs/latest/commands/redis-8-0-commands/"
canonical_url: "https://redis.io/docs/latest/commands/redis-8-0-commands/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T16:56:34.246Z"
...
**[HGETDEL](/commands/hgetdel/)** - Returns the value of a field and deletes it from the hash. ⭐ New in 8.0
...
**[HGETEX](/commands/hgetex/)** - Get the value of one or more fields of a given hash key, and optionally set their expiration. ⭐ New in 8.0
...
**[HSETEX](/commands/hsetex/)** - Set the value of one or more fields of a given hash key, and optionally set their expiration. ⭐ New in 8.0
...
**[VADD](/commands/vadd/)** - Add a new element to a vector set, or update its vector if it already exists. ⭐ New in 8.0
...
**[VCARD](/commands/vcard/)** - Return the number of elements in a vector set. ⭐ New in 8.0
...
**[VDIM](/commands/vdim/)** - Return the dimension of vectors in the vector set. ⭐ New in 8.0
...
**[VEMB](/commands/vemb/)** - Return the vector associated with an element. ⭐ New in 8.0
...
**[VGETATTR](/commands/vgetattr/)** - Retrieve the JSON attributes of elements. ⭐ New in 8.0
...
**[VINFO](/commands/vinfo/)** - Return information about a vector set. ⭐ New in 8.0
...
**[VISMEMBER](/commands/vismember/)** - Check if an element exists in a vector set. ⭐ New in 8.0
...
**[VLINKS](/commands/vlinks/)** - Return the neighbors of an element at each layer in the HNSW graph. ⭐ New in 8.0
...
**[VRANDMEMBER](/commands/vrandmember/)** - Return one or multiple random members from a vector set. ⭐ New in 8.0
...
**[VREM](/commands/vrem/)** - Remove an element from a vector set. ⭐ New in 8.0
...
**[VSETATTR](/commands/vsetattr/)** - Associate or remove the JSON attributes of elements. ⭐ New in 8.0
...
**[VSIM](/commands/vsim/)** - Return elements by vector similarity. ⭐ New in 8.0
