...
canonical_url: "https://redis.io/docs/latest/commands/redis-7-2-commands/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T17:05:37.918Z"
...
section_path: ["Docs\n        Docs","Docs\n        Docs","Docs","Docs","→\n      \n        Commands","→","Commands","→\n      \n        Redis 7.2 Commands Reference","→","Redis 7.2 Commands Reference"]
nav_prev: {"path": "../redis-6-2-commands/index.md", "title": "Redis 6.2 Commands Reference"}
nav_next: {"path": "../redis-7-4-commands/index.md", "title": "Redis 7.4 Commands Reference"}
---
...
**[CLIENT NO-TOUCH](/commands/client-no-touch/)** - Controls whether commands sent by the client affect the LRU/LFU of accessed keys. ⭐ New in 7.2
...
**[CLIENT SETINFO](/commands/client-setinfo/)** - Sets information specific to the client or connection. ⭐ New in 7.2
...
**[CLUSTER MYSHARDID](/commands/cluster-myshardid/)** - Returns the shard ID of a node. ⭐ New in 7.2
...
**[WAITAOF](/commands/waitaof/)** - Blocks until all of the preceding write commands sent by the connection are written to the append-only file of the master and/or replicas. ⭐ New in 7.2
