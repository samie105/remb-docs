...
source: "https://redis.io/docs/latest/commands/redis-6-2-commands/"
canonical_url: "https://redis.io/docs/latest/commands/redis-6-2-commands/"
docset: "redis"
kind: "database"
adapter: "generic"
last_crawled_at: "2026-04-18T17:08:37.533Z"
...
section_path: ["Docs\n        Docs","Docs\n        Docs","Docs","Docs","→\n      \n        Commands","→","Commands","→\n      \n        Redis 6.2 Commands Reference","→","Redis 6.2 Commands Reference"]
nav_prev: {"path": "../../index.md", "title": "Welcome to Redis Docs"}
nav_next: {"path": "../redis-7-2-commands/index.md", "title": "Redis 7.2 Commands Reference"}
---
...
**[GETDEL](/commands/getdel/)** - Returns the string value of a key after deleting the key. ⭐ New in 6.2
...
**[GETEX](/commands/getex/)** - Returns the string value of a key after setting its expiration time. ⭐ New in 6.2
...
**[HRANDFIELD](/commands/hrandfield/)** - Returns one or more random fields from a hash. ⭐ New in 6.2
...
**[BLMOVE](/commands/blmove/)** - Pops an element from a list, pushes it to another list and returns it. Blocks until an element is available otherwise. Deletes the list if the last element was moved. ⭐ New in 6.2
...
**[LMOVE](/commands/lmove/)** - Returns an element after popping it from one list and pushing it to another. Deletes the list if the last element was moved. ⭐ New in 6.2
...
**[SMISMEMBER](/commands/smismember/)** - Determines whether multiple members belong to a set. ⭐ New in 6.2
...
**[ZDIFF](/commands/zdiff/)** - Returns the difference between multiple sorted sets. ⭐ New in 6.2
...
**[ZDIFFSTORE](/commands/zdiffstore/)** - Stores the difference of multiple sorted sets in a key. ⭐ New in 6.2
...
**[ZINTER](/commands/zinter/)** - Returns the intersect of multiple sorted sets. ⭐ New in 6.2
...
**[ZMSCORE](/commands/zmscore/)** - Returns the score of one or more members in a sorted set. ⭐ New in 6.2
...
**[ZRANDMEMBER](/commands/zrandmember/)** - Returns one or more random members from a sorted set. ⭐ New in 6.2
...
**[ZRANGESTORE](/commands/zrangestore/)** - Stores a range of members from sorted set in a key. ⭐ New in 6.2
...
**[ZUNION](/commands/zunion/)** - Returns the union of multiple sorted sets. ⭐ New in 6.2
...
**[XAUTOCLAIM](/commands/xautoclaim/)** - Changes, or acquires, ownership of messages in a consumer group, as if the messages were delivered to as consumer group member. ⭐ New in 6.2
...
**[XGROUP CREATECONSUMER](/commands/xgroup-createconsumer/)** - Creates a consumer in a consumer group. ⭐ New in 6.2
...
**[GEOSEARCH](/commands/geosearch/)** - Queries a geospatial index for members inside an area of a box or a circle. ⭐ New in 6.2
...
**[GEOSEARCHSTORE](/commands/geosearchstore/)** - Queries a geospatial index for members inside an area of a box or a circle, optionally stores the result. ⭐ New in 6.2
...
**[CLIENT INFO](/commands/client-info/)** - Returns information about the connection. ⭐ New in 6.2
...
**[CLIENT TRACKINGINFO](/commands/client-trackinginfo/)** - Returns information about server-assisted client-side caching for the connection. ⭐ New in 6.2
...
**[CLIENT UNPAUSE](/commands/client-unpause/)** - Resumes processing commands from paused clients. ⭐ New in 6.2
...
**[RESET](/commands/reset/)** - Resets the connection. ⭐ New in 6.2
...
**[FAILOVER](/commands/failover/)** - Starts a coordinated failover from a server to one of its replicas. ⭐ New in 6.2
...
**[COPY](/commands/copy/)** - Copies the value of a key to a new key. ⭐ New in 6.2
