...
canonical_url: "https://vite.dev/config/build-options"
docset: "vite"
kind: "tool"
adapter: "generic"
last_crawled_at: "2026-04-18T16:32:09.232Z"
...
*   **Related:** [Browser Compatibility](../../guide/build/index.md#browser-compatibility)
...
Note: the polyfill does **not** apply to [Library Mode](../../guide/build/index.md#library-mode). If you need to support browsers without native dynamic import, you should probably avoid using it in your library.
...
The resolved dependency paths can be further modified using [`experimental.renderBuiltUrl`](../../guide/build/index.md#advanced-base-options).
...
Specify the output directory (relative to [project root](../../guide/index.md#index-html-and-project-root)).
...
Specify the directory to nest generated assets under (relative to `build.outDir`. This is not used in [Library Mode](../../guide/build/index.md#library-mode)).
...
This option allows users to override CSS minification specifically instead of defaulting to `build.minify`, so you can configure minification for JS and CSS separately. Vite uses [Lightning CSS](https://lightningcss.dev/minification.html) by default to minify CSS. It can be configured using [`css.lightningcss`](../shared-options/index.md#css-lightningcss). Set the option to `'esbuild'` to use esbuild instead.
...
*   **Related:** [Dynamic Import](../../guide/features/index.md#dynamic-import)
...
*   **Related:** [Library Mode](../../guide/build/index.md#library-mode)
...
*   **Default:** `false`
*   **Related:** [License](../../guide/features/index.md#license)
...
*   **Type:** `boolean | string`
*   **Default:** `false`
*   **Related:** [Backend Integration](../../guide/backend-integration/index.md)
...
If you are writing a plugin and need to inspect each output chunk or asset's related CSS and static assets during the build, you can also use [`viteMetadata` output bundle metadata API](../../guide/api-plugin/index.md#output-bundle-metadata).

## build.ssrManifest [​](#build-ssrmanifest)

*   **Type:** `boolean | string`
*   **Default:** `false`
*   **Related:** [Server-Side Rendering](../../guide/ssr/index.md)
...
Set to `false` to disable writing the bundle to disk. This is mostly used in [programmatic `build()` calls](../../guide/api-javascript/index.md#build) where further post processing of the bundle is needed before writing to disk.
...
There are cases that file system watching does not work with WSL2. See [`server.watch`](../server-options/index.md#server-watch) for more details.
