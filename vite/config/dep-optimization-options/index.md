...
section_path: []
---
*   **Related:** [Dependency Pre-Bundling](https://vite.dev/guide/dep-pre-bundling)

Unless noted, the options in this section are only applied to the dependency optimizer, which is only used in dev.

## optimizeDeps.entries [non-inherit](https://vite.dev/guide/api-environment#environments-configuration) [​](#optimizedeps-entries)
...
## optimizeDeps.exclude [non-inherit](https://vite.dev/guide/api-environment#environments-configuration) [​](#optimizedeps-exclude)
...
## optimizeDeps.include [non-inherit](https://vite.dev/guide/api-environment#environments-configuration) [​](#optimizedeps-include)
...
## optimizeDeps.rolldownOptions [non-inherit](https://vite.dev/guide/api-environment#environments-configuration) [​](#optimizedeps-rolldownoptions)
...
## optimizeDeps.esbuildOptions [non-inherit](https://vite.dev/guide/api-environment#environments-configuration) [​](#optimizedeps-esbuildoptions)
...
## optimizeDeps.force [non-inherit](https://vite.dev/guide/api-environment#environments-configuration) [​](#optimizedeps-force)

*   **Type:** `boolean`

Set to `true` to force dependency pre-bundling, ignoring previously cached optimized dependencies.

## optimizeDeps.noDiscovery [non-inherit](https://vite.dev/guide/api-environment#environments-configuration) [​](#optimizedeps-nodiscovery)
...
## optimizeDeps.holdUntilCrawlEnd [non-inherit](https://vite.dev/guide/api-environment#environments-configuration) [​](#optimizedeps-holduntilcrawlend)
...
## optimizeDeps.disabled [non-inherit](https://vite.dev/guide/api-environment#environments-configuration) [​](#optimizedeps-disabled)
...
## optimizeDeps.needsInterop [non-inherit](https://vite.dev/guide/api-environment#environments-configuration) [​](#optimizedeps-needsinterop)
