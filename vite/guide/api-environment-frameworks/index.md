---
title: "Environment API for Frameworks ​"
source: "https://vite.dev/guide/api-environment-frameworks"
canonical_url: "https://vite.dev/guide/api-environment-frameworks"
docset: "vite"
kind: "tool"
adapter: "generic"
last_crawled_at: "2026-04-18T16:33:01.257Z"
...
## DevEnvironment Communication Levels [​](#devenvironment-communication-levels)
...
Given a Vite server configured in middleware mode as described by the [SSR setup guide](../ssr/index.md#setting-up-the-dev-server), let's implement the SSR middleware using the environment API. Remember that it doesn't have to be called `ssr`, so we'll name it `server` in this example. Error handling is omitted.
