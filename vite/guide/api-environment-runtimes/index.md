---
title: "Environment API for Runtimes ​"
source: "https://vite.dev/guide/api-environment-runtimes"
canonical_url: "https://vite.dev/guide/api-environment-runtimes"
docset: "vite"
kind: "tool"
adapter: "generic"
last_crawled_at: "2026-04-18T16:33:42.594Z"
...
There are [multiple communication levels for the `DevEnvironment`](https://vite.dev/guide/api-environment-frameworks#devenvironment-communication-levels). To make it easier for frameworks to write runtime agnostic code, we recommend to implement the most flexible communication level possible.
