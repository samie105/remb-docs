...
canonical_url: "https://hono.dev/docs/getting-started/lambda-edge"
docset: "hono"
kind: "framework"
adapter: "generic"
last_crawled_at: "2026-04-18T16:37:53.606Z"
...
When creating the application on Lambda@Edge, [CDK](https://docs.aws.amazon.com/serverless-application-model/latest/developerguide/serverless-cdk.html) is useful to set up the functions such as CloudFront, IAM Role, API Gateway, and others.
