...
canonical_url: "https://hono.dev/docs/guides/best-practices"
docset: "hono"
kind: "framework"
adapter: "generic"
last_crawled_at: "2026-04-18T16:45:23.631Z"
...
If you still want to create a RoR-like Controller, use `factory.createHandlers()` in [`hono/factory`](../../helpers/factory/index.md). If you use this, type inference will work correctly.
...
For more detailed information, please see [the RPC page](../rpc/index.md#using-rpc-with-larger-applications).
